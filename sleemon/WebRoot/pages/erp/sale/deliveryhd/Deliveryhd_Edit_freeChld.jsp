...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/deliveryhd/Deliveryhd_Edit_freeChld.js"></script>
	...
	<div class="lst_area">
		...
		<table id="jsontb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
			<tr class="fixedRow">
              ...
              <th nowrap align="center">订货方编号</th>
              <th nowrap align="center">订货方名称</th>
              <th nowrap align="center">发货控制金额</th>
            </tr>
		</table>
		</form>
	</div>
