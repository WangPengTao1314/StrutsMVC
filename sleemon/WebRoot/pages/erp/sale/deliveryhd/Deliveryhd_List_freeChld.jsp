...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/deliveryhd/Deliveryhd_List_freeChld.js"></script>
		...
		<div class="lst_area">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
                    ...
                    <th  nowrap="nowrap" align="center" dbname="FREEZE_AMOUNT" >发货控制金额</th>
				</tr>
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));">
					 <td width="1%"align='center' >
						<input type="checkbox"  style="height:12px;valign:middle"  id="eid${rr}" value="${rst.DELIVER_FREEZE_DTL_ID}" onclick="setEidChecked(this);"/>
					 </td>
                     <td nowrap="nowrap" align="center" >${rst.ORDER_CHANN_NO}&nbsp;</td>
                     <td nowrap="nowrap" align="center" >${rst.ORDER_CHANN_NAME}&nbsp;</td>
                     <td nowrap="nowrap" align="right" >${rst.FREEZE_AMOUNT}&nbsp;</td>
				    </tr>
				</c:forEach>
				<c:if test="${empty rst}">
					<tr>
						<td height="25" colspan="4" align="center" class="lst_empty">
			                &nbsp;无相关记录&nbsp;
						</td>
					</tr>
				</c:if>
...
<form id="form1" action="#" method="post" name="listForm">
	<input type="hidden" id="DELIVER_FREEZE_DTL_IDS" name="DELIVER_FREEZE_DTL_IDS" value=""/>
</form>
</body>
</html>