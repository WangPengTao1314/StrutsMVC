...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/deliveryhd/Deliveryhd_List.js"></script>
...
<tr>
	<td height="20px" valign="top">
		...
		<tr>
			<td>当前位置：销售管理>>发运管理>>出货计划维护&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;提示:如整单冻结 ,手工冻结信用=出货单总金额-出货单总冻结金额</td>
				...
				<tr>
                  <td nowrap>
				   <c:if test="${pvg.PVG_EDIT eq 1 }">
				   	<input id="addSave" type="button" class="btn" value="新增(A)" title="Alt+A" accesskey="A">
			   		<input id="modify" type="button" class="btn" value="修改(E)" title="Alt+E" accesskey="E">
					
				   </c:if>
				   <c:if test="${pvg.PVG_COMMIT_CANCLE eq 1 }">
				   	<input id="commit" type="button" class="btn" value="提交发货(C)" title="Alt+C" accesskey="C">
			   		<input id="cancel" type="button" class="btn" value="整单撤销(T)" title="Alt+T" accesskey="T">
				   </c:if>
	...
	<td valign="top">
		<div class="lst_area" style="margin-left:3px;">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
					<th width="1%"></th>
                    <th  nowrap="nowrap" align="center" dbname="DELIVER_ORDER_NO" >出货计划号</th>
                    <th  nowrap="nowrap" align="center" dbname="TEM_RECV_CHANN_NAME" >客户名称</th>
                    ...
                    <th  nowrap="nowrap" align="center" dbname="APPCH_TIME" >车辆进场时间</th>
                    <th  nowrap="nowrap" align="center" dbname="SHIP_POINT_NAME" >发货基地</th>
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setSelEid(document.getElementById('eid${rr}'));">
                     ...
                     <td nowrap="nowrap" align="center">${rst.TEM_RECV_CHANN_NAME}&nbsp;</td>
                     ...
                     <input id="SHIP_POINT_ID${rst.DELIVER_ORDER_ID}" type="hidden"  value="${rst.SHIP_POINT_ID}" />
...
<input type="hidden" id="selParam" name="selParam" value=" STATE in('未提交','已提交生产') and DEL_FLAG=0 and ORDER_CHANN_ID in ${CHANNS_CHARG} "/>
<input type="hidden" id="selectAddrParams" name=selectAddrParams value="DEL_FLAG=0 and STATE='启用' and CHANN_ID in ${CHANNS_CHARG} ">
               ...
               <tr>
                ...
                <tr>
			      ...
			      <td width="8%" nowrap align="right" class="detail_label">收货地址编号：</td>
					<td width="15%" class="detail_content" >
						<input type="text" id="RECV_ADDR_NO" json="RECV_ADDR_NO" name="RECV_ADDR_NO"  value="${params.RECV_ADDR_NO}"/>
		                <img align="absmiddle" name="selAddr" style="cursor: hand" src="${ctx}/styles/${theme}/images/plus/select.gif" 
		                onclick="selCommon('BS_76', false, 'RECV_ADDR_NO', 'DELIVER_ADDR_NO', 'forms[1]','RECV_ADDR_NO,RECV_ADDR', 'DELIVER_ADDR_NO,DELIVER_DTL_ADDR', 'selectAddrParams');">
					</td>
...
<script type="text/javascript">
    ...
    SelDictShow("STATE","BS_133","${params.STATE}","");
