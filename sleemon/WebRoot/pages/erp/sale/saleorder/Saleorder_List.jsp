...
<tr>
	<td height="20px" valign="top">
		...
		<tr>
		    <c:if test="${params.module eq 'all' }">
		       <td>当前位置：销售管理>>订单中心>>销售订单查看</td>
		    </c:if>
		    
		    <c:if test="${params.module ne 'all' }">
		       <td>当前位置：销售管理>>订单中心>>标准订单维护</td>
		    </c:if>
...
<!--                       <a href="#"  style="text-decoration:underline" title="销售订单生产状态查询 " onclick="openReportUrl(this,'${rst.SALE_ORDER_NO}')">${rst.SALE_ORDER_NO}</a>&nbsp;-->
                     ...
                     <input id="RECV_CHANN_ID${rst.SALE_ORDER_ID}" type="hidden" value="${rst.RECV_CHANN_ID}" />
...
<script type="text/javascript">
    SelDictShow("STATE","BS_83","${params.STATE}","");
