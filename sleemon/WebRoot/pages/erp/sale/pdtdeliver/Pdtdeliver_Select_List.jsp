...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/pdtdeliver/Pdtdeliver_Select_List.js"></script>
								   ...
								   <td width="15%" class="detail_content">
								     ...
								     <img align="absmiddle" name="selJGXX" style="cursor: hand"
									  src="${ctx}/styles/${theme}/images/plus/select.gif"
									   onClick="selCommon('BS_68', false, 'DELIVER_ORDER_ID', 'DELIVER_ORDER_ID', 'forms[0]','DELIVER_ORDER_NO', 'DELIVER_ORDER_NO', 'selParam')">
