...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/saleplan/Saleplan_List.js"></script>
		...
		<table width="100%" cellspacing="0" cellpadding="0" >
		 <tr>			
			<c:if test="${empty module ||module eq 'wh'}">
			 <td height="20px">&nbsp;&nbsp;当前位置：营销管理>>销售管理>>渠道销售指标设定维护</td>
			</c:if>
			<c:if test="${module eq 'sh'}">
			 <td height="20px">&nbsp;&nbsp;当前位置：营销管理>>销售管理>>渠道销售指标设定审核</td>
			</c:if>			
				...
				<tr>
                  <td nowrap>
				   ...
				   <c:if test="${pvg.PVG_BWS eq 1 or pvg.PVG_BWS_AUDIT eq 1 }">
			   	   <input id="query" type="button" class="btn"  value="查询(F)" title="Alt+F" accesskey="F" onclick="getYear()">
				   </c:if>
				   &nbsp;&nbsp;&nbsp;
				    年份:
				    <select name="PLAN_YEAR" id="PLAN_YEAR" json="PLAN_YEAR" value="${rst.PLAN_YEAR}" style="width:100px;" autocheck="true" inputtype="string" onchange="getPlanYear()">
	...
	<td valign="top">
		<div class="lst_area" style="margin-left:3px;">			
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
					<th width="1%"><br></th>
					<th nowrap align="center" dbname="CHANN_NO" >客户编码</th>
					<th nowrap align="center" dbname="CHANN_NAME" >客户名称</th>
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)" id="tr${rr}">
						<td width="1%" align='center' >
							<input type="radio" style="height:12px;valign:middle" name="eid" id="eid${rr}" value="${rst.SALE_PLAN_ID}" onclick="setSelEid(document.getElementById('eid${rr}'));"/>
							<input type="hidden" name="CHANN_RNVTN_ID" id="CHANN_RNVTN_ID" value="${rst.SALE_PLAN_ID}"/>
                     ...
                     <script type="text/javascript">
						   $("#tr${rr}").click(function(){
						      ...
						      state(document.getElementById('state${rst.SALE_PLAN_ID}'));
						   });
					 </script>
				    </tr>
				</c:forEach>
...
<table width="100%" border="0" cellpadding="4" cellspacing="4" class="detail">
	<tr>
		<td class="detail2">
			...
			<input type="hidden" id="selChannParam" name="selChannParam" value=" STATE ='启用' and DEL_FLAG=0 and CHANN_ID IN ${CHANNS_CHARG}"/>
            <input id="selectParamsTt" name="selectParamsTt" type="hidden" >   
            <input type="hidden" name="selectArea" value=" RYZT='启用' and DELFLAG=0 and JGXXID='${JGXXID}' ">
               <tr>
                    <td width="8%" nowrap align="right" class="detail_label">渠道销售指标编号:</td>
					<td width="15%" class="detail_content">
	   					<input id="SALE_PLAN_NO" name="SALE_PLAN_NO"  style="width:155" value="${params.SALE_PLAN_NO}"/>
					</td>
					<td width="8%" nowrap align="right" class="detail_label">渠道编号:</td>
				   <td width="15%" class="detail_content">
						<input id="CHANN_NO" name="CHANN_NO" json="CHANN_NO"  value="${params.CHANN_NO}" />
						<img align="absmiddle" name="selJGXX" style="cursor: hand"
					   src="${ctx}/styles/${theme}/images/plus/select.gif"       
					   onClick="selCommon('BS_136', false, 'CHANN_NO', 'CHANN_NO', 'forms[1]','CHANN_NO,CHANN_NAME,AREA_NAME', 'CHANN_NO,CHANN_NAME,AREA_NAME_P', 'selChannParam');">  				
	   			   </td>
	   			   <td width="8%" nowrap align="right" class="detail_label">渠道名称:</td>
				   <td width="15%" class="detail_content">
						<input id="CHANN_NAME" name="CHANN_NAME" json="CHANN_NAME"  value="${params.CHANN_NAME}" />
	   			   </td>
               </tr>
               <tr>  
                  <td width="8%" nowrap align="right" class="detail_label">战区名称:</td>
					<td width="15%" class="detail_content">
	   					<input id="AREA_NAME" name="AREA_NAME" json="AREA_NAME"  value="${params.AREA_NAME}"/>
					</td>
				   ...
				   <td width="15%" class="detail_content">
						<select id="STATE" name="STATE" style="width: 155"></select>&nbsp;<input id="YEAR" name="YEAR" json="YEAR" type="hidden" value="${rst.YEAR}"/>
	   			   </td>
               </tr>
               <tr>
