...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/saleorderque/Saleorderque_List.js"></script>
...
<tr>
	<td height="20px" valign="top">
		...
		<tr>
			<td height="20px">&nbsp;&nbsp;当前位置：销售管理>>销售补单>>销售补单查询</td>
		...
		<div class="lst_area" style="margin-left:3px;">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
                    ...
                    <th  nowrap="nowrap" align="center" dbname="BILL_TYPE" >状态</th>
				</tr>
		...
		<td class="detail2">
			<table width="100%" border="0" cellpadding="1" cellspacing="1" class="detail3">
               ...
               <tr>
				...
				<td width="15%" class="detail_content">
	   					<input type="text" id="FROM_BILL_NO" name="FROM_BILL_NO"   size="20" value="${params.FROM_BILL_NO}" >
				</td>
...
<script type="text/javascript">
 SelDictShow("BILL_TYPE","BS_63","${params.BILL_TYPE}","");
</script>
</html>
