...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/prdreturn/Prdreturn_List_Chld_Decide.js"></script>
		...
		<div class="lst_area">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
                    ...
                    <th  nowrap="nowrap" align="center" dbname="ADVC_RETURN_PRICE" >建议退货单价</th>
                    ...
                    <th  nowrap="nowrap" align="center" dbname="DECIDE_PSON_NAME" >核价人</th>
				...
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));">
					 ...
					 <td nowrap="nowrap" align="center" >${rst.SN}</td>
                     ...
                     <c:choose>
   						<c:when test="${rst.SPCL_TECH_FLAG eq 1}">
                     ...
                     <td nowrap="nowrap" align="right" >${rst.ADVC_RETURN_PRICE}&nbsp;</td>
                     ...
                     <td nowrap="nowrap" align="right" >${rst.REMARK_DECIDE}</td>
				...
				<c:if test="${empty rst}">
					<tr>
						<td height="25" colspan="23" align="center" class="lst_empty">
			                &nbsp;无相关记录&nbsp;
						</td>
					</tr>
				</c:if>
