...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/prdreturn/Prdreturn_List.js"></script>
...
<tr>
	<td height="20px" valign="top">
		...
		<tr>
			<td height="20px">&nbsp;&nbsp;当前位置：销售管理&gt;&gt;退货管理&gt;&gt;${moduleName}</td>
			...
			<table id="qxBtnTb" cellSpacing=0 cellPadding=0 border=0 width="100%" style="border:0px">
				<tr>
                  <td nowrap>
				   ...
				   <c:if test="${pvg.COMMIT_TO_FACTORY eq 1}">
				    <input id="commitToFactory" type="button" class="btn" value="提交(Y)" title="Alt+Y" accesskey="Y">
				   </c:if>
				    <c:if test="${pvg.PVG_BWS eq 1 or pvg.PVG_BWS_AUDIT eq 1 or pvg.COMMIT_TO_PVG eq 1 }">
		...
		<div class="lst_area" style="margin-left:3px;">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setSelEid(document.getElementById('eid${rr}'));setBillType('${rst.BILL_TYPE}')">
...
if(flag == "decide"){
	SelDictShow("STATE","BS_26","${params.STATE}","");
}else{
	SelDictShow("STATE","BS_84","${params.STATE}","");
}
