...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/Erprebatechangereq/Erprebatechangereq_BatchCancelAuditList.js"></script>
...
<tr>
	...
	<tr>
		<td height="12px" align="center" >
				<input id="q_commit" type="button" class="btn" value="弃审(O)"
