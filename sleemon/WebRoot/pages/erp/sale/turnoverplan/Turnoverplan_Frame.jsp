...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/erp/sale/turnoverplan/Turnoverplan_Frame.js"></script>
</head>
<BODY>
						...
						<tr>
						   <!--这里加入需要显示的标签页, 注意序号和标签的宽度-->
							<td id="label" nowrap="nowrap">
								<span id="label_1" class="label_down" style="margin-top:2px;">&nbsp;未排车明细信息&nbsp;</span>
