...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/forecastprd/Forecastprd_List.js"></script>
...
<tr>
		...
		<div class="lst_area" style="margin-left:3px;">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
					...
					<th nowrap align="center" dbname="PRD_TYPE">规格</th>
					<th nowrap align="center" dbname="AREA_NO">货品分类</th>
					<th nowrap align="center" dbname="AREA_NAME">是否需要上报</th>
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setSelEid(document.getElementById('eid${rr}'));" >
						<td width="1%"align='center' >
							<input type="checkbox" style="valign:middle"  name="eid" id="eid${rr}"  value="${rst.PRD_ID}"
                        ...
                        <td nowrap align="center" >${rst.PRD_SPEC}&nbsp;</td>
 ...
 <form  id="queryForm" name="queryForm" action="" method="post">
	   ...
	   <input type="hidden" name="PRD_NAME"  id="PRD_NAME"    />
       <input type="hidden" name="PRD_NO" id="PRD_NO"/>
       <input type="hidden" name="PRD_SPEC" id="PRD_SPEC" />
       <input type="hidden" name="PAR_PRD_NAME" id="PAR_PRD_NAME"  value="">
	   <input type="hidden" name="PAR_PRD_NO"  id="PAR_PRD_NO"     value="" >
