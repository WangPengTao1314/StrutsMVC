...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/erp/sale/forecastprd/Forecastprd_Frame.js"></script>
</head>
<BODY>
	<table cellspacing="0" cellpadding="0" width="99.9%" height="100%">
		<tr>
			...
			<div id="topdiv" style="height: 30%; width: 100%">
					...
					<table cellSpacing=0 cellPadding=0 border=0 width="100%">
						<tr>
							...
							<td id="label" nowrap="nowrap">
								<span id="label_1" class="label_down" style="margin-top: 2px;">&nbsp;货品信息&nbsp;</span>
				...
				<div id="bottomdiv" style="height: 67%; width: 100%">
					<!-- 下帧 -->
