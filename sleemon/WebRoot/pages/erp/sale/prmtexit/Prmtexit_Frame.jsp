...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/erp/sale//prmtexit/Prmtexit_Frame.js"></script>
						...
						<tr>
						   <!--这里加入需要显示的标签页, 注意序号和标签的宽度-->
							<td id="label" nowrap="nowrap">
								<span id="label_1" class="label_down"  style="margin-top: 2px;font-size:13">&nbsp;促销品发放明细&nbsp;</span>
