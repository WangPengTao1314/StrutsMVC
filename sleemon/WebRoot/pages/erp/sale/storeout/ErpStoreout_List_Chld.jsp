...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/storeout/ErpStoreout_List_Chld.js"></script>
	...
	<td height="20">
		<div class="tablayer" >
			<table id="qxBtnTb" cellSpacing=0 cellPadding=0 border=0 width="100%">
				<tr>
                  <td nowrap>			   	  
				   <!-- 	<input id="scanstrog" type="button" class="btn" value="扫描(带库位)(C)" title="Alt+C" accesskey="E"> -->
				</td>
				</tr>
			</table>
		</div>
		...
		<div class="lst_area">
			...
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
                    ...
                    <th  nowrap="nowrap" align="center" dbname="STOREOUT_NUM" >出库数量</th>
                    <th  nowrap="nowrap" align="center" dbname="VOLUMES" >总体积</th>
				...
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));">
	                 ...
	                 <td nowrap="nowrap" align="right" >${rst.VOLUMES}&nbsp;</td>                  
