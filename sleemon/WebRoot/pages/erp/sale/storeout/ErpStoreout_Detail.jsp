	...
	<tr>
		...
		<table width="100%" border="0" cellpadding="1" cellspacing="1"
			...
			<tr>
				...
				<td width="35%" class="detail_content"> ${rst.STOREOUT_NO}&nbsp; </td>
			...
			<tr>
				...
				<td width="15%" align="right" class="detail_label"> 销售订单编号: </td>
				<td width="35%" class="detail_content">${rst.SALE_ORDER_NO}</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td width="35%" class="detail_content"> ${rst.TRUCK_NO}&nbsp; </td>
				<td width="15%" align="right" class="detail_label"> 出库时间: </td>
				<td width="35%" class="detail_content"> ${rst.STOREOUT_TIME}&nbsp; </td>
			</tr> 
			<tr>
				<td width="15%" align="right" class="detail_label">U9出库单号:</td>
				<td width="35%" class="detail_content">${rst.U9_SM_NO }</td>
				<td width="15%" align="right" class="detail_label"> 发货点名称:</td>
