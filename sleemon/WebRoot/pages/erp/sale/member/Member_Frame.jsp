...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/erp/sale/member/Member_Frame.js"></script>
</head>
<BODY>
						...
						<tr>
						   <!--这里加入需要显示的标签页, 注意序号和标签的宽度-->
							<td id="label" nowrap="nowrap">
						        ...
						        <span id="label_2" class="label_down1" style="margin-top:2px;">&nbsp;参加活动信息&nbsp;</span>
						        <span id="label_3" class="label_down1" style="margin-top:2px;">&nbsp;发放卡券信息&nbsp;</span>
						        <span id="label_4" class="label_down1" style="margin-top:2px;">&nbsp;积分流水&nbsp;</span>
