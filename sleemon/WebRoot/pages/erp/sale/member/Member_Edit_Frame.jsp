...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/erp/sale/member/Member_Edit_Frame.js"></script>
</head>
<BODY>
			...
			<table cellSpacing=0 cellPadding=0 border=0 width="100%">
				<tr>
					...
					<td id="label" nowrap="nowrap">
						<span id="label_1" class="label_down" style="margin-top:2px;">&nbsp;参加活动信息&nbsp;</span>
