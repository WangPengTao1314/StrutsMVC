...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/marketing/MarketCard_Edit.js"></script>
	...
	<div class="lst_area">
		...
		<table id="jsontb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
			<tr class="fixedRow">
               ...
               <th  nowrap="nowrap" align="center" dbname="MARKETING_CARD_NO" >营销卡卷编号</th>
               <th  nowrap="nowrap" align="center" dbname="CARD_TYPE" >卡卷类型</th>
               <th  nowrap="nowrap" align="center" dbname="CARD_VALUE" >卡卷面值</th>
