	...
	<tr>
		<td class="detail2">
			<table width="100%" border="0" cellpadding="1" cellspacing="1" class="detail_lst">
               ...
               <tr>
			        <td width="15%" align="right" class="detail_label">开始日期:</td>
					<td width="35%" class="detail_content">  ${rst.START_DATE}&nbsp; </td>
			        <td width="15%" align="right" class="detail_label">结束日期:</td>
					<td width="35%" class="detail_content"> ${rst.END_DATE}&nbsp; </td>
               </tr>
               <tr>
                    <td width="15%" align="right" class="detail_label">发起人名称:</td>
					<td width="35%" class="detail_content">
                        ${rst.SPONSOR_NAME}&nbsp;
					</td>
			        <td width="15%" align="right" class="detail_label">提成比例:</td>
					<td width="35%" class="detail_content">
                        ${rst.COMMISSION_PERCENTAGE_P}&nbsp;
					</td>
               </tr>
               <tr>
			        <td width="15%" align="right" class="detail_label">活动内容:</td>
