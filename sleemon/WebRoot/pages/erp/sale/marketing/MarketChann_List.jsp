...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/marketing/MarketChann_List.js"></script>
				...
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)" id="tr{rr}" onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));">
					 <td width="1%"align='center' >
						<input type="checkbox"  style="valign:middle"  id="eid${rr}" value="${rst.MARKETING_CHANN_ID}" onclick="setEidChecked(this);"/>
					 </td>
					 <td nowrap="nowrap" align="center" >${rst.CHANN_NO}&nbsp;</td>
                     <td nowrap="nowrap" align="center" >${rst.CHANN_NAME}&nbsp;</td>
                     <td nowrap="nowrap" align="center" >${rst.CHANN_TYPE}&nbsp;</td>
...
<form id="form1" action="#" method="post" name="listForm">
	<input type="hidden" id="MARKETING_CHANN_IDS" name="MARKETING_CHANN_IDS" value=""/>
