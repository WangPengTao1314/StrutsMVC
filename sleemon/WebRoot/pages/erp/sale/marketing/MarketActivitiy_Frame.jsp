...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/erp/sale/marketing/MarketActivitiy_Frame.js"></script>
	 <style type="text/css">
		.opendiv{
			margin: 0px auto; 
			width:600px;
						...
						<tr>
						   <!--这里加入需要显示的标签页, 注意序号和标签的宽度-->
							<td id="label" nowrap="nowrap">
						        ...
						        <span id="label_2" class="label_down1" style="margin-top:2px;">&nbsp;参加活动加盟商&nbsp;</span>
						        <span id="label_3" class="label_down1" style="margin-top:2px;">&nbsp;营销活动卡券&nbsp;</span>
