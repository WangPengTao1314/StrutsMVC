	...
	<body class="bodycss1">
		<div style="height: 100">
			...
			<tr>
				...
				<td width="35%" class="detail_content">
				    <input json="AREA_MANAGE_ID" name="AREA_MANAGE_ID" id="AREA_MANAGE_ID" type="hidden" label="区域经理ID"/>
				...
				<td width="35%" class="detail_content">
				    <select name="PLAN_YEAR" id="PLAN_YEAR" json="PLAN_YEAR" value="${rst.PLAN_YEAR}" style="width:275px;" autocheck="true" onchange="getRate();" inputtype="string"  mustinput="true">
