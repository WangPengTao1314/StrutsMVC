		...
		<div class="lst_area" style="margin-left:3px;">	
		   <form method="POST" action="#" id="queryForm" >		
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
				   <th width="1%"><br></th>
					<th  align="center" dbname="AREA_NO">区域编号</th>
					<th  align="center" dbname="AREA_NAME">区域名称</th>
					<th  align="center" dbname="AREA_MANAGE_NAME">区域经理</th>
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)" id="tr${rr}">
                     ...
                     <img align="absmiddle" name="selSHIP" style="cursor: hand" src="${ctx}/styles/${theme}/images/plus/select.gif"       
									onclick="selCommon('BS_167', false, 'AREA_MANAGE_NAME${rr}', 'AREA_MANAGE_NAME', 'forms[0]','AREA_MANAGE_ID${rr},AREA_MANAGE_NAME${rr}', 'AREA_MANAGE_ID,AREA_MANAGE_NAME', '')">
					 </td>
                     <td nowrap="nowrap" align="center">${rst.PLAN_YEAR}<input type="hidden" id="PLAN_YEAR" name="PLAN_YEAR${rr}" value="${rst.PLAN_YEAR}"/></td>
                     <td nowrap="nowrap" align="center"><input type="text" name="YEAR_PLAN_AMOUNT" id="YEAR_PLAN_AMOUNT${rr}" json="YEAR_PLAN_AMOUNT" size="6" onblur="getRate(${rr})" onfocus="checkYearAmount(this)" onchange="checkYearAmount(this)"/></td>
