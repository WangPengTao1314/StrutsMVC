...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/erp/sale/allotchanncard/AllotChanncard_Frame.js"></script>
</head>
<BODY>
<table cellspacing="0" cellpadding="0" width="99.9%" height="98%">
		<tr>
			<td >
				<div id="topdiv" style="height: 27%; width: 100%">
						...
						<tr>
						   <!--这里加入需要显示的标签页, 注意序号和标签的宽度-->
							<td id="label" nowrap="nowrap">
								<span id="label_1" class="label_down" style="margin-top:2px;">&nbsp;卡券信息&nbsp;</span>
				...
				<div id="bottomdiv" style="height: 63%; width: 100%" >
					<!-- 下帧 -->
...
<input type="hidden" id="NO_SALE_ID" value="${NO_SALE_ID}"/>
