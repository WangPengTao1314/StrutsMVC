...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/erp/sale/budgetquota/Budgetquota_Frame.js">
</script>
</head>
<BODY>
	<table cellspacing="0" cellpadding="0" width="99.9%" height="100%">
		<tr>
			<td id="leftiframe" width="180px">
				<iframe id="leftcontent" name="leftcontent" style="margin-left: 0px" src="#" frameBorder=0 width="100%" height="100%" vspace="0px"
					hspace="0px" scrolling="AUTO"></iframe>
			</td>
			<td width="7px">
				<table id="colResize" width="7" height="100%" style="cursor: col-resize" border="0" cellpadding="0"
					cellspacing="0" background="${ctx}/styles/${theme}/images/left/sep3pt.gif">
					<tr>
						<td>
							&nbsp;
						</td>
	...
	<input type="hidden" id="fla" value="0"/>
</body>
