...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/paymentcmt/Paymentcmt_List.js"></script>
...
<tr>
	<td height="20px" valign="top">
		...
		<tr>
			<td height="20px">&nbsp;&nbsp;当前位置：销售管理&gt;&gt;订单中心&gt;&gt;付款凭证确认</td>
	...
	<td height="20">
		<div class="tablayer" style="margin-left:3px; border-bottom:1px solid #d3d3d3; padding-bottom:3px; margin-bottom:3px;">
			<table id="qxBtnTb" cellSpacing=0 cellPadding=0 border=0 width="100%" style="border:0px">
				<tr>
                  <td nowrap>
				   <c:if test="${pvg.PVG_VERIFY eq 1 }">
				    <input id="verify" type="button" class="btn" value="确认(V)" title="Alt+V" accesskey="V">
				   </c:if>
				...
				<table width="100%" height="100%">
					<tr >
						...
						<td align="left">
							...
							<input  type="hidden" id="PAYMENT_UPLOAD_ID"  >  
						</td>
					</tr>
					<tr>
		...
		<div class="lst_area" style="margin-left:3px;">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
                    ...
                    <input id="state${rst.PAYMENT_UPLOAD_ID}" type="hidden"  value="${rst.STATE}" />
				    </tr>
				</c:forEach>
...
<script type="text/javascript">
	   SelDictShow("STATE","BS_22","${params.STATE}","");
</script>