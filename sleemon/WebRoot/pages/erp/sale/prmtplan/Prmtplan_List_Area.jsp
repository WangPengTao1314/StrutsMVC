...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/prmtplan/Prmtplan_List_Area.js"></script>
				...
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));">
					 <td width="10%"align='center' >
						<input type="checkbox"  style="height:12px;valign:middle"  id="eid${rr}" value="${rst.PRMT_EFFCT_AREA_ID}" onclick="setEidChecked(this);"/>
					 </td>
                     <td nowrap="nowrap" align="left" >${rst.AREA_NO}&nbsp;</td>
...
<form id="form1" action="#" method="post" name="listForm">
	<input type="hidden" id="PRMT_EFFCT_AREA_IDS" name="PRMT_EFFCT_AREA_IDS" value=""/>
</form>
</body>
</html>