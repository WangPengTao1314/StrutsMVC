<!--
 * @prjName:喜临门营销平台
 * @fileName:Payment_Detial
 * @author glw
 * @time   2013-08-15 11:18:27 
 * @version 1.1
-->
	...
	<tr>
		<td class="detail2">
			<table width="100%" border="0" cellpadding="1" cellspacing="1" class="detail_lst">
               <tr>
			        <td width="15%" align="right" class="detail_label">付款单编号:</td>
               ...
               <tr>
			        ...
			        <td width="15%" align="right" class="detail_label">付款日期:</td>
					<td width="35%" class="detail_content">
                        ${rst.PAY_DATE}&nbsp;
					</td>
               </tr>
               ...
               <tr>
					...
					<td width="30%" class="detail_content"  colspan="3">
                        ${rst.REMARK}&nbsp;
					</td>
               </tr>
			</table>
