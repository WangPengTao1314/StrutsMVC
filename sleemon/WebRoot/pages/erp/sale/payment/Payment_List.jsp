...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/payment/Payment_List.js"></script>
...
<tr>
	<td height="20px" valign="top">
		...
		<tr>
			<td height="20px">&nbsp;&nbsp;当前位置：销售管理&gt;&gt;信誉管理&gt;&gt;客户付款单</td>
	...
	<td valign="top">
		<div class="lst_area" style="margin-left:3px;">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
					<th width="1%"></th>
                    <th  nowrap="nowrap" align="center" dbname="PAYMENT_NO" >付款单编号</th>
                    ...
                    <th  nowrap="nowrap" align="center" dbname="PAY_DATE" >付款日期</th>
                    <th  nowrap="nowrap" align="center" dbname="CRE_NAME" >制单人名称</th>
                    <th  nowrap="nowrap" align="center" dbname="CRE_TIME" >制单时间</th>
                    <th  nowrap="nowrap" align="center" dbname="DEPT_NAME" >制单部门名称</th>
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setSelEid(document.getElementById('eid${rr}'));">
					 <td width="1%"align='center' >
						<input type="radio" style="height:12px;valign:middle" name="eid" id="eid${rr}" value="${rst.PAYMENT_ID}"/>
					 </td>
                     ...
                     <td nowrap="nowrap" align="center" >${rst.PAY_DATE}&nbsp;</td>
                    ...
                    <input id="state${rst.PAYMENT_ID}" type="hidden"  value="${rst.STATE}" />
				    </tr>
				</c:forEach>
	...
	<tr>
		<td class="detail2">
			<table width="100%" border="0" cellpadding="1" cellspacing="1" class="detail3">
               <tr>
                    <td width="8%" nowrap align="right" class="detail_label">付款单编号:</td>
					...
					<td width="15%" class="detail_content">
	   					<input id="CHANN_NO" name="CHANN_NO" id="CHANN_NO" style="width:155" value="${params.CHANN_NO}"/>
						...
						<img align="absmiddle" name="selCHANN_NO" style="cursor: hand"src="${ctx}/styles/${theme}/images/plus/select.gif"
							onClick="selCommon('BS_19', false, 'CHANN_ID', 'CHANN_ID', 'queryForm','CHANN_ID,CHANN_NO,CHANN_NAME', 'CHANN_ID,CHANN_NO,CHANN_NAME', 'selectParams')">
					</td>					
...
<script language="JavaScript">  
	SelDictShow("STATE","191","${params.STATE }","");
</script>
</html>