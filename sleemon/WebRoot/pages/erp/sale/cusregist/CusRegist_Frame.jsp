...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/erp/sale/cusregist/CusRegist_Frame.js"></script>
...
<table cellspacing="0" cellpadding="0" width="99.9%" height="98%">
		<tr>
			<td >
				<div id="topdiv" style="height: 90%; width: 100%">
						...
						<tr>
						   <!--这里加入需要显示的标签页, 注意序号和标签的宽度-->
							<td id="label" nowrap="nowrap">
							    <span id="label_1" class="label_down1" style="margin-top:2px;">&nbsp;签到信息&nbsp;</span>
