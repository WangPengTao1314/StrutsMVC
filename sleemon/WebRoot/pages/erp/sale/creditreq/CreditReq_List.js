...
$(function(){
	...
	//主从及主从从列表页面通用加载方法
	listPageInit("credit_req.shtml?action=toList&module=" + module);
	...
	mtbDelListener("credit_req.shtml?action=delete", "creditReqID");
 ...
 function toFlow(i) {
    ...
    document.affirm.sourceURI.value=ctxPath+"/credit_req.shtml?action=toList"+document.getElementById("paramUrl").value ;
	switch (Number(i)) {
	  case 1:
		affirmEvent(0);
		break;//提交
