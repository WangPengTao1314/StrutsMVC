...
$(function(){
	...
	$("#edit").click(function(){
		...
		var selRowId = parent.document.getElementById("selRowId").value;
	    $("#ADVC_STATEMENTS_ORDER_ID").val(selRowId);
		$("#ADVC_STATEMENTS_ORDER_DTL_IDS").val(ids);
		$("#form1").attr("action","erpadvcorderstatement.shtml?action=toChildEdit");
		$("#form1").submit();
	});
...
function multiRecDeletes(){
	...
	$.ajax({
		...
		type:"POST",
		dataType:"text",
		data:{"ADVC_STATEMENTS_ORDER_ID":selRowId,"ADVC_STATEMENTS_ORDER_DTL_IDS":ids},
