...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/advisehd/Advisehd_SerCmpl.js"></script>
		...
		<td class="detail2">
			<table width="100%" border="0" cellpadding="1" cellspacing="1" class="detail3">
               ...
               <input id="QX" type="hidden"  value="${QX}" label="当前登录人权限级别" />
				...
				<tr>
					<td width="15%" align="right" class="detail_label" rowspan="5">投诉内容：</td>
					<td width="35%" class="detail_content" colspan="3" rowspan="5">
				...
				<tr>
					<td width="15%" align="right" class="detail_label" rowspan="5">投诉回馈信息：</td>
					<td width="35%" class="detail_content" colspan="3" rowspan="5">
