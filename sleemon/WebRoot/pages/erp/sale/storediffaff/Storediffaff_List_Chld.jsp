...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/storediffaff/Storediffaff_List_Chld.js"></script>
		...
		<div class="lst_area">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
                    ...
                    <th  nowrap="nowrap" align="center" dbname="NOTICE_NUM" >出库数量</th>
