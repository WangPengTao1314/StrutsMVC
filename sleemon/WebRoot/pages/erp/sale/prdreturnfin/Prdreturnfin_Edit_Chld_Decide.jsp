...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/prdreturnfin/Prdreturnfin_Edit_Chld_Decide.js"></script>
	...
	<div class="lst_area">
		...
		<table id="jsontb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
			<tr class="fixedRow">
              ...
              <th nowrap align="center">核价人</th>
              <th nowrap align="center">核价时间</th>
     	 </tr>
		</table>
...
<script type="text/javascript">
	...
	var arrs = [
              ...
              '${rst.RETURN_ATT}',//13
               ...
               '${rst.SN}',//20
               '${rst.DECIDE_PSON_NAME}',//21
               '${rst.DECIDE_TIME}',//22
              '${rst.SPCL_TECH_ID}',//23
              '${rst.SPCL_TECH_FLAG}'//24
            ];
	addRow(arrs);
	</c:forEach>
</script>
