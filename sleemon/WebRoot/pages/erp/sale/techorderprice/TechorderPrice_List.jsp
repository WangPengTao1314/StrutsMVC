...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale//techorderprice/TechorderPrice_List.js"></script>
...
<tr>
	<td height="20px" valign="top">
		...
		<tr>
			<td height="20px">&nbsp;&nbsp;当前位置：销售管理&gt;&gt;工艺单管理&gt;&gt;工艺单核价</td>
			...
			<table id="qxBtnTb" cellSpacing=0 cellPadding=0 border=0 width="100%" style="border:0px">
				<tr>
                  ...
                  <c:if test="${pvg.PVG_AUDIT eq 1 }">
				    <input id="audit" type="button" class="btn" value="核价完成(A)" title="Alt+A" accesskey="A">
				   </c:if>
	...
	<td valign="top">
		<div class="lst_area" style="margin-left:3px;">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
					<th width="1%"></th>
                    <th  nowrap="nowrap" align="center" dbname="TECH_ORDER_NO" >工艺单编号</th>
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setSelEid(document.getElementById('eid${rr}'));">
					 <td width="1%"align='center' >
						<input type="radio" style="height:12px;valign:middle" name="eid" id="eid${rr}" value="${rst.TECH_ORDER_ID}"/>
					 </td>
                     <td nowrap="nowrap" align="center">${rst.TECH_ORDER_NO}&nbsp;</td>
                    ...
                    <input id="state${rst.TECH_ORDER_ID}" type="hidden"  value="${rst.STATE}" />
                    <input id="TECH_ORDER_NO${rst.TECH_ORDER_ID}" type="hidden"  value="${rst.TECH_ORDER_NO}" />
                    <input id="SALE_ORDER_ID${rst.TECH_ORDER_ID}" type="hidden"  value="${rst.FROM_BILL_ID}" />
