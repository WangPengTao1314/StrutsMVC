...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/erp/sale/saleordermge/Saleordermge_Frame.js"></script>
</head>
<BODY>
						...
						<tr>
						   <!--这里加入需要显示的标签页, 注意序号和标签的宽度-->
							<td id="label" nowrap="nowrap">
								<span id="label_1" class="label_down" style="margin-top:2px;">&nbsp;订单明细&nbsp;</span>
						        <span id="label_2" class="label_down1" style="margin-top:2px;">&nbsp;详细信息&nbsp;</span>
						        <span id="label_3" class="label_down1" style="margin-top:2px;">&nbsp;出货情况&nbsp;</span>
