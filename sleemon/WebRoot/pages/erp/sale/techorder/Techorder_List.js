...
$(function(){
	...
	//主从及主从从列表页面通用加载方法
	listPageInit("techorder.shtml?action=toList&module=" + module);
	$("#audit").click(function (){
		...
		parent.showConfirm("是否审核?","topcontent.audit();","N");
	});
	$("#query").click(function(){
		$("#STATE option[text='已核价']").remove();
	});
});
