...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/erpadvcorder/Erpadvcorder_Child_List.js"></script>
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)" id="tr{rr}" onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));">
                     ...
                     <td nowrap="nowrap" align="center" >
                     	 <c:if test="${rst.SPCL_TECH_FLAG ge 1}">
                     	 	...
                     	 	<input type="button" class="btn" value="查看" onclick="showSpec('${rst.SPCL_TECH_ID}')" />
                     	 </c:if>
