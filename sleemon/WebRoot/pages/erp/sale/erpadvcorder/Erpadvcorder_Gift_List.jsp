...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/erpadvcorder/Erpadvcorder_Gift_List.js"></script>
				...
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)" id="tr{rr}" onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));">
					 <td width="1%"align='center' >
						<input type="checkbox"  style="valign:middle"  id="eid${rr}" value="${rst.ERP_ADVC_GIFT_DTL_ID}" onclick="setEidChecked(this);"/>
					 </td>
...
<form id="form1" action="#" method="post" name="listForm">
	<input type="hidden" id="ERP_ADVC_GIFT_DTL_IDS" name="ERP_ADVC_GIFT_DTL_IDS" value=""/>
</form>
</body>
</html>