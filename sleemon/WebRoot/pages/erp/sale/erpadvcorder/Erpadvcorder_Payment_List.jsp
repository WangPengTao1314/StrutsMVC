...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/erp/sale/erpadvcorder/Erpadvcorder_Payment_List.js"></script>
		...
		<div class="lst_area">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
			    <tr class="fixedRow">
                    ...
                    <th  nowrap="nowrap" align="center" dbname="PRD_NO" >付款方式</th>
                    <th  nowrap="nowrap" align="center" dbname="PRD_NAME" >付款单据号</th>
                    <th  nowrap="nowrap" align="center" dbname="PRD_TYPE" >付款金额</th>
                    <th  nowrap="nowrap" align="center" dbname="PRD_SPEC" >付款信息</th>
				</tr>
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)" id="tr{rr}" onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));">
					 <td width="1%"align='center' >
						<input type="checkbox"  style="valign:middle"  id="eid${rr}" value="${rst.PAYMENT_DTL_ID}" onclick="setEidChecked(this);"/>
					 </td>
					  <td nowrap="nowrap" align="center" >${rst.PAY_TYPE}</td>
                     <td nowrap="nowrap" align="left" >${rst.PAY_BILL_NO}&nbsp;</td>
                     <td nowrap="nowrap" align="center" >${rst.PAY_AMONT}&nbsp;</td>
