...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/erp/sale/erpadvcorder/Erpadvcorder_Frame.js"></script>
</head>
<BODY>
						...
						<tr>
						   <!--这里加入需要显示的标签页, 注意序号和标签的宽度-->
							<td id="label" nowrap="nowrap">
						        <span id="label_1" class="label_down1" style="margin-top:2px;">&nbsp;预订单明细&nbsp;</span>
						        <span id="label_2" class="label_down" style="margin-top:2px;">&nbsp;详细信息&nbsp;</span>
						        <span id="label_3" class="label_down" style="margin-top:2px;">&nbsp;付款明细&nbsp;</span>
						        <span id="label_4" class="label_down" style="margin-top:2px;">&nbsp;赠品信息&nbsp;</span>
