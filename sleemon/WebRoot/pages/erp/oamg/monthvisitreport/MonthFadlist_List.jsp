...
<div>
	...
	<ul>
		<li class="li1">
			<a href="#" onclick="openUrl('月度拜访工作计划达成率','report/raq.shtml?action=toFrame&rptConFile=toQueryMonthvisitResult&IS_DRP_LEDGER=${IS_DRP_LEDGER}&backPath=','0')" style="color: black;font-weight: normal;">
				月度拜访工作计划达成率
			</a>
		</li>
		<li class="li1">&nbsp;
