  ...
  <tr>
    <td>
     <div id="topdiv" style="height:32%;width:100%">
	    <!-- 上帧 -->
	    <iframe id="topcontent" name="topcontent" src="monthvisitreport.shtml?action=toConDition&rptConFile=${rptConFile}&reportID=${reportID}&backPath=${backPath}&sjcd=${sjcd}"  frameBorder=0 width="100%" height="100%" frameborder="0" scrolling="AUTO"></iframe>
	  </div>
