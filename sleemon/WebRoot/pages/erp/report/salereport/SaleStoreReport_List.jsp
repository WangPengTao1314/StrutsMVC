...
<div>
	...
	<ul>
		<li class="li1">
			<c:if test="${pvg.PVG_BWS_STOCK eq 1}">
			<a 
					href="#" onclick="openUrl('库存查询','querystock.shtml?action=toFrames','0')" style="color: black;font-weight: normal;"
			>
				库存查询
			</a>
			</c:if>
			<c:if test="${pvg.PVG_BWS_STOCK ne 1}">
				<a href="#">&nbsp;</a>
			</c:if>
		</li>
		<li class="li1">
			<c:if test="${pvg.PVG_ERP_STORE_BWS eq 1}">
			...
			<c:if test="${pvg.PVG_ERP_STORE_BWS ne 1}">
				<a href="#">&nbsp;</a>
			</c:if>
		</li>
		<li class="li1">&nbsp;
