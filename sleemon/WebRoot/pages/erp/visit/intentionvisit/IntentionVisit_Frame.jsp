...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/erp/visit/intentionvisit/IntentionVisit_Frame.js"></script>
	<title>门店拜访表维护</title>
</head>
<body>
	           ...
	           <table cellSpacing=0 cellPadding=0 border=0 width="100%">
				<tr>
					...
					<td id="label" nowrap="nowrap">
						...
						<span id="label_2" class="label_down" style="margin-top:2px;">&nbsp;意向客户评估表&nbsp;</span>
