									...
									<td class="detail2">
										<table width="100%" border="0" cellpadding="1" cellspacing="1"
											...
											<tr>
												...
												<td width="35%" class="detail_content">												
													<select json="PRVD_TYPE" id="PRVD_TYPE" name="PRVD_TYPE" style="width:155" autocheck="true" mustinput="true" inputtype="string"></select>
													</select>													
												</td>
												<td width="15%" align="right" class="detail_label">
													供应商级别：
												...
												<td width="35%" class="detail_content">
													<select json="PRVD_LVL" id="PRVD_LVL" name="PRVD_LVL" style="width:155" autocheck="true" mustinput="true" inputtype="string"></select>												
												</td>
											</tr>
											<tr>
												<td width="15%" align="right" class="detail_label" nowrap>
												...
												<td width="35%" class="detail_content">
													<select json="PRVD_NATRUE" id="PRVD_NATRUE" name="PRVD_NATRUE" style="width:155" autocheck="true" mustinput="true" inputtype="string"></select>	
												</td>
												<td width="15%" align="right" class="detail_label" nowrap>
													是否默认供应商：
												</td>
												<td width="35%" class="detail_content">
													<input type="checkbox"  id="DEFAULT_FLAGCHECK" onclick="DEFAULT_FLAGClick()">
													<input type="hidden" id="DEFAULT_FLAG" name="DEFAULT_FLAG" json="DEFAULT_FLAG" value="${rst.DEFAULT_FLAG}"/>
													<script type="text/javascript">
														var DEFAULT_FLAG='${rst.DEFAULT_FLAG}';
														if(1==DEFAULT_FLAG){
															$("#DEFAULT_FLAGCHECK").attr("checked","true");
														}else{
															$("#DEFAULT_FLAGCHECK").removeAttr("checked");
														}
													</script>
												</td>
											</tr>
											...
											<tr>
												...
												<td width="35%" class="detail_content">
													<select  json="PRVD_CY" label="供应周期" id="PRVD_CY" name="PRVD_CY" valueType="chinese:false"
													 inputtype="string" style="width: 155" value="${rst.PRVD_CY}">
													</select>
												</td>
											</tr>
											<tr>
												...
												<td width="35%" class="detail_content">
													<select  json="PRVD_CAP" label="供应能力" id="PRVD_CAP" name="PRVD_CAP" valueType="chinese:false"
													 inputtype="string" style="width: 155" value="${rst.PRVD_CY}">
													</select>
												</td>
												<td width="15%" align="right" class="detail_label">
												...
												<td width="35%" class="detail_content">
													<input json="PERSON_BUSS" name="PERSON_BUSS" type="text" autocheck="true"
														label="业务员" inputtype="string"  mustinput="true" maxlength="30" value="${rst.PERSON_BUSS }">
												</td>
											</tr>
											<tr>
												<td width="15%" align="right" class="detail_label">
											...
											<tr>
												...
												<td width="35%" class="detail_content">
													<input json="LEGAL_REPRE" name="LEGAL_REPRE" type="text" autocheck="true"
														label="法人代表" inputtype="string" maxlength="30"
														value="${rst.LEGAL_REPRE }">
												</td>
											</tr>
											<tr>
												<td width="15%" align="right" class="detail_label">
												...
												<td width="35%" class="detail_content">
													<input json="BUSS_LIC" name="BUSS_LIC" type="text" autocheck="true"
														label="营业执照号" inputtype="string" maxlength="30"
														value="${rst.BUSS_LIC }">
												</td>
												<td width="15%" align="right" class="detail_label">
													发票抬头：
												...
												<td width="35%" class="detail_content">
													<input json="INVOICE_TI" name="INVOICE_TI" type="text" autocheck="true"
														label="发票抬头" inputtype="string" maxlength="100"
														value="${rst.INVOICE_TI }">
												</td>
											</tr>
											<tr>
												<td width="15%" align="right" class="detail_label">
												...
												<td width="35%" class="detail_content">
													<input json="INVOICE_ADDR" name="INVOICE_ADDR" type="text" autocheck="true"
														label="发票地址" inputtype="string" maxlength="100"
														value="${rst.INVOICE_ADDR }">
												</td>
												<td width="15%" align="right" class="detail_label">
													开户行：
												</td>
											...
											<tr>
												...
												<td width="35%" class="detail_content">
													<input json="FI_CMP_NO" name="FI_CMP_NO" type="text" autocheck="true"
														label="财务对照码" inputtype="string" maxlength="30"
														value="${rst.FI_CMP_NO }">
												</td>
											</tr>
											...
											<tr>
												...
												<td width="35%" class="detail_content" colspan="3">													
													...
													maxlength="250" rows="3" cols="83%">${rst.ADDRESS }</textarea>
												</td>												
											</tr>
											<tr>
												<td width="15%" align="right" class="detail_label" nowrap>
												...
												<td width="35%" class="detail_content" colspan="3">													
													...
													maxlength="250" rows="3" cols="83%">${rst.REMARK }</textarea>
												</td>												
											</tr>
										</table>
									</td>
