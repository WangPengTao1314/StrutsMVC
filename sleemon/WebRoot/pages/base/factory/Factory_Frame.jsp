...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/base/factory/Factory_Frame.js"></script>
					...
					<table cellSpacing=0 cellPadding=0 border=0 width="100%">
						<tr>
							...
							<td id="label" nowrap="nowrap">
								...
								<span id="label_2" class="label_down1" style="margin-top: 2px;font-size:13">&nbsp;生产货品类型&nbsp;</span>
