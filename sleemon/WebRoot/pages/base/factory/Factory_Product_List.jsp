...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/base/factory/Factory_Product_List.js"></script>
				...
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));">
					 <td width="1%"align='center' >
						<input type="checkbox"  style="height:12px;valign:middle"  id="eid${rr}" value="${rst.FACTORY_PRD_ID}" onclick="setEidChecked(this);"/>
					 </   td>
...
<form id="form1" action="#" method="post" name="listForm">
	<input type="hidden" id="FACTORY_PRD_IDS" name="FACTORY_PRD_IDS" value=""/>
</form>
</body>
</html>