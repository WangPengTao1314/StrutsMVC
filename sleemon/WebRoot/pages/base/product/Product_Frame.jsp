...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/base/product/Product_Frame.js">
</script>
</head>
<BODY>
					...
					<table cellSpacing=0 cellPadding=0 border=0 width="100%">
						<tr>							
							...
							<td id="label" nowrap="nowrap">
								...
								<span id="label_2" class="label_down1" style="margin-top: 2px;">&nbsp;货品特殊工艺维护&nbsp;</span>
								<span id="label_3" class="label_down1" style="margin-top:2px;">&nbsp;货品计量单位&nbsp;</span>
								 <span id="label_4" class="label_down1" style="margin-top:2px;">&nbsp;货品套明细&nbsp;</span>
