...
$(function () {
	...
	//页面初始化
	listPageInit("product.shtml?action=toDrpList&module="+module);
	...
	$("#tempUp").click(function(){
		window.location="product.shtml?action=ExcelOutput&DRPFLAG=1";
	})
	...
	$("#export").click(function(){
	   $("#queryForm").attr("action","product.shtml?action=toExpData&module=" + module);
	   $("#queryForm").submit();
	});
