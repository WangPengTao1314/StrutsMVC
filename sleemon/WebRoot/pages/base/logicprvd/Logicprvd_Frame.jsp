...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/base/logicprvd/Logicprvd_Frame.js"></script>
</head>
<BODY>
						...
						<tr>
						   <!--这里加入需要显示的标签页, 注意序号和标签的宽度-->
							<td id="label" nowrap="nowrap">
								...
								<span id="label_2" class="label_down1" style="margin-top: 2px;font-size:13">&nbsp;车型明细&nbsp;</span>
								<span id="label_3" class="label_down1" style="margin-top: 2px;font-size:13">&nbsp;合并路线&nbsp;</span>
