			...
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setSelEid(document.getElementById('eid${rr}'));">
                        ...
                        <td nowrap align="left">${rst.CRE_TIME}&nbsp;</td>
			...
			<table width="100%" border="0" cellpadding="1" cellspacing="1" class="detail3">
				<tr>
					...
					<td nowrap width="15%" class="detail_content">
						...
						<input type="text" name="AREA_NO" seltarget="selJGXX" value="${params.AREA_NO}" inputtype="string"  autocheck="true" />
                       
                        <input id="AREA_ID1" name="AREA_ID1" type="hidden" seltarget="selJGXX" value="${params.AREA_ID}">
					...
					<td width="15%" class="detail_content">
						<input type="text" json="AREA_NAME" name="AREA_NAME" seltarget="selJGXX" value="${params.AREA_NAME}"/>
					</td>
