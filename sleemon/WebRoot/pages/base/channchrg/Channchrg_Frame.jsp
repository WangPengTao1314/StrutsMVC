...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/base/channchrg/Channchrg_Frame.js"></script>
</head>
<BODY>
	<table cellspacing="0" cellpadding="0" width="99.9%" height="100%">
		<tr>
			...
			<td valign="top" height="95%">
				<div id="topdiv" style="height: 33%; width: 100%">
					...
					<table cellSpacing=0 cellPadding=0 border=0 width="100%">
						<tr>
							...
							<td id="label" nowrap="nowrap">
								<span id="label_1" class="label_down" style="margin-top: 2px;">&nbsp;分管信息&nbsp;</span>
