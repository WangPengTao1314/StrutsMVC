...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/store/dbstoreout/Dbstoreout_List.js"></script>
...
<tr>
	<td height="20px" valign="top">
		...
		<tr>
			<td height="20px">&nbsp;&nbsp;当前位置：库存管理&gt;&gt;出库管理&gt;&gt;调拨出库处理</td>
			...
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
                    ...
                    <td nowrap="nowrap" align="center">
                      <c:if test="${empty rst.STORAGE_FLAG || rst.STORAGE_FLAG eq 0}">
                     	否 
                      </c:if>
