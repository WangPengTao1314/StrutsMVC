...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/store/allocate/Allocate_List_Chld.js"></script>
		...
		<div class="lst_area">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
                    ...
                    <th  nowrap="nowrap" align="center" dbname="ALLOC_NUM" >调拨数量</th>
				...
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));">
					 <td width="1%"align='center' >
						<input type="checkbox"  style="height:12px;valign:middle"  id="eid${rr}" value="${rst.ALLOCATE_DTL_ID}" onclick="setEidChecked(this);"/>
					 </td>
                     ...
                     <td nowrap="nowrap" align="right" >${rst.ALLOC_NUM}&nbsp;</td>
...
<form id="form1" action="#" method="post" name="listForm">
	<input type="hidden" id="ALLOCATE_DTL_IDS" name="ALLOCATE_DTL_IDS" value=""/>
</form>
</body>
</html>