...
function childSave(){
	...
	var rows = eval('('+jsonData+')');
	$.ajax({
		url: "rtstoreout.shtml?action=storgChildEdit&STOREOUT_ID="+storeoutId+"&STOREOUT_DTL_ID="+storeoutDtlId,
		type:"POST",
		dataType:"text",
...
//查找当前是否有选中的记录
	...
	$.ajax({
		url: "rtstoreout.shtml?action=storegChildDelete&BILL_TYPE="+billType,
		type:"POST",
		dataType:"text",
