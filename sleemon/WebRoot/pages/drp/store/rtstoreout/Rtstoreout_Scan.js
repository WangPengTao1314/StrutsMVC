...
function addRow(arrs){
	...
	$("#jsontb tr:last-child")
            ...
            .append('<td nowrap align="left"><input  json="SN" id="SN'+rownum+'" name="SN'+rownum+'"  autocheck="true" label="货品序列号"  type="text" mustinput="true"   maxlength="50" size="12"  value="'+arrs[2]+'"  onkeyup="'+functionText+'"  />&nbsp;</td>')
