...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/drp/store/storein/Storein_Frame.js"></script>
</head>
<BODY>
						...
						<tr>
						   <!--这里加入需要显示的标签页, 注意序号和标签的宽度-->
							<td id="label" nowrap="nowrap">
								<span id="label_1" class="label_down" style="margin-top:2px;">&nbsp;入库单明细&nbsp;</span>
								<%--
								<span id="label_2" class="label_down1" style="margin-top:2px;">&nbsp;入库单库位明细&nbsp;</span>
						        --%>
...
<input type="hidden" id="STOREIN_DTL_ID" value=""/>
