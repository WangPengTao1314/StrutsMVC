...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/drp/store/sporadicstoreout/Sporadicstoreout_Frame.js"></script>
</head>
<BODY>
						...
						<tr>
						   <!--这里加入需要显示的标签页, 注意序号和标签的宽度-->
							<td id="label" nowrap="nowrap">
								<span id="label_1" class="label_down" style="margin-top:2px;">&nbsp;出库单明细&nbsp;</span>
								<span id="label_2" class="label_down1" style="margin-top:2px;">&nbsp;出库单库位明细&nbsp;</span>
...
<input type="hidden" id="STORAGE_FLAG" value=""/>
<input type="hidden" id="BILL_TYPE" value="${BILL_TYPE}"/>
<input type="hidden" id="STOREOUT_STORE_ID" value=""/>
</body>