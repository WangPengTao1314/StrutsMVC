...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/store/storeout/Salestoreout_List.js"></script>
...
<tr>
	<td height="20px" valign="top">
		...
		<tr>
			<td height="20px">&nbsp;&nbsp;当前位置：库存管理>>出库管理>>销售出库处理</td>
		...
		<div class="tablayer" style="margin-left:3px; border-bottom:1px solid #d3d3d3; padding-bottom:3px; margin-bottom:3px;">
			<table id="qxBtnTb" cellSpacing=0 cellPadding=0 border=0 width="100%" style="border:0px">
				...
				　　<input id="print" type="button" class="btn" value="打印(P)" title="Alt+P" accesskey="P">
					...
					总数量：<span style="margin-right: 20px;" id="totalAmount">${delMap.NUM_AMOUNT}</span>
					总金额：<span style="margin-right: 20px;" id="totalNum">${delMap.DECT_AMOUNT}</span>
			                    处理日期：<span style="margin-right: 20px;" id="totalNum">${delMap.DEAL_TIME}</span>
			        </span> 
...
<!--				    		</tr>-->
							<tr>
				    			...
				    			<td class="">
				    				<input type="text" json="ORDER_RECV_DATE" id="ORDER_RECV_DATE" name="ORDER_RECV_DATE" autocheck="true" inputtype="string" label="要求到货日期"  value="${rst.ORDER_RECV_DATE}" onclick="SelectDate();" readonly />
...
<!--                     </c:if>-->
                     ...
                     <td nowrap="nowrap" aling="center">${rst.ORDER_RECV_DATE}</td>
                    ...
                    <input id="ORDER_RECV_DATE${rst.STOREOUT_ID}" type="hidden"  value="${rst.ORDER_RECV_DATE}" />
				    </tr>
				</c:forEach>
			...
			<table width="100%" border="0" cellpadding="1" cellspacing="1" class="detail3">
               <tr>
                   <td width="8%" nowrap align="right" class="detail_label">出库单编号:</td>
					...
					<td width="15%" class="detail_content">
						<input id="TERM_ID" name="TERM_ID" type="hidden" style="width:155" value="${params.TERM_ID}"/>
	   					...
	   					<img align="absmiddle" name="selTERM_NO" style="cursor: hand"src="${ctx}/styles/${theme}/images/plus/select.gif"
							onClick="selCommon('BS_27', false, 'TERM_ID', 'TERM_ID', 'forms[1]','TERM_ID,TERM_NO,TERM_NAME', 'TERM_ID,TERM_NO,TERM_NAME', 'termParam')">
