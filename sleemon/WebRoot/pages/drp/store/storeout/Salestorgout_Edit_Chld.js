...
function childSave(){
	...
	var rows = eval('('+jsonData+')');
	$.ajax({
		url: "storeout.shtml?action=storgChildEdit&STOREOUT_ID="+storeoutId+"&STOREOUT_DTL_ID="+storeoutDtlId,
		type:"POST",
		dataType:"text",
...
//查找当前是否有选中的记录
	...
	$.ajax({
		url: "storeout.shtml?action=storegChildDelete&BILL_TYPE="+billType,
		type:"POST",
		dataType:"text",
