...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/store/repairstoreout/Repairstoreout_List.js"></script>
...
<tr>
	<td height="20px" valign="top">
		...
		<tr>
			<td height="20px">&nbsp;&nbsp;当前位置：库存管理>>出库管理>>返修出库处理</td>
...
<!--				　　<input id="b_print" type="button" class="btn" value="打印(P)" title="Alt+P" accesskey="P">-->
				</td>
				</tr>
			</table>
		</div>
			...
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);childType('${rst.STORAGE_FLAG}');setSelEid(document.getElementById('eid${rr}'));setStoreId('${rst.STOREOUT_STORE_ID}')">
                     ...
                     <%--
                     <c:if test="${rst.STORAGE_FLAG ne 1}">
...
<form id="queryForm" method="post" action="#">
  <input id="selStoreoutParam" name="selectParams" type="hidden" value=" DEL_FLAG=0 and BILL_TYPE = '${params.BILL_TYPE}'"/>
