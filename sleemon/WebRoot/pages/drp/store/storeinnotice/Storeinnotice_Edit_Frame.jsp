...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/drp/store/storeinnotice/Storeinnotice_Edit_Frame.js"></script>
</head>
<BODY>
			...
			<table cellSpacing=0 cellPadding=0 border=0 width="100%">
				<tr>
					...
					<td id="label" nowrap="nowrap">
						<span id="label_1" class="label_down" style="margin-top:2px;">&nbsp;入库通知单维护明细&nbsp;</span>
