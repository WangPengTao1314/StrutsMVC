...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/store/dstrstoreout/Dstrstoreout_List.js"></script>
...
<tr>
	<td height="20px" valign="top">
		...
		<tr>
			<td height="20px">&nbsp;&nbsp;当前位置：库存管理&gt;&gt;出库管理&gt;&gt;分发出库处理</td>
	...
	<td height="20">
		<div class="tablayer" style="margin-left:3px; border-bottom:1px solid #d3d3d3; padding-bottom:3px; margin-bottom:3px;">
			<table id="qxBtnTb" cellSpacing=0 cellPadding=0 border=0 width="100%" style="border:0px">
				<tr>
                  <td nowrap>
                   <c:if test="${pvg.PVG_FCOMMIT_CANCLE eq 1 }">
		...
		<div class="lst_area" style="margin-left:3px;">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
                    ...
                    <th  nowrap="nowrap" align="center" dbname="STOREIN_NO" >入库通知单编号</th>
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);childType('${rst.STORAGE_FLAG}');setSelEid(document.getElementById('eid${rr}'));setStoreId('${rst.STOREOUT_STORE_ID}');">
                     ...
                     <td nowrap="nowrap" align="center">
                     	<c:if test="${empty rst.STORAGE_FLAG || rst.STORAGE_FLAG eq 0}">否</c:if>
...
<form id="queryForm" method="post" action="#">
 <input id="selStoreoutParam" name="selStoreoutParam" type="hidden" value=" DEL_FLAG=0 and BILL_TYPE = '${params.BILL_TYPE}'"/>
  ...
  <input id="selectParam" name="selectParam" type="hidden" value=" STATE in( '启用','停用') and DEL_FLAG=0 and LEDGER_ID = '${params.LEDGER_ID}'"/>
					...
					<td width="15%" class="detail_content">
						<input id="RECV_CHANN_ID" name="RECV_CHANN_ID" type="hidden" style="width:155" value="${params.RECV_CHANN_ID}"/>
	   					...
	   					<img align="absmiddle" name="selCHANN_NO" style="cursor: hand"src="${ctx}/styles/${theme}/images/plus/select.gif"
							onClick="selCommon('BS_19', false, 'RECV_CHANN_ID', 'CHANN_ID', 'forms[1]','RECV_CHANN_ID,RECV_CHANN_NO,RECV_CHANN_NAME', 'CHANN_ID,CHANN_NO,CHANN_NAME', 'selectParams')">
