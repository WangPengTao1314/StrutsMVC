...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/drp/store/storeoutfewnotice/Storeoutfewnotice_Edit_Frame.js"></script>
</head>
<BODY>
			...
			<table cellSpacing=0 cellPadding=0 border=0 width="100%">
				<tr>
					...
					<td id="label" nowrap="nowrap">
						<span id="label_1" class="label_down" style="margin-top:2px;">&nbsp;出库通知单明细&nbsp;</span>
