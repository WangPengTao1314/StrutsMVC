...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/store/storeoutfewnotice/Storeoutfewnotice_List_Chld.js"></script>
				...
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));">
					 <td width="1%"align='center' >
						<input type="checkbox"  style="height:12px;valign:middle"  id="eid${rr}" value="${rst.FEW_STOREOUT_REQ_DTL_ID}" onclick="setEidChecked(this);"/>
					 </td>
...
<form id="form1" action="#" method="post" name="listForm">
	<input type="hidden" id="FEW_STOREOUT_REQ_DTL_IDS" name="FEW_STOREOUT_REQ_DTL_IDS" value=""/>
	<input type="hidden" id="FEW_STOREOUT_REQ_ID" name="FEW_STOREOUT_REQ_ID" value="${FEW_STOREOUT_REQ_ID}"/>
</form>
</body>
</html>