...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/store/storediff/Storediffdeal_List_Chld.js"></script>
		...
		<div class="lst_area">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
                    ...
                    <th  nowrap="nowrap" align="center" dbname="DIFF_RSON" >差异原因</th>
                    <th  nowrap="nowrap" align="center" dbname="DEAL_WAY" >处理方式</th>
                    <th  nowrap="nowrap" align="center" dbname="DIFF_AMOUNT" >折后差异金额</th>
                    <th  nowrap="nowrap" align="center" dbname="DIFF_ATT" >差异附件</th>
				...
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));">
					 <td width="1%"align='center' >
						<input type="checkbox"  style="height:12px;valign:middle"  id="eid${rr}" value="${rst.DIFF_DEAL_DTL_ID}" onclick="setEidChecked(this);"/>
					 </td>
                     ...
                     <td nowrap="nowrap" align="left" >${rst.DIFF_RSON}&nbsp;</td>
                     <td nowrap="nowrap" align="left" >${rst.DEAL_WAY}&nbsp;</td>
