...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/drp/store/storediff/Storediff_Frame.js"></script>
</head>
<BODY>
<table cellspacing="0" cellpadding="0" width="99.9%" height="98%">
		<tr>
			<td >
						...
						<tr>
						   <!--这里加入需要显示的标签页, 注意序号和标签的宽度-->
							<td id="label" nowrap="nowrap">
								<span id="label_1" class="label_down" style="margin-top:2px;">&nbsp;入库差异明细&nbsp;</span>
								<span id="label_2" class="label_down1" style="margin-top:2px;">&nbsp;差异处理明细&nbsp;</span>
						        <span id="label_3" class="label_down1" style="margin-top:2px;">&nbsp;详细信息&nbsp;</span>
				...
				<div id="bottomdiv" style="height: 43%; width: 100%">
					<!-- 下帧 -->
					<iframe id="bottomcontent" name="bottomcontent" src="#" frameBorder=0 width="100%" height="100%" frameborder="0"></iframe>
				</div>
			</td>
		</tr>
	</table>
...
<input type="hidden" id="STOREIN_DIFF_DTL_ID" value=""/>
