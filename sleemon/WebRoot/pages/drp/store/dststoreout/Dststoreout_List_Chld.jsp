...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/store//dststoreout/Dststoreout_List_Chld.js"></script>
		...
		<div class="lst_area">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
                    ...
                    <th  nowrap="nowrap" align="center" dbname="SPCL_TECH_ID" >订单特殊工艺ID</th>
                    ...
                    <th  nowrap="nowrap" align="center" dbname="RECV_NUM" >出库数量</th>
...
<form id="form1" action="#" method="post" name="listForm">
	...
	<input type="hidden" id="STOREOUT_ID" name="STOREOUT_ID" value="">
</form>
</body>
</html>