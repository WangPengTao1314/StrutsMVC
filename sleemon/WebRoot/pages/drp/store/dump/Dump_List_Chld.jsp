...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/store/dump/Dump_List_Chld.js"></script>
...
<!--                    <th  nowrap="nowrap" align="center" dbname="DUMP_OUT_STORG_NO" >转出库位编号</th>-->
<!--                    <th  nowrap="nowrap" align="center" dbname="DUMP_OUT_STORG_NAME" >转出库位名称</th>-->
<!--                    <th  nowrap="nowrap" align="center" dbname="DUMP_IN_STORG_NO" >转入库位编号</th>-->
<!--                    <th  nowrap="nowrap" align="center" dbname="DUMP_IN_STORG_NAME" >转入库位名称</th>-->
                    <th  nowrap="nowrap" align="center" dbname="DUMP_NUM" >转储数量</th>
				...
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));">
					 <td width="1%"align='center' >
						<input type="checkbox"  style="valign:middle"  id="eid${rr}" value="${rst.DUMP_DTL_ID}" onclick="setEidChecked(this);"/>
					 </td>
...
<!--                     <td nowrap="nowrap" align="center" >${rst.DUMP_OUT_STORG_NO}&nbsp;</td>-->
<!--                     <td nowrap="nowrap" align="left" >${rst.DUMP_OUT_STORG_NAME}&nbsp;</td>-->
<!--                     <td nowrap="nowrap" align="center" >${rst.DUMP_IN_STORG_NO}&nbsp;</td>-->
<!--                     <td nowrap="nowrap" align="left" >${rst.DUMP_IN_STORG_NAME}&nbsp;</td>-->
                     <td nowrap="nowrap" align="right" >${rst.DUMP_NUM}&nbsp;</td>
...
<form id="form1" action="#" method="post" name="listForm">
	<input type="hidden" id="DUMP_DTL_IDS" name="DUMP_DTL_IDS" value=""/>
</form>
</body>
</html>