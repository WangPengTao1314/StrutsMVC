/**
 * @prjName:喜临门营销平台
 * @fileName:Termreturnstoreout_Edit_Chld
 * @author lyg
...
function allSave(){
	...
	$.ajax({
		url: "termreturnstoreout.shtml?action=edit",
		type:"POST",
		dataType:"text",
		...
		complete: function (xhr){
			...
			if(jsonResult.success===true){
				saveSuccess("保存成功","termreturnstoreout.shtml?action=toFrame");
			}else{
...
function childSave(){
	...
	$.ajax({
		url: "termreturnstoreout.shtml?action=childEdit",
		type:"POST",
		dataType:"text",
...
//查找当前是否有选中的记录
	...
	$.ajax({
		url: "termreturnstoreout.shtml?action=childDelete",
		type:"POST",
		dataType:"text",
...
function gobacknew()
{
   newGoBack("termreturnstoreout.shtml?action=toFrame");
}
