...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale//repairapp/Repairapp_List_Chld.js"></script>
...
<!--                     <td nowrap="nowrap" align="left" >${rst.PRD_COLOR}&nbsp;</td>-->
                     ...
                     <td nowrap="nowrap" align="center" >
					 	...
					 	<c:choose>
					 		 <c:when test="${rst.SPCL_TECH_FLAG == '1'}">
					 		 	<span  style="color: red">有</span>
                     			<input type="button" class="btn" value="查看" onclick="showSpecTech('${rst.SPCL_TECH_ID}','${module}','${rst.REPAIR_PRICE}')" />
					 		 </c:when>
					 		 <c:when test="${rst.SPCL_TECH_FLAG == '2'}">
					 		 	<span  style="color: red">有</span>
                     			<input type="button" class="btn" value="查看" onclick="showSpecTech('${rst.SPCL_TECH_ID}','${module}','${rst.REPAIR_PRICE}')" />
					 		 </c:when>
                     ...
                     <td nowrap="nowrap" align="left" >
                        <input type="hidden" id="REPAIR_ATT${rr}" value="${rst.REPAIR_ATT}">
                     </td>
				    </tr>
				    <script language="JavaScript">
						displayDownFile('REPAIR_ATT${rr}','SAMPLE_DIR',true,false);
					</script>
				</c:forEach>
				<c:if test="${empty rst}">
					<tr>
