...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale/saleordera/Saleordera_List_AllPrint.js"></script>
               ...
               <tr>
					...
					<td width="15%" class="detail_content">
                       ...
                       <img align="absmiddle" name="" style="cursor: hand"
							...
							onClick="selCommon('BS_27', false, 'ORDER_CHANN_ID', 'TERM_ID', 'forms[0]','ORDER_CHANN_ID,ORDER_CHANN_NO,ORDER_CHANN_NAME','TERM_ID,TERM_NO,TERM_NAME',  'selectTERM');"> 
					</td>					
...
<iframe id='ifa' style="display: none" src></iframe>	
</table>
		</form>
		</div>
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);">
					 <td width="1%"align='center' >
						<input type="checkbox" style="height:12px;valign:middle" name="eid" id="eid${rr}" value="${rst.SALE_ORDER_ID}"/>
					 </td>
