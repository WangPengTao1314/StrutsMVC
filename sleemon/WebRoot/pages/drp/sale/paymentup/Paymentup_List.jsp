...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale//paymentup/Paymentup_List.js"></script>
...
<tr>
	<td height="20px" valign="top">
		...
		<tr>
			<td height="20px">&nbsp;&nbsp;当前位置：销售管理&gt;&gt;我的订货订单&gt;&gt;付款凭证上传</td>
...
<script type="text/javascript">
	   SelDictShow("STATE","BS_19","${params.STATE}","");
</script>