...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale/advcgoodslook/Advcgoodslook_List_Chld.js"></script>
...
<!--                    <th  nowrap="nowrap" align="center" dbname="PRD_COLOR" >花号</th>-->
                    ...
                    <th  nowrap="nowrap" align="center" dbname="SEND_NUM" >已发货数量</th>
				...
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));setSelOperateEx();">
					 <td width="1%"align='center' >
						<input type="checkbox"  style="valign:middle"  id="eid${rr}" value="${rst.ADVC_ORDER_DTL_ID}" onclick="setEidChecked(this);"/>
					 </td>
...
<!--                     <td nowrap="nowrap" align="left" >${rst.FREEZE_STORE_NAME}&nbsp;</td>-->
                     ...
                     <td nowrap="nowrap" align="left" >${rst.REMARK}&nbsp;</td>  
                      <input type="hidden" id="SEND_DATE_DIFF" name="SEND_DATE_DIFF" value="${rst.SEND_DATE_DIFF}"/>
				    </tr>
				</c:forEach>
				<c:if test="${empty rst}">
					<tr>
