...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale/repairstoreout/Repairstoreout_List_Chld.js"></script>
                      ...
                      <td nowrap="nowrap" align="center" >
					 	<c:if test="${rst.SPCL_TECH_FLAG ge 1}">
					 		<font color="red"> 有 </font>
                       		<input type="button" class="btn" value="查看" onclick="shouTechPage('${rst.SPCL_TECH_ID}');"/>
					 	</c:if>
