...
function allSave(){
	...
	//alert(childData);
	$.ajax({
		url: "repairout.shtml?action=edit",
		type:"POST",
		dataType:"text",
		...
		complete: function (xhr){
			...
			if(jsonResult.success===true){
				saveSuccess("保存成功","repairout.shtml?action=toFrame");
			}else{
...
function childSave(){
	...
	$.ajax({
		url: "repairout.shtml?action=childEdit",
		type:"POST",
		dataType:"text",
...
//查找当前是否有选中的记录
	...
	$.ajax({
		url: "repairout.shtml?action=childDelete",
		type:"POST",
		dataType:"text",
...
function gobacknew()
{
   newGoBack("repairout.shtml?action=toFrame");
}
...
function addRow(arrs){
	...
	$("#jsontb tr:last-child")
            ...
            .append('<td nowrap align="left"><input  json="REPAIR_NUM" id="REPAIR_NUM'+rownum+'" name="REPAIR_NUM'+rownum+'"  autocheck="true" label="返修数量"  type="text"   inputtype="int"        maxlength="22"  value="'+arrs[8]+'"/>&nbsp;</td>')
            .append('<td nowrap align="left"><input  json="REPAIR_RESON" id="REPAIR_RESON'+rownum+'" name="REPAIR_RESON'+rownum+'"  autocheck="true" label="返修原因"  type="text"   inputtype="string"     mustinput="true"     maxlength="250"  value="'+arrs[9]+'"/>&nbsp;</td>')
            .append('<td nowrap align="left"><input  json="REPAIR_ATT" id="REPAIR_ATT'+rownum+'" name="REPAIR_ATT'+rownum+'" type="text" value="'+arrs[10]+'"/>&nbsp;</td>')
