...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale/repairout/Repairstoreout_Edit_Chld.js"></script>
...
<td>
	<div class="lst_area">
		...
		<input type="hidden" name="selectContion" value=" STATE='启用' and DEL_FLAG=0 and FINAL_NODE_FLAG=1 ">
