...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale/prdreturnreq/Prdreturnreq_List_Chld.js"></script>
...
<tr>
	<td valign="top">
		<div class="lst_area" style="margin-top: -10px;">
...
<!--                    <th  nowrap="nowrap" align="center" dbname="PRD_COLOR" >花号</th>-->
                    ...
                    <th  nowrap="nowrap" align="center" dbname="USE_TIME" >使用时间</th>
                    <th  nowrap="nowrap" align="center" dbname="SHIP_POINT_NAME" >生产基地</th>
                    <th  nowrap="nowrap" align="center" dbname="PRDC_DATE" >生产时间</th>
...
<!--                     <td nowrap="nowrap" align="left" >${rst.PRD_COLOR}&nbsp;</td>-->
                     ...
                     <td nowrap="nowrap" align="left" >${rst.USE_TIME}&nbsp;(月)</td>
                     <td nowrap="nowrap" align="left" >${rst.SHIP_POINT_NAME}&nbsp;</td>
                     <td nowrap="nowrap" align="left" >${rst.PRDC_DATE}&nbsp;</td>
