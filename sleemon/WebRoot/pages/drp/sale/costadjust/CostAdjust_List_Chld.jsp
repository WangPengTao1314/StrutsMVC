...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale/costadjust/CostAdjust_List_Chld.js"></script>
		...
		<div class="lst_area">
			<table id="ordertb" style="margin-left:3px; " width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
                    ...
                    <th  nowrap="nowrap" align="center" dbname="CUR_COST_PRICE" >原成本单价</th>
                    <th  nowrap="nowrap" align="center" dbname="NEW_COST_PRICE" >调整后成本单价</th>
				...
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));">
					 <td width="1%"align='center' >
						<input type="checkbox"  style="height:12px;valign:middle"  id="eid${rr}" value="${rst.COST_ADJUST_DTL_ID}" onclick="setEidChecked(this);"/>
					 </td>
                     ...
                     <td nowrap="nowrap" align="right" >${rst.CUR_COST_PRICE}&nbsp;</td>
                     <td nowrap="nowrap" align="right" >${rst.NEW_COST_PRICE}&nbsp;</td>
...
<form id="form1" action="#" method="post" name="listForm">
	<input type="hidden" id="COST_ADJUST_DTL_IDS" name="COST_ADJUST_DTL_IDS" value=""/>
	<input type="hidden" id="COST_ADJUST_ID" name="COST_ADJUST_ID" value=""/>
</form>
</body>
</html>