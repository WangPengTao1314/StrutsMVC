...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale/adviseinit/Adviseinit_Advs.js"></script>
	<title>建议</title>
</head>
<body class="bodycss1">
...
<table width="100%" border="0" cellpadding="4" cellspacing="4" class="detail">
	...
	<tr>
		<td style="height: 15px">
			<input type="button" id="check" name="check" class="btn" value="查看我的建议">
		</td>
	</tr>
	<tr>
		<td class="detail2">
			<table width="100%" border="0" cellpadding="1" cellspacing="1" class="detail3" id="maintable">
               ...
               <tr>
               		<td width="15%" align="right" class="detail_label">建议编号:</td>
					<td width="35%" class="detail_content">
                        <input type="text" value="系统自动生成" autocheck="true" inputtype="string"" label="建议编号" id="CMPL_ADVS_ID" name="CMPL_ADVS_ID" readonly/>
					</td>
               ...
               <tr>
					...
					<td width="35%" class="detail_content">
                        ...
                        <input type="text" json="CHANN_NO" id="CHANN_NO" name="CHANN_NO"  autocheck="true" label="渠道编号" value="${channInfo.CHANN_NO}" inputtype="string" mustinput="true" readonly/>
...
<!--							onClick="selCommon('BS_18', false, 'AREA_ID', 'AREA_ID', 'forms[0]','AREA_NO,AREA_NAME','AREA_NO,AREA_NAME', 'selectParams')"> -->
					...
					<td width="35%" class="detail_content">
						<input type="text" json="AREA_NAME" id="AREA_NAME" value="${channInfo.AREA_NAME}" name="AREA_NAME" readonly/>
					</td>
               </tr>
               <tr>
			        <td width="15%" align="right" class="detail_label">建议人:</td>
					<td width="35%" class="detail_content">
               ...
               <tr>
               		<td width="15%" align="right" class="detail_label">建议类型:</td>
               		<td width="35%" class="detail_content">
               ...
               <tr>
               		...
               		<td width="35%" class="detail_content" colspan="3">
               			<input type="text" json="ADVS_SMMRY" name="ADVS_SMMRY" autocheck="true"  inputtype="string" label="建议概述" id="ADVS_SMMRY" maxlength="250" style="width: 735px"/>
               		</td>
               </tr>
               <tr>
               		<td width="15%" align="right" class="detail_label">建议内容:</td>
               		<td width="35%" class="detail_content" colspan="3" >
               			<textarea rows="5" cols="90" id="CMPL_ADVS_CONTENT" name="CMPL_ADVS_CONTENT" maxlength="1000" autocheck="true" inputtype="string" label="建议内容" mustinput="true"></textarea>
               		</td>
               </tr>
