...
$(function(){
	$("#check").click(function(){
		window.open("advise.shtml?action=toFrame&CMPL_ADVS_TYPE=3","反馈查询","height=600, width=900, top=100, left=100, toolbar=no, menubar=no, scrollbars=yes, resizable=yes,location=no, status=no");
	});
	$("#save").click(function(){
		allSave();
	});
...
function allSave(){
	...
	$.ajax({
		url: "adviseinit.shtml?action=saveAdvsCmpl",
		type:"POST",
		dataType:"text",
