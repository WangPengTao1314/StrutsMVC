...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale/repairsend/Repairsend_List.js"></script>
			...
			<table id="qxBtnTb" cellSpacing=0 cellPadding=0 border=0 width="100%">
				<tr>
                  <td nowrap>
                   ...
                   <input id="commSend" type="button" class="btn" value="提交排车"  />
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setSelEid(document.getElementById('eid${rr}'));">
                     ...
                     <td nowrap="nowrap" align="left">
                      ${fn:substring(rst.DELIVER_DTL_ADDR,"0","50")}  
                      &nbsp;
                     </td>
...
SelDictShow("STATE","BS_68","${params.STATE}","");
