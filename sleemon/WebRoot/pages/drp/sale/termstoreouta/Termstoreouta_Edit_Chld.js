/**
 * @prjName:喜临门营销平台
 * @fileName:Termstoreouta_Edit_Chld
 * @author lyg
...
function allSave(){
	...
	$.ajax({
		url: "termstoreouta.shtml?action=edit",
		type:"POST",
		dataType:"text",
		...
		complete: function (xhr){
			...
			if(jsonResult.success===true){
				saveSuccess("保存成功","termstoreouta.shtml?action=toFrame");
			}else{
...
function childSave(){
	...
	$.ajax({
		url: "termstoreouta.shtml?action=childEdit",
		type:"POST",
		dataType:"text",
...
//查找当前是否有选中的记录
	...
	$.ajax({
		url: "termstoreouta.shtml?action=childDelete",
		type:"POST",
		dataType:"text",
...
function gobacknew()
{
   newGoBack("termstoreouta.shtml?action=toFrame");
}
