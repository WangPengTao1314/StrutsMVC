		...
		<div class="lst_area">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
                    ...
                    <th  nowrap="nowrap" align="center" dbname="PRD_NO" >
                                                          货品编号&nbsp;-&nbsp;特殊工艺编号 
                    </th>
				...
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)" id="tr{rr}" onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));">
                     ...
                     <td nowrap="nowrap" align="center" >
                      <a href="javascript:void(0);" onclick="oppenAdvcDtlPage(this);" url="goodsorderhd.shtml?action=toLookAdvc&GOODS_ORDER_DTL_ID=${rst.GOODS_ORDER_DTL_ID}">
                      ${rst.PRD_NO}
