...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale/advctoorder/Advctoorder_List.js"></script>
...
<tr>
	<td height="20px" valign="top">
		...
		<tr>
			<td height="20px">&nbsp;&nbsp;当前位置：销售管理&gt;&gt;预订单处理&gt;&gt;预订单转订货</td>
	...
	<td height="20">
		<div class="tablayer" style="margin-left:3px; border-bottom:1px solid #d3d3d3; padding-bottom:3px; margin-bottom:3px;">
			<table id="qxBtnTb" cellSpacing=0 cellPadding=0 border=0 width="100%" style="border:0px">
				<tr>
                  <td nowrap>
				   <c:if test="${pvg.PVG_SHIFT eq 1 }">
					<input id="shift" type="button" class="btn" value="转订货订单(S)" onclick="url()" title="Alt+S" accesskey="S" >
				   </c:if>
		 ...
		 <div id="reverseDiv">
				<table width="100%" height="100%">
					<tr >
						<td align="right"><span style="font-size: 12px;">退回原因：</span></td>
						<td align="left">
		...
		<div class="lst_area" style="margin-left:3px;">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
                    ...
                    <th  nowrap="nowrap" align="center" dbname="DEAL_FLAG" >处理状态</th>
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setSelEid(document.getElementById('eid${rr}'));">
                     ...
                     <td nowrap="nowrap" align="center">
                     	<c:if test="${rst.DEAL_FLAG==1}">已处理</c:if>
                     	<c:if test="${(empty rst.DEAL_FLAG or 0 eq rst.DEAL_FLAG) && '退回' ne rst.STATE}">未处理</c:if>
                     	<c:if test="${0 eq rst.DEAL_FLAG && '退回' eq rst.STATE}">退回</c:if>
                    </td>
                    <td nowrap="nowrap" align="left">${rst.STATE}&nbsp;</td>
                    <input id="state${rst.ADVC_ORDER_ID}" type="hidden"  value="${rst.DEAL_FLAG}" />
				    </tr>
				</c:forEach>
		...
		<td class="detail2">
			<table width="100%" border="0" cellpadding="1" cellspacing="1" class="detail3">
               <tr>
					...
					<td width="15%" class="detail_content">
                       ...
                       <img align="absmiddle" name="" style="cursor: hand"
							...
							onClick="selCommon('BS_27', false, 'TERM_ID', 'TERM_ID', 'forms[1]','TERM_ID,TERM_NO,TERM_NAME', 'TERM_ID,TERM_NO,TERM_NAME', 'selectParams')"> 
					</td>					
               ...
               <tr>
                   ...
                   <td width="8%" nowrap align="right" class="detail_label">处理状态：</td>
					<td width="15%" class="detail_content">
						<select id="DEAL_FLAG" name="DEAL_FLAG" style="width: 155"></select>
					</td>				
                    <td width="8%" nowrap align="right" class="detail_label">要求到货日期从：</td>
                    <td width="15%" class="detail_content">
                    	<input id="ORDER_RECV_DATE_BEG" name="ORDER_RECV_DATE_BEG" readonly="readonly" style="width:155" onclick="SelectDate();" value="${params.ORDER_RECV_DATE_BEG}"/>
                    ...
                    <td width="15%" class="detail_content">
                    	<input id="ORDER_RECV_DATE_END" name="ORDER_RECV_DATE_END" readonly="readonly" style="width:155" onclick="SelectDate();" value="${params.ORDER_RECV_DATE_END}"/>
...
SelDictShow("DEAL_FLAG","BS_37","${params.DEAL_FLAG}","");  
	function url(){
		window.open('advctoorder.shtml?action=toListShift','预订单选取','height=600, width=1200, top=100, left=100, toolbar=no, menubar=no, scrollbars=yes, resizable=yes,location=no, status=no')
	}
</script>