...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale/termreturn/Termreturn_List.js"></script>
...
<tr>
	<td height="20px" valign="top">
		...
		<tr>
			<td height="20px">&nbsp;&nbsp;当前位置：销售管理&gt;&gt;终端销售&gt;&gt;终端退货录入</td>
				...
				<tr>
                  <td nowrap>
				   ...
				   <c:if test="${pvg.PVG_COMMIT_CANCLE eq 1 }">
					<input id="commit" type="button" class="btn" value="提交退货(C)" title="Alt+C" accesskey="C">
				   </c:if>
		...
		<div class="lst_area" style="margin-left:3px;">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				...
				<c:if test="${empty page.result}">
					<tr>
						<td height="26" colspan="15" align="center" class="lst_empty">
			                &nbsp;无相关记录&nbsp;
						</td>
					</tr>
				</c:if>
...
<table width="100%" border="0" cellpadding="4" cellspacing="4" class="detail">
	<tr>
		<td class="detail2">
			...
			<!-- 修改终端退货单编号，来源单据编号，人员信息通用查询条件 -->
			<input type="hidden" name=selectFrom value="STATE NOT IN ('提交','未提交','退回','待核价') and DEL_FLAG=0 and LEDGER_ID='${ZTXXID}'">
			<input type="hidden" name=selectOrder value=" BILL_TYPE='终端退货' and ${params.QXJBCON} and DEL_FLAG=0 and LEDGER_ID='${ZTXXID}' ">
			...
			<!-- 0157683--End--刘曰刚--2014-06-26 -->
               <tr>
					...
					<td width="15%" class="detail_content">
	   					<input id="FROM_BILL_NO" name="FROM_BILL_NO"  json="FROM_BILL_NO" style="width:155" value="${params.FROM_BILL_NO}"/>
	   					<img align="absmiddle" name="" style="cursor: hand"
							src="${ctx}/styles/${theme}/images/plus/select.gif"
							onClick="selCommon('BS_38', false, 'FROM_BILL_NO', 'ADVC_ORDER_NO', 'forms[1]','FROM_BILL_NO', 'ADVC_ORDER_NO', 'selectFrom')">  
					</td>	
