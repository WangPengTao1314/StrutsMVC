...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale/repairrecv/Repairrecv_List_Chld.js"></script>
				...
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));">
					 <td width="1%"align='center' >
						<input type="checkbox"  style="valign:middle"  id="eid${rr}" value="${rst.REPAIR_ORDER_DTL_ID}" onclick="setEidChecked(this);"/>
					 </td>
