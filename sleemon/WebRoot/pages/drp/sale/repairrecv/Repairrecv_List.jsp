...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale/repairrecv/Repairrecv_List.js"></script>
			...
			<table id="qxBtnTb" cellSpacing=0 cellPadding=0 border=0 width="100%">
				<tr>
                  <td nowrap>
                   ...
                   <input id="commRecv" type="button" class="btn" value="确认收货"  />
                   
                   </c:if>
                   <!-- 
	                   <c:if test="${pvg.PVG_COMMIT_CANCLE eq 1 }">
	                   	<input id="auditBack" type="button" class="btn" value="退回" />
					   </c:if>
				    -->
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setSelEid(document.getElementById('eid${rr}'));">
					 <td width="1%"align='center' >
						<input type="radio" style="valign:middle" name="eid" id="eid${rr}" value="${rst.ERP_REPAIR_ORDER_ID}"/>
					 </td>
...
SelDictShow("STATE","BS_67","${params.STATE}","");
