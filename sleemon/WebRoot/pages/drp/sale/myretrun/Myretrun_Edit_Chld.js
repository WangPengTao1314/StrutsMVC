...
function allSave(){
	...
	$.ajax({
		url: "myretrun.shtml?action=edit",
		type:"POST",
		dataType:"text",
		...
		complete: function (xhr){
			...
			if(jsonResult.success===true){
				saveSuccess("保存成功","myretrun.shtml?action=toFrame");
			}else{
...
function childSave(){
	...
	$.ajax({
		url: "myretrun.shtml?action=childEdit",
		type:"POST",
		dataType:"text",
...
//查找当前是否有选中的记录
	...
	$.ajax({
		url: "myretrun.shtml?action=childDelete",
		type:"POST",
		dataType:"text",
...
function gobacknew()
{
   newGoBack("myretrun.shtml?action=toFrame");
}
