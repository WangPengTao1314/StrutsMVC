...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale/progressadvc/ProgressAdvcOrder_List.js"></script>
...
<tr>
	<td height="20px" valign="top">
		...
		<tr>
			...
			<c:if test="${empty module or module eq 'wh'}">
				<td height="20px">&nbsp;&nbsp;当前位置：销售管理&gt;&gt;终端销售&gt;&gt;待完善预订单</td>
			</c:if>
		...
		<div class="lst_area" style="margin-left:3px;">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
                    ...
                    <th  nowrap="nowrap" align="center" dbname="FROM_BILL_NO" >龙安订单编号</th>
		...
		<td class="detail2">
			<table width="100%" border="0" cellpadding="1" cellspacing="1" class="detail3">
               ...
               <tr>
					...
					<td width="8%" nowrap align="right" class="detail_label">龙安订单编号：</td>
					<td width="15%" class="detail_content">
					<input id="FROM_BILL_NO" name="FROM_BILL_NO"   value="${params.FROM_BILL_NO}" />
					</td>
               </tr>
