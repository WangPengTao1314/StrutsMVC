...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale/forecasttaskup/ForecastTaskup_List.js"></script>
		...
		<div class="lst_area" style="margin-left:3px;">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
					...
					<th nowrap align="center" dbname="CHANN_NAME" >渠道</th>
					...
					<th nowrap align="center" dbname="JOB_STATE" >任务状态</th>
					<th nowrap align="center" dbname="STATE" >填报状态</th>
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setSelEid(document.getElementById('eid${rr}'));">
				        ...
				        <td align="center">${rst.JOB_STATE}&nbsp;</td>
				        <td align="center">${rst.STATE}&nbsp;
				        <input type="hidden" id="state${rst.RPT_JOB_CHANN_ID}" name="STATE" value="${rst.STATE}"/> 
				        <input type="hidden" id="JOB_STATE${rst.RPT_JOB_CHANN_ID}" name="STATE" value="${rst.JOB_STATE}"/> 
				        
				        </td>
				        
						<td align="center">
						  <input type="button" id="" name="" class="btn" value="填报" 
						   <c:if test="${'结束上报' eq rst.JOB_STATE or 2 eq rst.DISADLED1}">disabled</c:if>
						  onclick="openPrdPage('${rst.ADVC_RPT_JOB_ID}','${rst.RPT_JOB_CHANN_ID}','${rst.YEAR}','${rst.MONTH}');"/> 
						  <input type="button" id="" name="commit" class="btn" value="提交"
						      <c:if test="${'结束上报' eq rst.JOB_STATE or 2 eq rst.DISADLED2}">disabled</c:if>
                            onclick="parent.showConfirm('是否提交','topcontent.commitConfirm(this);');"/> 
                            
						  <input type="button" id="" name="" class="btn" 
						     <c:if test="${'结束上报' eq rst.JOB_STATE or 2 eq rst.DISADLED3}">disabled</c:if>
						    onclick="parent.showConfirm('是否撤销','topcontent.revokeConfirm(this);');" value="撤销"   /> 
						  <input type="hidden" id="state${rst.RPT_JOB_CHANN_ID}" value="${rst.STATE}"/>
						</td>
					</tr>
				</c:forEach>
