...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale//advcorder/Advcorder_Edit_Chld.js"></script>
	<script type=text/javascript src="${ctx}/scripts/util/My97DatePicker/WdatePicker.js"></script>
	<script type=text/javascript src="${ctx}/scripts/util/SearchBox.js"></script>
	<style type="text/css">
	</style>
	<title>预订单明细编辑</title>
</head>
...
<div id="seachDiv" style="z-index: 5;border: 1px black solid; position:absolute;display: none;background-color: white;" ></div>
</body>
