...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale/advise/Advise_PrdCmpl.js"></script>
	...
	<td valign="top" style="float: right;">
		<div  style="float:right;" class="lst_area">
			<table width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				...
				<tr>
					<td nowrap="nowrap" align="left" ><textarea style="width: 100%;" id="FEEDBACK_INFO" name="FEEDBACK_INFO" rows="15" cols="24" readonly ></textarea></td>
				</tr>
			</table>
		</div>
	</td>
