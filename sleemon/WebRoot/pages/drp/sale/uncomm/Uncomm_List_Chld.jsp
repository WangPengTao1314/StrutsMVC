...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale/uncomm/Uncomm_List_Chld.js"></script>
...
<!--                    <th  nowrap="nowrap" align="center" dbname="FREEZE_STORE_NAME" >冻结库房</th>-->
				...
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));checkDtlState();">
					 <td width="1%"align='center' >
						<input type="checkbox"  style="height:12px;valign:middle"  name="dtlCheck" id="eid${rr}" value="${rst.ADVC_ORDER_DTL_ID}" onclick="setEidChecked(this);"/>
					 </td>
...
<!--                     <td nowrap="nowrap" align="left" >${rst.FREEZE_STORE_NAME}&nbsp;</td>-->
                     ...
                     <td nowrap="nowrap" align="left" >${rst.REMARK}&nbsp; </td>  
                       <input type="hidden" name="STATE" id="state${rst.ADVC_ORDER_DTL_ID}" value="${rst.STATE}"/>
				    </tr>
				</c:forEach>
				<c:if test="${empty rst}">
					<tr>
