...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale/uncomm/Uncomm_Edit_Chld.js"></script>
...
<td>
	<div class="" style="width: 100%;overflow-x: auto;  height: 100%;background-color: #fff;">
		...
		<table id="jsontb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
			<input type="hidden" name=selectParams id="selectParams" value="STATE='启用' and DEL_FLAG=0 and FINAL_NODE_FLAG=1 and (COMM_FLAG=1 or (COMM_FLAG=0 and LEDGER_ID='${LEDGER_ID}'))">
			...
			<input type="hidden" id="CHANN_ID" value="${LEDGER_ID}" />
