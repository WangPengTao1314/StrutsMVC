...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale/uncomm/Uncomm_Edit.js"></script>
...
<!--					</td>-->
					  <td width="15%" align="right" class="detail_label">合同编号：</td>
					   <td width="35%" class="detail_content">
					   		<input json="CONTRACT_NO" name="CONTRACT_NO" autocheck="true" label="合同编号"  type="text"   inputtype="string"  readonly="readonly"  maxlength="30"   value="${rst.CONTRACT_NO}"/>
					   </td>
               </tr>
               <tr>
               		<td width="15%" align="right" class="detail_label">订金金额：</td>
				   <td width="35%" class="detail_content">
                     <input json="ADVC_AMOUNT" id="ADVC_AMOUNT" name="ADVC_AMOUNT" autocheck="true" label="订金金额"  type="text"  readonly="readonly" inputtype="float" mustinput="true"  valueType="12,2"  value="${rst.ADVC_AMOUNT}"/>
				   </td>
