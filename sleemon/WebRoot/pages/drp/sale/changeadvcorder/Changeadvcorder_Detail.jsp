	...
	<tr>
		<td class="detail2">
			<table width="100%" border="0" cellpadding="1" cellspacing="1" class="detail_lst">
               <tr>
               		<td width="15%" align="right" class="detail_label">预订单变更编号:</td>
               ...
               <tr>
               		<td width="15%" align="right" class="detail_label">原客户名称:</td>
					<td width="35%" class="detail_content">
                        ${rst.OLD_CUST_NAME}&nbsp;
					</td>
					<td width="15%" align="right" class="detail_label">原电话</td>
					<td width="35%" class="detail_content">
						 ${rst.OLD_TEL}&nbsp;
					</td>
               </tr>
...
<!--               </tr>-->
               ...
               <tr>
				...
				<tr>
					<td width="15%" align="right" class="detail_label">原收货地址：</td>
					<td width="35%" class="detail_content" colspan="3" style="word-break:break-all">${rst.OLD_RECV_ADDR }&nbsp;</td>
				</tr>
               <tr>
