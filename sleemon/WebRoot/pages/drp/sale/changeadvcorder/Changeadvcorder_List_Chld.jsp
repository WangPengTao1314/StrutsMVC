...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/sale/changeadvcorder/Changeadvcorder_List_Chld.js"></script>
...
<!--                    <th  nowrap="nowrap" align="center" dbname="PRD_COLOR" >花号</th>-->
                    ...
                    <th  nowrap="nowrap" align="center" dbname="REMARK" >变更原因</th>                    
				</tr>
				...
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));">
					 <td width="1%"align='center' >
						<input type="checkbox"  style="height:12px;valign:middle"  id="eid${rr}" value="${rst.ADVC_ORDER_CHANGE_DTL_ID}" onclick="setEidChecked(this);"/>
					 </td>
                     <td nowrap="nowrap" align="center" >${rst.PRD_NO}&nbsp;${rst.SPCL_SPEC_REMARK}</td>
...
<!--                     <td nowrap="nowrap" align="left" >${rst.PRD_COLOR}&nbsp;</td>-->
                     ...
                     <td nowrap="nowrap" align="center" >                    	
                     	 <c:if test="${not empty rst.SPCL_TECH_ID}">                     	 	
                     	 	<c:if test="${!empty rst.SPCL_SPEC_REMARK }">
	                     		<label class="hideNoticeText" title="${rst.SPCL_SPEC_REMARK}">${rst.SPCL_SPEC_REMARK}</label>
	                     	</c:if>
                     	 	<input class='btn'   value='查看' onclick='url("${rst.SPCL_TECH_ID}");'  type='button' />
                     	 </c:if>
                     	 <c:if test="${empty rst.SPCL_TECH_ID}">
                     	 	无
                     	 </c:if>
                     	&nbsp;
                     </td>
                     <td nowrap="nowrap" align="center" >${rst.PRICE}&nbsp;</td>
                     <td nowrap="nowrap" align="center" >${rst.DECT_RATE}&nbsp;</td>
                     ...
                     <td nowrap="nowrap" align="center" >${rst.FREEZE_NUM}&nbsp;</td>
...
<form id="form1" action="#" method="post" name="listForm">
	<input type="hidden" id="ADVC_ORDER_CHANGE_DTL_IDS" name="ADVC_ORDER_CHANGE_DTL_IDS" value=""/>
</form>
</body>
</html>