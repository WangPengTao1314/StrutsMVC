...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/distributer/distributerreq/DistributerReq_List.js"></script>
			   ...
			   <td height="20px" valign="top">
				...
				<tr>			
					<c:if test="${empty module || module eq 'wh'}">
					 <td height="20px">&nbsp;&nbsp;当前位置：渠道管理&gt;&gt;分销商管理&gt;&gt;分销渠道信息登记维护</td>
					</c:if>
					<c:if test="${module eq 'sh'}">
					 <td height="20px">&nbsp;&nbsp;当前位置：渠道管理&gt;&gt;分销商管理&gt;&gt;分销渠道信息登记审核</td>
					</c:if>
