...
<html>
	...
	<script type=text/javascript
		src="${ctx}/pages/drp/distributer/distributerreq/DistributerReq_Edit.js"></script>
	<script type="text/javascript"
						...
						<tr>
							...
							<td width="35%" class="detail_content">													
								<input id="SALE_STORE_NAME" json="SALE_STORE_NAME" name="SALE_STORE_NAME"
										type="text" inputtype="string" mustinput="true" autocheck="true" maxlength="100"  label="商场名称"
						...
						<tr>
							...
							<td width="35%" class="detail_content">
								<input id="SALE_STORE_LOCAL" json="SALE_STORE_LOCAL" name="SALE_STORE_LOCAL"
										type="text" inputtype="string" mustinput="true" autocheck="true" maxlength="100"  label="商场地址"
							...
							<td width="35%" class="detail_content">
								<input id="BUSS_BRAND" json="BUSS_BRAND" name="BUSS_BRAND"
									type="text" inputtype="string" mustinput="true" autocheck="true" maxlength="100"  label="经营品牌"
						...
						<tr>
							...
							<td width="35%" class="detail_content">
								<input id="BUSS_CLASS" name="BUSS_CLASS" type="text" autocheck="true" 
										inputtype="string" mustinput="true" label="主营品类" json="BUSS_CLASS" 
							...
							<td width="35%" class="detail_content">
								<input type="text" json="COOPER_DATE" id="COOPER_DATE" name="COOPER_DATE" autocheck="true" inputtype="string" mustinput="true" label="合作时间"  value="${rst.COOPER_DATE}"  onclick="SelectDate();" readonly />
						...
						<tr id="tr_att" <c:if test="${nFlag == true}"> style="display:none" </c:if> >
								...
								<td width="35%" class="detail_content" colspan="3">
									<table id="attTable" width="100%">
										<tr>
											<td>
												<font color='red'>1、&lt;&lt;2015年喜临门家具分销协议&gt;&gt;；2、分销床垫陈列照片（两款五张及以上，照片需同时显示2款产品以上，陈列5张床垫以上）</font>											
											</td>
										</tr>
										<tr>
											<td>											
