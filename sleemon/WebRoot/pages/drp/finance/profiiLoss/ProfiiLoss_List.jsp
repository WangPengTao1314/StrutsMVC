...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/finance/profiiLoss/ProfiiLoss_List.js"></script>
...
<tr>
	<td height="20px" valign="top">
		...
		<tr>
			<td height="20px">&nbsp;&nbsp;当前位置：财务管理>>财务结算>>盈亏单查询</td>
	...
	<td valign="top">
		<div class="lst_area" style="margin-left:3px;">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
					<th width="1%"></th>
                    <th  nowrap="nowrap" align="center" dbname="PROFIT_LOSS_NO" >盈亏单编号</th>
                    ...
                    <th  nowrap="nowrap" align="center" dbname="INV_PSON_NO" >监盘人编号</th>
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setSelEid(document.getElementById('eid${rr}'));">
					 <td width="1%"align='center' >
						<input type="radio" style="height:12px;valign:middle" name="eid" id="eid${rr}" value="${rst.PROFIT_LOSS_ID}"/>
					 </td>
                     <td nowrap="nowrap" align="center">${rst.PROFIT_LOSS_NO}&nbsp;</td>
                     <td nowrap="nowrap" align="center">${rst.PRD_INV_NO}&nbsp;</td>
                     <td nowrap="nowrap" align="center">${rst.STORE_NO}&nbsp;</td>
                     <td nowrap="nowrap" align="center">${rst.STORE_NAME}&nbsp;</td>
                     <td nowrap="nowrap" align="left">${rst.INV_PSON_NO}&nbsp;</td>
                    ...
                    <input id="state${rst.PROFIT_LOSS_ID}" type="hidden"  value="${rst.STATE}" />
				    </tr>
				</c:forEach>
...
<input type="hidden" name="selectStore"  ID="selectStore" value=" STATE ='启用' and DEL_FLAG=0 and  LEDGER_ID='${params.LEDGER_ID}' ">
	<tr>
		<td class="detail2">
			<table width="100%" border="0" cellpadding="1" cellspacing="1" class="detail3">
               <tr>
                    <td width="8%" nowrap align="right" class="detail_label">盈亏单编号:</td>
					<td width="15%" class="detail_content">
	   					<input id="PROFIT_LOSS_NO" name="PROFIT_LOSS_NO" type="text" style="width:155" value="${params.PROFIT_LOSS_NO}"/>
					</td>					
                    <td width="8%" nowrap align="right" class="detail_label">盘点单编号:</td>
					<td width="15%" class="detail_content">
	   					<input id="PRD_INV_NO" name="PRD_INV_NO" type="text"  style="width:155" value="${params.PRD_INV_NO}"/>
					</td>					
					...
					<td width="15%" class="detail_content">
	   					...
	   					<img align="absmiddle" style="cursor: hand"
							...
							onClick="selCommon('BS_35',false,'STORE_NO','STORE_NO','forms[1]','STORE_NO,STORE_NAME','STORE_NO,STORE_NAME','selectStore');">
					</td>					
