...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/finance/advpayment/Advpayment_List.js"></script>
				...
				<tr>
                  <td nowrap>
				   ...
				   <c:if test="${pvg.PVG_BWS eq 1 }">
				    ...
				    <input id="PaymentExport" type="button" class="btn" value="导出(N)" title="Alt+N" accesskey="N">
				   </c:if>
		...
		<div class="lst_area" style="margin-left:3px;">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
                    ...
                    <th  nowrap="nowrap" align="center" dbname="BILL_TYPE" >收款类型</th>
                    <th  nowrap="nowrap" align="center" dbname="TERM_NO" >终端编号</th>
                    <th  nowrap="nowrap" align="center" dbname="TERM_NAME" >终端名称</th>
                    <th  nowrap="nowrap" align="center" dbname="STATEMENTS_AMOUNT" >本次收款金额</th>
<!--                    <th  nowrap="nowrap" align="center" dbname="DEDUCT_AMOUNT" >本次扣款金额</th>-->
                    <th  nowrap="nowrap" align="center" dbname="FUND_OF_END" >尾款</th>
                    ...
                    <th  nowrap="nowrap" align="center" dbname="UPD_TIME" >更新时间</th>
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setSelEid(document.getElementById('eid${rr}'));">
                     ...
                     <td nowrap="nowrap" align="left">${rst.STATEMENTS_AMOUNT}&nbsp;</td>
<!--                     <td nowrap="nowrap" align="left">${rst.DEDUCT_AMOUNT}&nbsp;</td>-->
                     <td nowrap="nowrap" align="left">${rst.FUND_OF_END}&nbsp;</td>
                     ...
                     <td nowrap="nowrap" align="center">${rst.UPD_TIME}&nbsp;</td>
                     <td nowrap="nowrap" align="center">${rst.STATE}&nbsp;</td>
                    <input id="state${rst.STATEMENTS_ID}" type="hidden"  value="${rst.STATE}" />
                    <input id="BILL_TYPE${rst.STATEMENTS_ID}" type="hidden"  value="${rst.BILL_TYPE}" />
                    <input id="ADVC_ORDER_ID${rst.STATEMENTS_ID}" type="hidden"  value="${rst.ADVC_ORDER_ID}" />
				    </tr>
				</c:forEach>
	...
	<tr>
		<td class="detail2">
			<table width="100%" border="0" cellpadding="1" cellspacing="1" class="detail3">
               <tr>
                    <td width="8%" nowrap align="right" class="detail_label">收款单编号:</td>
               ...
               <tr>
               		<td width="8%" nowrap align="right" class="detail_label">收款类型:</td>
					<td width="15%" class="detail_content">
	   					<select json="BILL_TYPE" id="BILL_TYPE"  name="BILL_TYPE" style="width:155px" ></select>
					</td>
...
<script type="text/javascript">
	...
	SelDictShow("BILL_TYPE","BS_41","${params.BILL_TYPE}","");
</script>