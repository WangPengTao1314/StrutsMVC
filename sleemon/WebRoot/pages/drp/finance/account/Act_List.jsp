...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/finance/account/Act_List.js"></script>
				...
				<tr>
				   <td nowrap>
				    ...
				    &nbsp;月份:&nbsp;<select id="MONTH" name="MONTH" style="width: 100px" ></select>
			   		&nbsp;&nbsp;<input id="act_Btn" type="button" class="btn" value="  月结  " >
				</td>
				</tr>
			</table>
			</form>
			...
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="setSelEids(document.getElementById('eid${rr}'),'${rst.ZTXXID}');">
						...
						<input  type="button" class="btn" value=" 月结 " onclick="chkAccount('${rst.LEDGER_ID}','${rst.YEAR}','${rst.MONTH}')" >&nbsp;
						<input  type="button" class="btn" value="取消月结" onclick="cancleAccount('${rst.LEDGER_ID}','${rst.YEAR}','${rst.MONTH}','${rst.STATE}')">
						</td>
					</tr>
				</c:forEach>
