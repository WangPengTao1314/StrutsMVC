...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/finance/custrefundments/Custrefundments_Edit_Chld.js"></script>
...
<td>
	<div class="lst_area">
	    <form>
		<input type="hidden" id="STATEMENTS_ID" name="STATEMENTS_ID">
