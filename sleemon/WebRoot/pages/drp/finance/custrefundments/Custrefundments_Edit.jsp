...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/finance/custrefundments/Custrefundments_Edit.js"></script>
			...
			<td class="detail2">
				<table id="jsontb" width="100%" border="0" cellpadding="1" cellspacing="1" class="detail3">
	               ...
	               <tr>
					   ...
					   --%>
					   <input type="text" id="BILL_TYPE" name="BILL_TYPE"  json="BILL_TYPE" value="销售退款" readonly="readonly"/>
					   </td>
	               ...
	               <tr>
					   ...
					   <td width="35%" class="detail_content">
	                     <input id="ORDER_RECV_DATE" json="ORDER_RECV_DATE" readonly name="ORDER_RECV_DATE" autocheck="true" label="要求到货日期"  type="text"   inputtype="string"       value="${rst.ORDER_RECV_DATE}"/> 
					   </td>
	                   <td width="15%" align="right" class="detail_label">订金：</td>
					   <td width="35%" class="detail_content">
	                     <input id="ADVC_AMOUNT" json="ADVC_AMOUNT" name="ADVC_AMOUNT" autocheck="true" readonly label="订金"  type="text"   inputtype="string"        maxlength="22"  value="${rst.ADVC_AMOUNT}"/> 
					   </td>
	               </tr>
	               <tr>
	                   <td width="15%" align="right" class="detail_label">已付款：</td>
					   <td width="35%" class="detail_content">
	                     <input id="PAYED_TOTAL_AMOUNT" json="PAYED_TOTAL_AMOUNT" name="PAYED_TOTAL_AMOUNT" autocheck="true" label="已付款金额" readonly  type="text"   inputtype="string"      value="${rst.PAYED_TOTAL_AMOUNT}"/> 
					   </td>
	                   <td width="15%" align="right" class="detail_label">应收总额：</td>
					   <td width="35%" class="detail_content">
	                     <input id="PAYABLE_AMOUNT" json="PAYABLE_AMOUNT" name="PAYABLE_AMOUNT" autocheck="true" readonly label="应收总额"  type="text"   inputtype="string"     mustinput="true"     maxlength="22"  value="${rst.PAYABLE_AMOUNT}"/> 
					   </td>
	               </tr>
	               <tr>
