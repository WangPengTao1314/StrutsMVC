		...
		<td class="detail2">
			<table width="100%" border="0" cellpadding="1" cellspacing="1" class="detail_lst">
               ...
               <tr>
					...
					<td width="15%" align="right" class="detail_label">发票号：</td>
					<td width="35%" class="detail_content">
						${rst.RECEIPT_NO}&nbsp;
					</td> 
               </tr>
               <tr>
                ...
                <tr>
			        <td width="15%" align="right" class="detail_label">开票人:</td>
					<td width="35%" class="detail_content">
                        ${rst.XM}&nbsp;
					</td>
			        <td width="15%" align="right" class="detail_label">开票时间:</td>
					<td width="35%" class="detail_content">
                        ${rst.RECEIPT_TIME}&nbsp;
					</td>
               </tr>
               ...
               <tr>
				...
				<tr>
					<td width="15%" align="right" class="detail_label">开票备注：</td>
					<td width="35%" class="detail_content" colspan="3" style="word-break:break-all">${rst.RECEIPT_REMARK }&nbsp;</td>
				</tr>
				<tr>
					<td width="15%" align="right" class="detail_label">退货原因：</td>
