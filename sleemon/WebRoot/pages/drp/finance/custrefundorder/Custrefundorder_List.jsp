...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/finance/custrefundorder/Custrefundorder_List.js"></script>
				...
				<tr>
                  <td nowrap>
				   ...
				   <c:if test="${pvg.PVG_COMMIT_CANCLE eq 1 }">
					...
					<input id="revoke" type="button" class="btn" value="反结算(R)" title="Alt+R" accesskey="R" >
				   </c:if>
