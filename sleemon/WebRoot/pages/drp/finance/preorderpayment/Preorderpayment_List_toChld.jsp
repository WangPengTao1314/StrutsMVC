...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/finance/preorderpayment/Preorderpayment_List_toChld.js"></script>
	...
	<td valign="top">
		<div class="lst_area">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
					<th  nowrap="nowrap" align="center" >出库单编号</th>
				...
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));">
                     ...
                     <td nowrap="nowrap" align="right" >${rst.STATEMENTS_NUM}&nbsp;</td>
