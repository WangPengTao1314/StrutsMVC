...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/drp/finance/restatements/Restatements_Frame.js"></script>
</head>
<BODY>
<table cellspacing="0" cellpadding="0" width="99.9%" height="98%">
		<tr>
			<td >
				...
				<div class="tablayer tabBackground" style="width: 100%;">
					<table cellSpacing=0 cellPadding=0 border=0 width="100%">
						<tr>
						   <!--这里加入需要显示的标签页, 注意序号和标签的宽度-->
							<td id="label" nowrap="nowrap" >
								<span id="label_1" class="label_down" style="margin-top: 2px;font-size:13">&nbsp;退货结算明细&nbsp;</span>
								<span id="label_2" class="label_down1" style="margin-top: 2px;font-size:13">&nbsp;详细信息&nbsp;</span>
				...
				<div id="bottomdiv" style="height: 45%; width: 100%">
					<!-- 下帧 -->
					<iframe id="bottomcontent" style="margin-left:3px;" name="bottomcontent" src="#" frameBorder=0 width="100%" height="100%" frameborder="0" scrolling="AUTO"></iframe>
				</div>
			</td>
		</tr>
	</table>
