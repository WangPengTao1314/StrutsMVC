...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/areaser/storeoutnotice/Storeoutnotice_List_Chld.js"></script>
...
<!--                    <th  nowrap="nowrap" align="center" dbname="PRD_COLOR" >颜色</th>-->
				...
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));setSelOperateEx();">
					 <td width="1%"align='center' >
						<input type="checkbox"  style="height:12px;valign:middle"  id="eid${rr}" value="${rst.STOREOUT_NOTICE_DTL_ID}" onclick="setEidChecked(this);"/>
					 </td>
...
<!--                     <td nowrap="nowrap" align="left" >${rst.PRD_COLOR}&nbsp;</td>-->
                     ...
                     <td nowrap="nowrap" align="center" >${rst.DECT_AMOUNT}&nbsp;</td>
...
<form id="form1" action="#" method="post" name="listForm">
	<input type="hidden" id="STOREOUT_NOTICE_DTL_IDS" name="STOREOUT_NOTICE_DTL_IDS" value=""/>
</form>
</body>
