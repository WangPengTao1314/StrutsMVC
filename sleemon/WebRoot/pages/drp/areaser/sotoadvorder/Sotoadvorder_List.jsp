...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/areaser/sotoadvorder/Sotoadvorder_List.js"></script>
...
<tr>
	<td height="20px" valign="top">
		...
		<tr>
			<td>当前位置：区域服务中心管理>>订单中心>>销售订单转订货</td>
...
<script type="text/javascript">
	function url(){
		window.open('sotoadvorder.shtml?action=toListShift','订货订单选取','height=600, width=900, top=100, left=100, toolbar=no, menubar=no, scrollbars=yes, resizable=no,location=no, status=no')
	}
    //SelDictShow("STATE","System_193","${params.STATE}","");
    //初始化 审批流程
