...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/areaser/sotoadvorder/Sotoadvorder_List_Chld.js"></script>
...
<!--                    <th  nowrap="nowrap" align="center" dbname="PRD_COLOR" >花号</th>-->
                    ...
                    <th  nowrap="nowrap" align="center" dbname="STORED_NUM" >抵库数量</th>
                    <th  nowrap="nowrap" align="center" dbname="CHANGE_NUM" >已转订货数量</th>
...
<!--                     <td nowrap="nowrap" align="left" >${rst.PRD_COLOR}&nbsp;</td>-->
                     ...
                     <td nowrap="nowrap" align="right" >${rst.STORED_NUM}&nbsp;</td>
                     <td nowrap="nowrap" align="right" >${rst.CHANGE_NUM }</td>
