				...
				<td class="detail2">
					<table id="jsontb" width="100%" border="0" cellpadding="1"
						 ...
						 <tr>
							...
							<td width="20%" class="detail_content">
								<input json="VISIT_PEOPLE" name="XM" 
									...
									value="${rst.VISIT_PEOPLE}" autocheck="true"  inputtype="string" mustinput="true" readonly/>
								<!-- 
						...
						<tr>
							...
							<td width="20%" class="detail_content">
							    <input json="VISIT_DATE" name="VISIT_DATE" id="VISIT_DATE" type="text" size="30" 
									label="申请时间" value="${rst.VISIT_DATE}" autocheck="true"  inputtype="string" mustinput="true"  
						...
						<tr>
							...
							<td width="20%" class="detail_content">
								<input json="MATTRESS_STOCK" name="MATTRESS_STOCK" id="MATTRESS_STOCK" type="text" size="30" 
									label="床垫" value="${rst.MATTRESS_STOCK}"  autocheck="true"  inputtype="string" maxlength="20" />
							</td>
							<td width="15%"   class="detail_label">
								软床：
							</td>
							<td width="20%" class="detail_content">
							    <input json="BED_STOCK" name="BED_STOCK" id="BED_STOCK" type="text" size="30" 
									label="软床" value="${rst.BED_STOCK}"  autocheck="true"  inputtype="string" maxlength="20" />
							</td>
							<td width="15%"   class="detail_label">
								床头柜：
							</td>
							<td width="20%" class="detail_content">
							    <input json="BEDSIDE_STOCK" name="BEDSIDE_STOCK" id="BEDSIDE_STOCK" type="text" size="30" 
									label="床头柜" value="${rst.BEDSIDE_STOCK}"   autocheck="true"  inputtype="string" maxlength="20" />
							</td>
						</tr> 
						<tr>
							<td width="15%"   class="detail_label">
							...
							<td width="20%" class="detail_content">
								<input json="BEDDING_STOCK" name="BEDDING_STOCK" id="BEDDING_STOCK" type="text" size="30" 
									label="床品" value="${rst.BEDDING_STOCK}"  autocheck="true"  inputtype="string" maxlength="20" />
							</td>
							<td width="15%"  class="detail_label">
								其他：
							</td>
							<td width="20%" class="detail_content">
							    <input json="OTHER_STOCK" name="OTHER_STOCK" id="OTHER_STOCK" type="text" size="30" 
									label="其他" value="${rst.OTHER_STOCK}"  autocheck="true"  inputtype="string" maxlength="20" />
							</td>
							<td width="15%"   class="detail_label">
								合计：
							</td>
					    ...
					    <tr>
							...
							<td width="20%" class="detail_content">
							    <input json="MONTH_ORDER_NUM" name="MONTH_ORDER_NUM" id="MONTH_ORDER_NUM" label="销售本月目标" maxlength="20" 
									size="30" autocheck="true" inputtype="string"   maxlength="250" value="${rst.MONTH_ORDER_NUM}"></input>
							</td>
							<td width="15%"  class="detail_label">
								本季销售目标：
							</td>
						...
						<tr>
							...
							<td width="20%" class="detail_content">
								<input json="SEASON_GOALS" name="SEASON_GOALS" id="SEASON_GOALS" type="text" maxlength="200" 
									label="季度目标" value="${rst.SEASON_GOALS}"  autocheck="true"  inputtype="string"  size="30"  />
							</td>
							<td width="15%"   class="detail_label">
								目前达成：
							</td>
							...
							<td width="20%" class="detail_content">
							    <input json="CURRENT_RATE" name="CURRENT_RATE" id="CURRENT_RATE" type="text" size="30" maxlength="20"
									label="达成率" value="${rst.CURRENT_RATE}"   autocheck="true"  inputtype="string"/>
							</td>
						</tr>
						<tr>
						   <td width="15%"  class="detail_label">
						   ...
						   <td width="20%"  class="detail_content">
							    <textarea json="SEASON_IMPROVE_PLAN" name="SEASON_IMPROVE_PLAN" id="SEASON_IMPROVE_PLAN" type="text" maxlength="200" 
									 rows="3" cols="24%" label="季度改善计划"  autocheck="true"  inputtype="string">${rst.SEASON_IMPROVE_PLAN}</textarea>
							</td>
							<td width="15%" class="detail_label">
								加盟商问题：
							</td>
