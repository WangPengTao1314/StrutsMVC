...
<head>
	...
	<title>拓展拜访表维护列表</title>
	<link rel="stylesheet" type="text/css" href="${ctx}/styles/${theme}/css/style.css">
	<script language="JavaScript" src="${ctx}/pages/common/select/selCommJs.js"></script>
	<script type="text/javascript" src="${ctx}/pages/drp/visit/expandvisit/Expandvisit_List.js"></script>
			   ...
			   <td height="20px" valign="top">
				...
				<tr>			
					<c:if test="${empty module || module eq 'wh'}">
					 <td height="20px">&nbsp;&nbsp;当前位置：渠道管理>>拜访管理>>拓展拜访表维护</td>
					</c:if>
					<c:if test="${module eq 'sh'}">
					 <td height="20px">&nbsp;&nbsp;当前位置：渠道管理>>拜访管理>>拓展拜访表审核</td>
					</c:if>			
		   ...
		   <div class="lst_area" style="margin-left:3px;">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
					...
					<th nowrap align="center" >紧急程度</th>
                    <th nowrap align="center" >申请部门</th>
                    <th nowrap align="center" >申请日期</th>
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)" id="tr${rr}"  >
						<td width="1%" align='center' >
							<input type="radio" style="height:12px;valign:middle" json="EXPAND_VISIT_ID" name="eid" id="eid${rr}" value="${rst.EXPAND_VISIT_ID}" onclick="setSelEid(document.getElementById('eid${rr}'));"/>
						    <input type="hidden" id="state${rst.EXPAND_VISIT_ID}" value="${rst.STATE}"/>
						    <input type="hidden" value="${rst.EXPAND_VISIT_ID}" name="EXPAND_VISIT_ID" json="STORE_VISIT_ID" id="rylb${rst.EXPAND_VISIT_ID}"/>
						</td>
						<td align="center">${rst.EXPAND_VISIT_NO}&nbsp;</td>
						<td align="center">${rst.EME_DEGREE}&nbsp;</td>
						...
						<script type="text/javascript">
						   $("#tr${rr}").click(function(){
						      ...
						      state(document.getElementById('state${rst.EXPAND_VISIT_ID}'));
						   });
					    </script>
					</tr>
				</c:forEach>
			 ...
			 <table width="100%" border="0" cellpadding="1" cellspacing="1" class="detail3">
				<tr>
					...
					<td class="detail_content">
						<input name="EXPAND_VISIT_NO" id="EXPAND_VISIT_NO" json="EXPAND_VISIT_NO"  type="text"  value="${params.EXPAND_VISIT_NO}" label="流程编号"/>
					</td>
				   ...
				   <td nowrap align="right" class="detail_label">拜访人：</td>
		      		...
		      		<td nowrap class="detail_content" colspan="6">
