...
<head>
	...
	<title>门店拜访表维护列表</title>
	<link rel="stylesheet" type="text/css" href="${ctx}/styles/${theme}/css/style.css">
	<script language="JavaScript" src="${ctx}/pages/common/select/selCommJs.js"></script>
	<script type="text/javascript" src="${ctx}/pages/drp/visit/storevisit/Storevisit_List.js"></script>
			   ...
			   <td height="20px" valign="top">
				...
				<tr>			
					<c:if test="${empty module || module eq 'wh'}">
					 <td height="20px">&nbsp;&nbsp;当前位置：渠道管理>>拜访管理>>门店拜访表维护</td>
					</c:if>
					<c:if test="${module eq 'sh'}">
					 <td height="20px">&nbsp;&nbsp;当前位置：渠道管理>>拜访管理>>门店拜访表审核</td>
					</c:if>			
		   ...
		   <div class="lst_area" style="margin-left:3px;">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
					...
					<th nowrap align="center" >终端编号</th>
					<th nowrap align="center" >终端名称</th>
                    <th nowrap align="center" >渠道名称</th>
                    <th nowrap align="center" >申请人</th>
					<th nowrap align="center" >城市</th>
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)" id="tr${rr}"  >
						<td width="1%" align='center' >
							<input type="radio" style="height:12px;valign:middle" json="STORE_VISIT_ID" name="eid" id="eid${rr}" value="${rst.STORE_VISIT_ID}" onclick="setSelEid(document.getElementById('eid${rr}'));"/>
						    <input type="hidden" id="state${rst.STORE_VISIT_ID}" value="${rst.STATE}"/>
						    <input type="hidden" value="${rst.STORE_VISIT_ID}" name="STORE_VISIT_ID" json="STORE_VISIT_ID" id="rylb${rst.STORE_VISIT_ID}"/>
						</td>
						<td align="center">${rst.STORE_VISIT_NO}&nbsp;</td>
						<td align="center">${rst.TERM_NO}&nbsp;</td>
						<td align="center">${rst.STORE_NAME}&nbsp;</td>
						<td align="center">${rst.CHANN_NAME}&nbsp;</td>
						<td align="center">${rst.APPLY_PERSON}&nbsp;</td>
						<td align="center">${rst.CITY}&nbsp;</td>
						...
						<script type="text/javascript">
						   $("#tr${rr}").click(function(){
						      ...
						      state(document.getElementById('state${rst.STORE_VISIT_ID}'));
						   });
					    </script>
					</tr>
				</c:forEach>
			 ...
			 <table width="100%" border="0" cellpadding="1" cellspacing="1" class="detail3">
				<tr>
					...
					<td class="detail_content">
						<input name="STORE_VISIT_NO" id="STORE_VISIT_NO" json="STORE_VISIT_NO"  type="text"  value="${params.STORE_VISIT_NO}" label="门店拜访表编号"/>
					</td>
