...
<div style="height: 100">
				...
				<td class="detail2">
					<table id="jsontb" width="100%" border="0" cellpadding="1"
						...
						<tr>
							...
							<td width="20%" class="detail_content">
							    <input json="APPLY_ID"     name="APPLY_ID"     id="APPLY_ID"  value="${rst.APPLY_ID}" type="hidden" />
								...
								<img align="absmiddle" name="" style="cursor: hand"
									...
									onClick="selCommon('BS_125', false, 'APPLY_ID', 'RYXXID', 'forms[0]','APPLY_ID,APPLY_PERSON,APPLY_DEP','RYXXID,TNAME,BMMC','selectParamsTt')">
							    -->
							</td>
						</tr>
						<tr>
							...
							<td width="20%" class="detail_content">
							    <input json="VISIT_DATE" name="VISIT_DATE" id="VISIT_DATE" type="text" size="30" 
									label="申请时间" value="${APPLY_DATE}" autocheck="true"  inputtype="string"
						...
						<tr>
							...
							<td width="20%" class="detail_content">
							    <input json="TERM_ID" name="TERM_ID" id="TERM_ID" size="30" 
									...
									inputtype="string" value="${params.TERM_ID}" />
								<input json="TERM_NO" name="TERM_NO" id="TERM_NO" size="30" 
									autocheck="true" label="门店编号" type="hidden"
									inputtype="string" value="${params.TERM_NO}" />
							    <input json="STORE_NAME" name="TERM_NAME" id="STORE_NAME" type="text" size="30" 
									label="终端名称" value="${rst.STORE_NAME}" autocheck="true"  inputtype="string" mustinput="true" READONLY />
								<img align="absmiddle" name="" style="cursor: hand"
									src="${ctx}/styles/${theme}/images/plus/select.gif"
						...
						<tr>
							...
							<td width="20%" class="detail_content">
							    <input json="EXECUTE_ACTION_DATE" name="EXECUTE_ACTION_DATE" id="EXECUTE_ACTION_DATE" type="text" size="30" 
									label="执行活动时间" value="${APPLY_DATE}"  autocheck="true"  inputtype="string" onclick="SelectDate()" READONLY/>
							    <img align="absmiddle" style="cursor: hand"
									src="${ctx}/styles/${theme}/images/plus/date_16x16.gif"
						...
						<tr>
							...
							<td width="20%" class="detail_content">
							    <input json="ACTION_PLAN_DATE" name="ACTION_PLAN_DATE" id="ACTION_PLAN_DATE" type="text" size="30" 
									label="活动计划时间" value="${APPLY_DATE}"  autocheck="true"  inputtype="string" onclick="SelectDate()" READONLY/>
								<img align="absmiddle" style="cursor: hand"
									src="${ctx}/styles/${theme}/images/plus/date_16x16.gif"
	...
	<script type="text/javascript">
       ...
       SelDictShow("VISIT_TYPE","BS_155","${rst.VISIT_TYPE}","");
