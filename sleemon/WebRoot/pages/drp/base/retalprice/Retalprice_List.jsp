...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/base/retalprice/Retalprice_List.js"></script>
...
<tr>
	<td height="20px" valign="top">
	   <table width="100%" cellspacing="0" cellpadding="0">
		<tr>
			<td height="20px">&nbsp;&nbsp;当前位置：系统管理&gt;&gt;基础信息&gt;&gt;货品零售价设置</td>
		...
		<div class="lst_area" style="margin-left:3px;">
			<table id="ordertb" width="100%" border="0" cellpadding="1"  cellspacing="1" class="lst">
				<tr class="fixedRow">
					...
					<th nowrap align="center" dbname="FACT_PRICE">零售价</th>
				</tr>
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  >
                        ...
                        <td nowrap align="center">
                        	<input type="text" value="${rst.FACT_PRICE}" onclick="$('#eid${rr}').attr('checked','true');" size="5" name="FACT_PRICE"  json="FACT_PRICE"/>
                        	<input type="hidden" name="RETAL_PRICE_ID" json="RETAL_PRICE_ID" value="${rst.RETAL_PRICE_ID}">
