...
<head>
	...
	<script type=text/javascript  src="${ctx}/pages/drp/base/paramset/Paramset_Edit_T.js"></script>
	<title>数据字典维护</title>
</head>
<body>
<table width="99.9%" height="98%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td>
			...
			<input type="hidden" id="freezeDays" value="${freezeDays}"/>
			...
			<table cellSpacing=0 cellPadding=0 border=0 width="100%">
				<tr>
					...
					<td id="label" nowrap="nowrap">
						<span id="label_1" class="label_down" style="margin-top:2px;">&nbsp;数据字典明细&nbsp;</span>
