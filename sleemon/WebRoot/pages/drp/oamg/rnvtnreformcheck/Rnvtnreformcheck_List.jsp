...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/oamg/rnvtnreformcheck/Rnvtnreformcheck_List.js"></script>
	   ...
	   <table width="99.8%" height="100%" border="0" cellspacing="0" cellpadding="0" class="panel">
			<tr>
				  <td height="20px" valign="top">
					...
					<tr>			
					    <td height="20px">&nbsp;&nbsp;当前位置：渠道管理>>装修管理>>装修整改验收单维护</td>
					...
					<table id="qxBtnTb" cellSpacing=0 cellPadding=0 border=0 width="100%" style="border:0px">
			           <tr>
						   <td id="qxBtnTb" nowrap>
						   		<input id="modify" type="button" class="btn" value="验收(C)"  title="Alt+C" accesskey="C"/>
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)" id="tr${rr}" >
						<td width="1%" align='center' >
						    ...
						    <input type="hidden" value="${rst.RNVTN_CHECK_NO}"  name="RNVTN_CHECK_NO"  json="RNVTN_CHECK_NO"  id="rylb${rst.RNVTN_CHECK_NO}"/>
						</td>
...
<script language="JavaScript">
   SelDictShow("STATE","BS_97","${params.STATE}","");  
</script>
</body>
