...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/oamg/trainreq/Trainreq_List.js"></script>
...
<tr>
	<td height="20px" valign="top">
		...
		<c:if test="${module eq 'sh'}">
		 <td height="20px">&nbsp;&nbsp;当前位置：渠道管理&gt;&gt;渠道培训管理&gt;&gt;渠道培训申请单审核</td>
		</c:if>
		<c:if test="${empty module || module eq 'wh'}">
		 <td height="20px">&nbsp;&nbsp;当前位置：渠道管理&gt;&gt;渠道培训管理&gt;&gt;渠道培训申请单维护</td>
		</c:if>
