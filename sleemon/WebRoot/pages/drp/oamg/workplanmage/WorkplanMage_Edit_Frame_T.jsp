...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/drp/oamg/workplanmage/WorkplanMage_Edit_Frame_T.js"></script>
	<title>工作计划维护</title>
</head>
<body>
...
<input type="hidden" id="WORK_PLAN_ID" value="${WORK_PLAN_ID}"/>
</body>
