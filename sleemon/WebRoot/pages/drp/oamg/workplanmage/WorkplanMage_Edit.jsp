			...
			<table id="jsontb"  width="100%" border="0" cellpadding="1" cellspacing="1" class="detail3">
				<tr>
					...
					<td width="35%" class="detail_content">
						    <input json="WORK_PLAN_ID" name="WORK_PLAN_ID" size="40"  id="WORK_PLAN_ID" type="text" label="销售计划编号" autocheck="true"  inputtype="string" mustinput="true"
