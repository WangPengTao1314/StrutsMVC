...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/drp/oamg/workplanmage/WorkplanMage_Edit_Frame.js"></script>
	<title>工作计划维护</title>
</head>
<body>
			...
			<table cellSpacing=0 cellPadding=0 border=0 width="100%">
				<tr>
					...
					<td id="label" nowrap="nowrap">
						<span id="label_1" class="label_down" style="margin-top:2px;">&nbsp;工作计划明细&nbsp;</span>
...
<input type="hidden" id="RNVTN_SUBST_STD_ID" value="${RNVTN_SUBST_STD_ID}"/>
<input type="hidden" id="STATE" name="STATE" value="${STATE}"/> 
<input type="hidden" id="getYear" name="getYear" value="1"/>
</body>
