...
$(function(){
	...
	mtbSaveListener("storetoretail.shtml?action=edit","SPCL_STORE_TO_RETAIL_REQ_ID");
	//保存监听。参数1：请求Url，参数2：主键Id，参数3：上帧url.保存成功后需要刷新上帧，
});
...
function selAdvcorder(){
	...
	selCommon('BS_181', false, 'TERM_ID', 'TERM_ID', 'forms[0]',
		'TERM_ID,TERM_NO,TERM_NAME,TERM_TYPE,CHANN_ID,CHANN_NO,CHANN_NAME,PERSON_CON,TEL,MOBILE,ADDRESS,ZONE_ID,CHANN_PERSON_CON,CHANN_TEL,AREA_ID,AREA_NO,AREA_NAME,ZONE_ADDR,BUSS_AREA,AREA_MANAGE_ID,AREA_MANAGE_NAME,AREA_MANAGE_TEL,SALE_STORE_NAME,LOCAL_TYPE,BUSS_SCOPE,BEG_SBUSS_DATE', 
		'TERM_ID,TERM_NO,TERM_NAME,TERM_TYPE,CHANN_ID,CHANN_NO,CHANN_NAME,PERSON_CON,TEL,MOBILE,ADDRESS,ZONE_ID,CHANN_PERSON_CON,CHANN_TEL,AREA_ID,AREA_NO,AREA_NAME,ZONE_ADDR,BUSS_AREA,AREA_MANAGE_ID,AREA_MANAGE_NAME,AREA_MANAGE_TEL,SALE_STORE_NAME,LOCAL_TYPE,BUSS_SCOPE,BEG_SBUSS_DATE',
		'selectParams');	
}
