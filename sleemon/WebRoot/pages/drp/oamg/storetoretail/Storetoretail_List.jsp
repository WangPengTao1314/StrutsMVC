...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/oamg/storetoretail/Storetoretail_List.js"></script>
	...
	<td height="20px" valign="top">
		...
		<tr>			
			<c:if test="${module eq 'wh'}">
			 <td height="20px">&nbsp;&nbsp;当前位置：渠道管理&gt;&gt;转撤店管理&gt;&gt;专卖店转分销店申请单维护</td>
			</c:if>
			<c:if test="${empty module || module eq 'sh'}">
			 <td height="20px">&nbsp;&nbsp;当前位置：渠道管理&gt;&gt;转撤店管理&gt;&gt;专卖店转分销店申请单审核</td>
			</c:if>			
	...
	<td valign="top">
		<div class="lst_area" style="margin-left:3px;">			
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
					<th width="1%"></th>
					<th  nowrap="nowrap" align="center" dbname="SPCL_STORE_TO_RETAIL_REQ_NO" >专卖店转分销申请单号</th>
...
<!--                    <th  nowrap="nowrap" align="center" dbname="SPCL_STORE_TO_RETAIL_DATE" >专卖转分销日期</th>-->
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setSelEid(document.getElementById('eid${rr}'));">
					 <td width="1%"align='center' >
						<input type="radio" style="height:12px;valign:middle" name="eid" id="eid${rr}" value="${rst.SPCL_STORE_TO_RETAIL_REQ_ID}"/>
					 </td>
					 <td nowrap="nowrap" align="center">${rst.SPCL_STORE_TO_RETAIL_REQ_NO}&nbsp;</td>
...
<!--                     <td nowrap="nowrap" align="center">${rst.SPCL_STORE_TO_RETAIL_DATE}&nbsp;</td>-->
                     <td nowrap="nowrap" align="center">${rst.STATE}&nbsp;</td>
                    <input id="state${rst.SPCL_STORE_TO_RETAIL_REQ_ID}" type="hidden"  value="${rst.STATE}" />
				    </tr>
				</c:forEach>
...
<table width="100%" border="0" cellpadding="4" cellspacing="4" class="detail">
	<tr>
		<td class="detail2">
			...
			<input type="hidden" name=selectTERM value="STATE in ('启用') and DEL_FLAG=0 and CHANN_ID_P in ${QUERY_CHANN_ID}">
			...
			<input type="hidden" name="selectParamsArea" value="STATE in( '启用') and DEL_FLAG='0'">
               <tr>
                    <td width="8%" nowrap align="right" class="detail_label">专卖店转分销申请单号:</td>
					<td width="15%" class="detail_content">
	   					<input id="SPCL_STORE_TO_RETAIL_REQ_NO" name="SPCL_STORE_TO_RETAIL_REQ_NO"  style="width:155" value="${params.SPCL_STORE_TO_RETAIL_REQ_NO}"/>
					</td>
					...
					-->
                    <td width="8%" nowrap align="right" class="detail_label">专卖店转分销日期从:</td>
					<td width="15%" class="detail_content">
	   					<input id="SPCL_STORE_TO_RETAIL_DATE_BEG" name="SPCL_STORE_TO_RETAIL_DATE_BEG" json="SPCL_STORE_TO_RETAIL_DATE_BEG" readonly="readonly"   onclick="SelectDate();" style="width:155" value="${params.SPCL_STORE_TO_RETAIL_DATE_BEG }">
	   					<img align="absmiddle" style="cursor:hand" src="${ctx}/styles/${theme}/images/plus/date_16x16.gif"  onclick="SelectDate(SPCL_STORE_TO_RETAIL_DATE_BEG);" >
					</td>
					<td width="8%" nowrap align="right" class="detail_label">专卖店转分销日期到:</td>
					<td width="15%" class="detail_content">
	   					<input id="SPCL_STORE_TO_RETAIL_DATE_END" name="SPCL_STORE_TO_RETAIL_DATE_END" json="SPCL_STORE_TO_RETAIL_DATE_END" readonly="readonly"   onclick="SelectDate();"  style="width:155" value="${params.SPCL_STORE_TO_RETAIL_DATE_END }">
	   					<img align="absmiddle" style="cursor:hand" src="${ctx}/styles/${theme}/images/plus/date_16x16.gif"  onclick="SelectDate(SPCL_STORE_TO_RETAIL_DATE_END);">
					</td>
               </tr>
               <tr> 
