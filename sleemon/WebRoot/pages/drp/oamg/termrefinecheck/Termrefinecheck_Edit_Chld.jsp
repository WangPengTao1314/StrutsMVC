...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/oamg/termrefinecheck/Termrefinecheck_Edit_Chld.js"></script>
...
<td>
	<div class="lst_area">
	    <form>
		<input type="hidden" id="TERM_REFINE_CHECK_ID" name="TERM_REFINE_CHECK_ID">
		...
		<table id="jsontb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
			...
			<tr class="fixedRow">
              ...
              <th nowrap align="center">门店精致化检查项目类型</th>
              <th nowrap align="center">检查项目编号</th>
              <th nowrap align="center">检查项目名称</th>
              <th nowrap align="center">项目分值</th>
              <th nowrap align="center">扣分原因</th>
              <th nowrap align="center">检查结果得分</th>
            </tr>
		</table>
		</form>
	</div>
...
<script type="text/javascript">
	...
	var arrs = [
	           '${rst.TERM_REFINE_CHECK_DTL_ID}',
              '${rst.TERM_REFINE_CHECK_ID}',
              '${rst.PRJ_TYPE}',
              '${rst.PRJ_CODE}',
              '${rst.PRJ_NAME}',
              '${rst.PRJ_SCORE}',
