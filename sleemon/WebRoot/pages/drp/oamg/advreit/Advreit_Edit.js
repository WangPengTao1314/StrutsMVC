...
function selAdvcorder(){
	selCommon('BS_109', false, 'ERP_ADV_REQ_ID', 'ERP_ADV_REQ_ID', 'forms[0]',
		'ERP_ADV_REQ_ID,ERP_ADV_REQ_NO,CHANN_NO,CHANN_NAME,AREA_NAME,AREA_MANAGE_NAME,CHANN_RANK,ADV_CO_NAME,ADV_CO_CONTACT,ADV_CO_TEL,ADV_CONTENT,ADV_ADDR,ADV_TOTAL_AMOUNT,ATT_PATH,AREA_MANAGE_ID,CHANN_ID,AREA_ID,AREA_NO', 
		'ERP_ADV_REQ_ID,ERP_ADV_REQ_NO,CHANN_NO,CHANN_NAME,AREA_NAME,AREA_MANAGE_NAME,CHANN_RANK,ADV_CO_NAME,ADV_CO_CONTACT,ADV_CO_TEL,ADV_CONTENT,ADV_ADDR,ADV_TOTAL_AMOUNT,ATT_PATH,AREA_MANAGE_ID,CHANN_ID,AREA_ID,AREA_NO',
		'selectParams');
