...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/drp/oamg/rnvtncheck/Rnvtncheck_Edit_Frame_T.js"></script>
	<title>装修验收单维护</title>
</head>
<body>
...
<input type="hidden" id="RNVTN_CHECK_ID" value="${RNVTN_CHECK_ID}"/>
</body>
