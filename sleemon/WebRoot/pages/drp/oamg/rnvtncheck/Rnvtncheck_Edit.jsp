				...
				<tr>
							...
							<td width="35%" class="detail_content">
								<input json="RNVTN_CHECK_ID" name="RNVTN_CHECK_ID"
									...
									label="装修验收单ID" size="40" value="${rst.RNVTN_CHECK_ID}" />
							...
							<td width="35%" class="detail_content">
								 ...
								 <img align="absmiddle" name="" style="cursor: hand"
									...
									onClick="selCommon('BS_90', false, 'CHANN_RNVTN_ID', 'CHANN_RNVTN_ID', 'forms[0]','CHANN_RNVTN_NO,TERM_ID,TERM_NO,TERM_NAME,RNVTN_PROP,PLAN_SBUSS_DATE,AREA_ID,AREA_NO,AREA_NAME,AREA_MANAGE_ID,AREA_MANAGE_NAME,AREA_MANAGE_TEL,SALE_STORE_ID,SALE_STORE_NAME,ZONE_ADDR,LOCAL_TYPE,BUSS_SCOPE','CHANN_RNVTN_NO,TERM_ID,TERM_NO,TERM_NAME,RNVTN_PROP,PLAN_SBUSS_DATE,AREA_ID,AREA_NO,AREA_NAME,AREA_MANAGE_ID,AREA_MANAGE_NAME,AREA_MANAGE_TEL,SALE_STORE_ID,SALE_STORE_NAME,ZONE_ADDR,LOCAL_TYPE,BUSS_SCOPE','selectParams')">
							</td>
						</tr>
						<tr>
							<td width="15%" align="right" class="detail_label">
							...
							<td width="35%" class="detail_content">
								<input json="RNVTN_PRINCIPAL" name="XM"     id="RNVTN_PRINCIPAL" type="text"
									label="验收负责人"
									size="40" value="${RNVTN_PRINCIPAL}" inputtype="string" mustinput="true" readonly/> 
							    <img align="absmiddle" name="" style="cursor: hand"
									src="${ctx}/styles/${theme}/images/plus/select.gif"
							...
							<td width="35%" class="detail_content">
								<input json="RNVTN_CHECK_DATE" name="RNVTN_CHECK_DATE" id="RNVTN_CHECK_DATE" type="text"
									label="验收时间" size="40" value="${RNVTN_CHECK_DATE}"  onclick="SelectDate();" readonly/>
						...
						<tr>
							...
							<td width="35%" class="detail_content">
								<input id="TERM_NAME" name="TERM_NAME" json="TERM_NAME"
									type="text" size="40"  label = "终端名称"
									readonly  value="${rst.TERM_NAME}"/>
							</td>
						</tr>
						...
						<tr>
							...
							<td width="35%" class="detail_content">
							    ...
							    type="text" size="40" value="${rst.RNVTN_PROP}" readonly
							    />
							</td>
							<td width="15%" align="right" class="detail_label">
								计划开业时间：
						...
						<tr>
							...
							<td width="35%" class="detail_content">
							    <input json="AREA_MANAGE_ID" name="AREA_MANAGE_ID" id="AREA_MANAGE_ID" type="hidden" /> 
					    ...
					    <tr>
							...
							<td width="35%" class="detail_content">
								 <textarea rows="2" cols="32%" id="CHECK_REMARK" name="CHECK_REMARK" json="CHECK_REMARK" 
							        label="验收意见"  autocheck="true" inputtype="string"   maxlength="250" value="${rst.CHECK_REMARK}"></textarea>
							</td>
							<td width="15%" align="right" class="detail_label">
								处罚意见：
							</td>
							<td width="35%" class="detail_content">
								<textarea rows="2" cols="32%" id="PUNISH_REMARK" name="PUNISH_REMARK" json="PUNISH_REMARK" 
							        label="处罚意见" autocheck="true" inputtype="string"   maxlength="250" value="${rst.PUNISH_REMARK}"></textarea>
							</td>
						</tr>
						<tr>
							<td width="15%" align="right" class="detail_label">
						...
						<tr>
							...
							<td width="35%" class="detail_content" colspan="3">
							    <textarea rows="5" cols="32%" id="REMARK" name="REMARK" json="REMARK" autocheck="true" inputtype="string"   maxlength="250" value="${rst.REMARK}"></textarea>
						    </td>
	                    </tr>
                  </table>
              </td>
