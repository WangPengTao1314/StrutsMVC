...
<input type="hidden" id="RNVTN_SUBST_STD_ID" name="RNVTN_SUBST_STD_ID" value="${RNVTN_SUBST_STD_ID}"/>
<table width="100%" border="0" cellpadding="4" cellspacing="4" class="detail">
	<tr>
		<td class="detail2">
			<table id="jsontb"  width="100%" border="0" cellpadding="1" cellspacing="1" class="detail3">
			    <input type="hidden" json="RNVTN_SUBST_STD_ID" value="${rst.RNVTN_SUBST_STD_ID}" />
				<tr>
					<td width="15%" align="right" class="detail_label">装修补贴标准编号：</td>
					<td width="35%" class="detail_content">
						    <input json="RNVTN_SUBST_STD_NO" name="RNVTN_SUBST_STD_NO" size="40"  id="RNVTN_SUBST_STD_NO" type="text" autocheck="true" label="装修补贴标准编号" inputtype="string" mustinput="true"
					...
					<td width="15%" align="right" class="detail_label">品牌${rst.BRAND}：</td>
					<td width="35%" class="detail_content">
				...
				<tr>
					...
					<td width="35%" class="detail_content">
					   <input json="MIN_AREA" name="MIN_AREA" id="MIN_AREA" type="text"
									...
									size="40" autocheck="true" inputtype="float" valueType="10,2" mustinput="true" /> 
 					</td>
