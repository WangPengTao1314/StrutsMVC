...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/drp/oamg/decorationallo/Decorationallo_Frame.js"></script>
	       ...
	       <table cellSpacing=0 cellPadding=0 border=0 width="100%">
				<tr>
					...
					<td id="label" nowrap="nowrap">
						<span id="label_1" class="label_down" style="margin-top:2px;">&nbsp;补贴明细&nbsp;</span>
