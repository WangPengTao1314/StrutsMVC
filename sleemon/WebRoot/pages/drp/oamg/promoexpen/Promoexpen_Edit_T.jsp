				...
				<table width="100%" border="0" cellpadding="1" cellspacing="1" class="detail3">
				   <tr>
					   ...
					   <td width="35%" class="detail_content">
	                     <input json="REQ_NAME" name="REQ_NAME" autocheck="true" label="申请人"  type="text" disabled="disabled"  inputtype="string" size="40"   value="${rst.REQ_NAME}"/> 
					     <input type="hidden" id="ATT_PATH" name="ATT_PATH" value="${rst.ATT_PATH}"/>
					   </td>
					   <td width="15%" align="left" class="detail_label">申请日期：</td>
					   <td width="35%" class="detail_content">
	                     <input json="REQ_DATE" name="REQ_DATE" autocheck="true" label="申请日期"  type="text" disabled="disabled"  inputtype="string" size="40"   value="${rst.REQ_DATE}"/> 
					   </td>
	               </tr>
	               <tr>
	                   <td width="15%" align="right" class="detail_label">加盟商名称：</td>
					   <td width="35%" class="detail_content">
					        <input id="selectParamsTt" name="selectParamsTt" type="hidden"     value="CHANN_ID in ${CHANN_ID}">
                            ...
                            <input json="CHANN_NAME" name="CHANN_NAMET" id="CHANN_NAME" autocheck="true" label="加盟商名称"  type="text" disabled="disabled"  inputtype="string"  size="40"   maxlength="100"  value="${rst.CHANN_NAME}" /> 
					   ...
					   <td width="35%" class="detail_content">
                            ...
                            <input id="AREA_NAME"   name="AREA_NAME"      json="AREA_NAME" type="text" autocheck="true" label="战区名称" disabled="disabled" inputtype="string" size="40"   maxlength="30"  value="${rst.AREA_NAME}"/>
					   </td>
	               </tr>
	               <tr>
	                   <td width="15%" align="right" class="detail_label">城市名称：</td>
					   <td width="35%" class="detail_content">
	                     <input <c:if test="${module eq 'sh'}">disabled</c:if> json="CITY_NAME" name="CITY_NAME" id="CITY_NAME" autocheck="true" label="城市名称"  type="text" inputtype="string"  size="40" value="${rst.CITY_NAME}"/> 
					   </td>
					   <td width="15%" align="right" class="detail_label">城市类型：</td>
					   <td width="35%" class="detail_content">
	                     <input json="CITY_LVL" name="CITY_LVL" autocheck="true" label="城市级别"  type="text" inputtype="string"  size="40"  maxlength="250"  value="${rst.CITY_LVL}" disabled="disabled" /> 
					   </td>
	               </tr>
	               <tr>
					   ...
					   <td width="35%" class="detail_content">
 					     <input json="REQ_MAKE" name="REQ_MAKE" type="text" id="REQ_MAKE"
									autocheck="true" label="申请编码" inputtype="string"
									maxlength="32" size="40" value="${rst.REQ_MAKE}" 
									disabled="disabled">
 					   </td>
	               </tr>
	               <tr>
					   ...
					   <td width="35%" class="detail_content">
					     ...
					     <input json="BUDGET_ITEM_NAME" name="BUDGET_ITEM_NAME" id="BUDGET_ITEM_NAME" label="预算科目"
								autocheck="true" inputtype="string" size="40"  value="${rst.BUDGET_ITEM_NAME}" disabled="disabled" /> 
 					   </td>
					   ...
					   <td width="35%" class="detail_content">
					     ...
					     <input json="PRMT_PLAN_NAME" name="PRMT_PLAN_NAME" id="PRMT_PLAN_NAME" label="促销方案"
								autocheck="true" inputtype="string" size="40"  value="${rst.PRMT_PLAN_NAME}" disabled="disabled" />
 					   </td>
	               </tr>
	               <tr>
					   ...
					   <td width="15%" align="left" class="detail_content">
					         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;此次费用共计&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					         <input <c:if test="${module eq 'sh'}">disabled</c:if> type="text" size="20" name="TOTAL_PRMT_COST" autocheck="true" label="此次费用共计"  type="text" inputtype="float" valueType="10,2" json="TOTAL_PRMT_COST" id="TOTAL_PRMT_COST" value="${rst.TOTAL_PRMT_COST}"/>&nbsp;&nbsp;(元)
 					   </td>
					   <td width="15%" align="right" class="detail_label">预批金额：</td>
 					   <td width="35%" class="detail_content">
					     <input <c:if test="${module eq 'sh'}">disabled</c:if> json="BUDGET_AMOUNT" name="BUDGET_AMOUNT" id="BUDGET_AMOUNT" 
						        autocheck="true" label="预批金额"  type="text" inputtype="float" valueType="10,2" size="40" value="${rst.BUDGET_AMOUNT}"/>&nbsp;&nbsp;(元)
 					   </td>
	               </tr>
	               <tr>
					   <td width="15%" align="left" class="detail_content">
					         ...
					         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					         <select <c:if test="${module eq 'sh'}">disabled</c:if> name=COST_TYPE id="COST_TYPE" json="COST_TYPE" style="width: 155px;"  label="费用类别" inputtype="string"></select> 
 					   </td>
	               ...
	               <tr>
 					 ...
 					 <tr>
					   ...
					   <td width="35%" class="detail_content">
 					   	  <input <c:if test="${module eq 'sh'}">disabled</c:if> json="RETAIL_AMOUNT" name="RETAIL_AMOUNT" id="RETAIL_AMOUNT" autocheck="true" label="计划零售额"  type="text"  inputtype="string"  size="40"      maxlength="100"  value="${rst.RETAIL_AMOUNT}"/>&nbsp;&nbsp;(元) 
 					   </td>
	                   <td width="15%" align="right" class="detail_label">
	                            计划开单数
	                   </td>
					   <td width="35%" class="detail_content">
					      <input <c:if test="${module eq 'sh'}">disabled</c:if> type="text" name="BILL_AMOUNT" id="BILL_AMOUNT" json="BILL_AMOUNT" value="${rst.BILL_AMOUNT}" size="40" inputtype="string" />
 					   </td>
	                  </tr>
					   ...
					   <td width="15%" align="left" class="detail_content">
					        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;季度累计实际收入
					        <input type="text" name="TOTAL_REAL_AMOUNT" id="TOTAL_REAL_AMOUNT" json="TOTAL_REAL_AMOUNT" value="${rst.TOTAL_REAL_AMOUNT}" disabled="disabled"/>
 					   </td>
	                   <td width="15%" align="right" class="detail_label">
	                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;季度累计预批费用
	                   </td>
					   <td width="35%" class="detail_content">
					        <input type="text" name="TOTAL_ADVC_AMOUNT" id="TOTAL_ADVC_AMOUNT" json="TOTAL_ADVC_AMOUNT" size="40" value="${rst.TOTAL_ADVC_AMOUNT}" disabled="disabled"/>
 					   </td>
	                  </tr>
	                  <tr>
	                   <td width="15%" align="left" class="detail_content" colspan="6">
					       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;季度累计费效比
					       &nbsp;&nbsp;&nbsp;
					       <input type="text" name="TOTAL_RATE" id="TOTAL_RATE" json="TOTAL_RATE" value="${rst.TOTAL_RATE}" disabled="disabled"/>
 					   </td>
	                  </tr>
	                   <tr>
					   ...
					   <td width="15%" align="left" class="detail_content">
					       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;季度累计预算费用
					       <input type="text" name="AREA_TOTAL_BUDGET_AMOUNT" json="AREA_TOTAL_BUDGET_AMOUNT" id="AREA_TOTAL_BUDGET_AMOUNT" value="${rst.AREA_TOTAL_BUDGET_AMOUNT}" value="0" disabled="disabled"/>
 					   </td>
 					   <td width="15%" align="right" class="detail_label">
	                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;季度累计预批费用
	                   </td>
					   <td width="35%" class="detail_content">
					        <input type="text" name="AREA_TOTAL_PRE_AMOUNT" id="AREA_TOTAL_PRE_AMOUNT" json="AREA_TOTAL_PRE_AMOUNT" size="40" value="${rst.AREA_TOTAL_PRE_AMOUNT}" value="0" disabled="disabled"/>
 					   </td>
	                  </tr>
	                  <tr>
					   <td width="15%" align="left" class="detail_content" colspan="6">
					        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;季度累计预算可用
					        <input type="text" name="AREA_TOTAL_AVALIABLE_AMOUNT" json="AREA_TOTAL_AVALIABLE_AMOUNT" id="AREA_TOTAL_AVALIABLE_AMOUNT" value="${rst.AREA_TOTAL_AVALIABLE_AMOUNT}" value="0" disabled="disabled"/>
 					   </td>
	                  </tr>
	                  <tr>
					   ...
					   <td width="15%" align="left" class="detail_content">
					       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;季度累计预算费用
					        <input type="text" name="WARE_TOTAL_BUDGET_AMOUNT" id="WARE_TOTAL_BUDGET_AMOUNT" json="WARE_TOTAL_BUDGET_AMOUNT" value="${rst.WARE_TOTAL_BUDGET_AMOUNT}" disabled="disabled"/>
 					   </td>
 					   <td width="15%" align="right" class="detail_label">
	                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;季度累计预批费用
	                   </td>
					   <td width="35%" class="detail_content">
					        <input type="text" name="WARE_TOTAL_PRE_AMOUNT" id="WARE_TOTAL_PRE_AMOUNT" json="WARE_TOTAL_PRE_AMOUNT" size="40" value="${rst.WARE_TOTAL_PRE_AMOUNT}" disabled="disabled"/>
 					   </td>
	                  </tr>
	                  <tr>
					   <td width="15%" align="left" class="detail_content" colspan="6">
					       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;季度累计预算可用
					       <input type="text" name="WARE_TOTAL_AVALIABLE_AMOUNT" json="WARE_TOTAL_AVALIABLE_AMOUNT" id="WARE_TOTAL_AVALIABLE_AMOUNT" value="${rst.WARE_TOTAL_AVALIABLE_AMOUNT}" disabled="disabled"/>
 					   </td>
	                  </tr>
				</table>
			</td>
