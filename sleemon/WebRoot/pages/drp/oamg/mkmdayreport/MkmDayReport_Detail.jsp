...
<html>
	...
	<body class="bodycss1">
		<table width="100%" border="0" cellpadding="4" cellspacing="4" class="" style="margin-top: -20px;">
		   ...
		   <input type="hidden" name="SOFT_BED_AMOUNT" id="SOFT_BED_AMOUNT" value="${rstcv.SOFT_BED_AMOUNT}">
		   <input type="hidden" name="OTHER_AMOUNT" id="OTHER_AMOUNT" value="${rstcv.OTHER_AMOUNT}" />
			<tr>   
				<td class="detail2">
					<table width="100%" border="0" cellpadding="1" cellspacing="1"
						...
						<c:choose>
				             <c:when test="${not empty rstcv.CHANN_VISIT_DAY_ID}">
							<tr>
							   <td> 
							       加盟商拜访
							   </td>
							...
							<tr>
								...
								<td width="10%" align="left" class="detail_content">
									 床垫： &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ${rstcv.MATT_AMOUNT}(万元)
								</td>
							    <td width="10%" class="detail_content" align="right">
									软床：
								</td>
								<td width="15%" class="detail_content">
									 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${rstcv.SOFT_BED_AMOUNT}(万元)
								</td>
								<td width="10%" align="right" class="detail_content">
									<span style="float:left;">其他：</span>&nbsp;&nbsp;&nbsp;${rstcv.OTHER_AMOUNT}(万元)
								</td>
								<td width="10%" align="right" class="detail_content">
									合计：
								</td>
						  ...
						  <c:choose>
				             <c:when test="${not empty rstact.PROMOTION_ACTV_ID}">
								 <tr>
								   <td> 
								       推广活动推进
								   </td>
							  ...
							  <c:choose>
				               <c:when test="${not empty rstdis.DISTRIBUTOR_VISIT_ID}">
								<tr>
									<td border="blod;">
										分销商开发与拜访  
									</td>
							  ...
							  <c:choose>
				               <c:when test="${not empty rstcoo.COOPERATIVE_VISIT_ID}">
									<tr>
										<td border="blod;">
											"1+N"合作商开发与拜访
										</td>
								 ...
								 <c:choose>
				                  <c:when test="${not empty rstshop.SHOPP_GUIDE_TRAN_ID}">
									<tr>
										<td border="blod;">
											导购员培训
										</td>
							     ...
							     <c:choose>
				                  <c:when test="${not empty rsterm.TERMINAL_VISIT_ID}">
							        <tr>
										<td border="blod;">
											门店拜访表
										</td>
