			...
			<td class="detail2">
               ...
               <tr>
				   ...
				   <td width="35%" class="detail_content">
				     <input json="CHANN_CHECK_PLAN_ID" name="CHANN_CHECK_PLAN_ID"  id="CHANN_CHECK_PLAN_ID" type="hidden" value="${rst.CHANN_CHECK_PLAN_ID}"/> 
               ...
               <tr>
				   ...
				   <td width="35%" class="detail_content">
				   	 <input  json="STATE" name="STATE" id="STATE" autocheck="true" label="状态"  type="text"  size="40" inputtype="string" maxlength="100"  value="${rst.STATE}" READONLY/>
				   </td>
               </tr>
               <!-- 
               <tr>
