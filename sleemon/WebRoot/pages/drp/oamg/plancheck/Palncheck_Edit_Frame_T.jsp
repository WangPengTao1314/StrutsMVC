...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/drp/oamg/plancheck/Palncheck_Edit_Frame_T.js"></script>
	<title></title>
</head>
<body>
			...
			<table cellSpacing=0 cellPadding=0 border=0 width="100%">
				<tr>
					...
					<td id="label" nowrap="nowrap">
						<span id="label_1" class="label_down" style="margin-top:2px;">&nbsp;检查项目明细&nbsp;</span>
						<!--  
...
<input type="hidden" id="CHANN_CHECK_PLAN_ID" value="${CHANN_CHECK_PLAN_ID}"/>
</body>
