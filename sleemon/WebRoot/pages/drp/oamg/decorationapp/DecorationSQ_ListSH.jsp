...
<head>
	...
	<script type="text/javascript" src="${ctx}/pages/drp/oamg/decorationapp/DecorationSQ_ListSH.js"></script>
			           ...
			           <tr>
						   <td id="qxBtnTb" nowrap>
							   ...
							   <c:if test="${pvg.PVG_AUDIT_AUDIT eq 1 }">
							    <input id="audit" type="button" class="btn" value="审核(A)" title="Alt+A" accesskey="A">&nbsp;<input type="hidden" name="ZXSQ" id="ZXSQ" value="ZXSQ" />
							   </c:if>
							   ...
							   <c:if test="${pvg.PVG_BWS eq 1 or pvg.PVG_BWS_AUDIT eq 1 }">
							    <input id="export" type="button" class="btn" value="导出(U)" title="Alt+U" accesskey="U">
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)" id="tr${rr}">
						<td width="1%" align='center' >
							...
							<input type="hidden" name="CHANN_RNVTN_ID" id="CHANN_RNVTN_ID" json="CHANN_RNVTN_ID" value="${rst.CHANN_RNVTN_ID}"/>
...
<input type="hidden" name="isManage" id="isManage" value="${isManage}" />
</body>
