...
<head>
	...
	<script type="text/javascript">
	    function  sel(){
	       //selCommon('BS_168', false, 'OPEN_TERMINAL_REQ_NO', 'OPEN_TERMINAL_REQ_NO', 'forms[0]','OPEN_TERMINAL_REQ_ID,OPEN_TERMINAL_REQ_NO,AREA_ID,AREA_NO,AREA_NAME,CHANN_ID,CHANN_NO,CHANN_NAME,AREA_MANAGE_ID,AREA_MANAGE_NAME,SALE_STORE_NAME,ADDRESS,PLAN_SBUSS_DATE,USE_AREA,LOCAL_TYPET,BUSS_SCOPET,RNVTN_PROPT,TERM_NAME,CHANN_TEL,CHANN_PERSON_CON', 'OPEN_TERMINAL_REQ_ID,OPEN_TERMINAL_REQ_NO,AREA_ID,AREA_NO,AREA_NAME,CHANN_ID_P,CHANN_NO_P,CHANN_NAME_P,AREA_MANAGE_ID,AREA_MANAGE_NAME,SALE_STORE_NAME,ADDRESS,BEG_SBUSS_DATE,BUSS_AREA,LOCAL_TYPE,BUSS_SCOPE,RNVTN_PROP,TERM_NAME,TEL,PERSON_CON', 'selectParams')
	       selCommon('BS_168', false, 'OPEN_TERMINAL_REQ_NO', 'OPEN_TERMINAL_REQ_NO', 'forms[0]','TERM_NO,OPEN_TERMINAL_REQ_ID,OPEN_TERMINAL_REQ_NO,AREA_ID,AREA_NO,AREA_NAME,CHANN_ID,CHANN_NO,CHANN_NAME,AREA_MANAGE_ID,AREA_MANAGE_NAME,SALE_STORE_NAME,ADDRESS,PLAN_SBUSS_DATE,USE_AREA,LOCAL_TYPET,BUSS_SCOPET,RNVTN_PROP,TERM_NAME,CHANN_TEL,CHANN_PERSON_CON,AREA_MANAGE_TEL,TERM_ID', 'TERM_NO,OPEN_TERMINAL_REQ_ID,OPEN_TERMINAL_REQ_NO,AREA_ID,AREA_NO,AREA_NAME,CHANN_ID_P,CHANN_NO_P,CHANN_NAME_P,AREA_MANAGE_ID,AREA_MANAGE_NAME,SALE_STORE_NAME,ADDRESS,BEG_SBUSS_DATE,BUSS_AREA,LOCAL_TYPE,BUSS_SCOPE,RNVTN_PROP,TERM_NAME,TEL,PERSON_CON,AREA_MANAGE_TEL,TERM_ID', 'selectParams')
				...
				<td class="detail2">
					<table id="jsontb" width="100%" border="0" cellpadding="1"
						...
						<tr>
							...
							<td width="20%" class="detail_content">
								<input json="RNVTN_REQ_NAME" name="RNVTN_REQ_NAME"
									...
									size="30" value="${rst.RNVTN_REQ_NAME}" autocheck="true" inputtype="string"  mustinput="true"  readonly>
							</td>
							<td width="18%" align="right" class="detail_label">
								填报日期：
							</td>
							...
							<td width="20%" class="detail_content">
								...
								<input json="OPEN_TERMINAL_REQ_NO" name="OPEN_TERMINAL_REQ_NO" value="${rst.OPEN_TERMINAL_REQ_NO}"
									...
									size="30" value="" autocheck="true" inputtype="string"  mustinput="true"   readonly>
								<img align="absmiddle" name="" style="cursor: hand"
									src="${ctx}/styles/${theme}/images/plus/select.gif"
								    onClick="sel()">
									
									<!--  onClick="selCommon('BS_167', false, 'OPEN_TERMINAL_REQ_NO', 'OPEN_TERMINAL_REQ_NO', 'forms[0]','OPEN_TERMINAL_REQ_ID,OPEN_TERMINAL_REQ_NO,AREA_ID,AREA_NO,AREA_NAME,CHANN_ID,CHANN_NO,CHANN_NAME,AREA_MANAGE_ID,AREA_MANAGE_NAME,SALE_STORE_NAME,SALE_STORE_ID', 'OPEN_TERMINAL_REQ_ID,OPEN_TERMINAL_REQ_NO,AREA_ID,AREA_NO,AREA_NAME,CHANN_ID_P,CHANN_NO_P,CHANN_NAME_P,AREA_MANAGE_ID,AREA_MANAGE_NAME,SALE_STORE_NAME,SALE_STORE_ID', 'selectParams')">
							        -->
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td width="20%" class="detail_content">
							    <input json="TERM_NAME" name="TERM_NAME" json="TERM_NAME" type="text" size="35" value="${rst.TERM_NAME}" readonly/>
							</td>
							<td width="18%" align="right" class="detail_label">
								商场名称：
							</td>
						...
						<tr id="trT">
							...
							<td width="20%" class="detail_content">
							   <input type="text" name="AMOUNT_DESC" id="AMOUNT_DESC" json="AMOUNT_DESC" value="${rst.AMOUNT_DESC}" inputtype="string" autocheck="true" label="金额说明" size="35" READONLY/>
							</td> 
						</tr>
						<tr>
							<td width="18%" align="right" class="detail_label">
							...
							<td width="20%" class="detail_content" colspan="5">
							  <input type="hidden" name="BEAR_WAY" id="BEAR_WAY" json="BEAR_WAY" value="${rst.BEAR_WAY}" />
							  <input type="radio"  name="BEAR_WAYs" value="1" onclick="check()" checked="true"/>三次报销&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="BEAR_WAYs" value="2" onclick="check()"/>特殊政策&nbsp;&nbsp;&nbsp;&nbsp;
							<td>
						</tr>
						...
						<tr>
							...
							<td width="20%" class="detail_content" colspan="5">
								 <textarea json="REMARK" name="REMARK" id="REMARK" readonly label="特殊说明"
									rows="15" cols="100%" autocheck="true" inputtype="string"   maxlength="250">1、新开店老店重装定义：在同一商场内，同一品牌门店进行版本更新或更换店面位置均为老店翻新；商场内新设品牌门店为新开店，不足300平米的场地，条件允许情况下可开设两店，但门店数只能统计为1家店 。   
