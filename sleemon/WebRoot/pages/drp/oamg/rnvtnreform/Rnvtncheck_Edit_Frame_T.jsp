...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/drp/oamg/rnvtnreform/Rnvtnreform_Edit_Frame_T.js"></script>
	<title>装修整改单维护</title>
</head>
<body>
...
<input type="hidden" id="RNVTN_REFORM_ID"  value="${RNVTN_REFORM_ID}"/>
</body>
