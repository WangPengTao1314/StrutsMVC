				...
				<tr>
						...
						<tr>
							...
							<td width="35%" class="detail_content">
							    ...
							    <img align="absmiddle" name="" style="cursor: hand"
									...
									onClick="selCommon('BS_89', false, 'RNVTN_CHECK_NO', 'RNVTN_CHECK_NO', 'forms[0]','RNVTN_CHECK_NO,RNVTN_PRINCIPAL,CHANN_RNVTN_NO,RNVTN_CHECK_DATE,TERM_NO,TERM_NAME,RNVTN_PROP,PLAN_SBUSS_DATE,SALE_STORE_NAME,LOCAL_TYPE,BUSS_SCOPE,USE_AREA', 'RNVTN_CHECK_NO,RNVTN_PRINCIPAL,CHANN_RNVTN_NO,RNVTN_CHECK_DATE,TERM_NO,TERM_NAME,RNVTN_PROP,PLAN_SBUSS_DATE,SALE_STORE_NAME,LOCAL_TYPE,BUSS_SCOPE,USE_AREA', 'selectParams')">
							</td>
							<td width="15%" align="right" class="detail_label">
								装修申请单号：
							</td>
						...
						<tr>
						    ...
						    <tr>
								...
								<td width="35%" class="detail_content" colspan="3">
									<textarea json="REMARK" name="REMARK" id="REMARK" type="text" label="整改意见"
...
<input type="hidden" name="RNVTN_REFORM_ID" id="RNVTN_REFORM_ID" value="${RNVTN_REFORM_ID}"/>
</body>
</html>
