...
<head>
	...
	<title>新开门店请单维护列表</title>
	<link rel="stylesheet" type="text/css" href="${ctx}/styles/${theme}/css/style.css">
	<script language="JavaScript" src="${ctx}/pages/common/select/selCommJs.js"></script>
	<script type="text/javascript" src="${ctx}/pages/drp/oamg/openterminal/OpenTerminal_List.js"></script>
			   ...
			   <td height="20px" valign="top">
				...
				<tr>			
					<c:if test="${empty module || module eq 'wh'}">
					 <td height="20px">&nbsp;&nbsp;当前位置：渠道管理>>终端管理>>新开/翻新门店评估单维护</td>
					</c:if>
					<c:if test="${module eq 'sh'}">
					 <td height="20px">&nbsp;&nbsp;当前位置：渠道管理>>终端管理>>新开/翻新门店评估单审核</td>
					</c:if>			
	     ...
	     <td valign="middle">
		   <div class="lst_area" style="margin-left:3px;">
			<table id="ordertb" width="100%" border="0" cellpadding="1" cellspacing="1" class="lst">
				<tr class="fixedRow">
					<th width="1%"></th>
					<th nowrap align="center" dbname="OPEN_TERMINAL_REQ_NO" >新增终端申请单编号</th>
					<th nowrap align="center" dbname="CHANN_NO_P" >渠道编号</th>
					<th  nowrap="nowrap" align="center" dbname="CHANN_NAME_P" >渠道名称</th>
				...
				<c:forEach items="${page.result}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)" id="tr${rr}">
						<td width="1%" align='center' >
							<input type="radio" style="height:12px;valign:middle" name="eid" id="eid${rr}" value="${rst.OPEN_TERMINAL_REQ_ID}" onclick="setSelEid(document.getElementById('eid${rr}'));"/>
							<input type="hidden" name="OPEN_TERMINAL_REQ_ID" id="OPEN_TERMINAL_REQ_ID" value="${rst.OPEN_TERMINAL_REQ_ID}"/>
							<input type="hidden" id="state${rst.OPEN_TERMINAL_REQ_ID}" value="${rst.STATE}"/>
						</td>
						...
						<script type="text/javascript">
						   $("#tr${rr}").click(function(){
						      ...
						      state(document.getElementById('state${rst.OPEN_TERMINAL_REQ_ID}'));
						   });
					    </script>
	...
	<tr>
		<td class="detail2">
			<table width="100%" border="0" cellpadding="1" cellspacing="1" class="detail3">
				<tr>
					<td nowrap align="right" class="detail_label">新增终端申请单编号：</td>
					<td class="detail_content">
					 ...
					 <td nowrap align="right" class="detail_label">终端编号：</td>
		      		...
		      		<td nowrap class="detail_content">
		                <input json="CHANN_NO_P" name="CHANN_NO_P" id="CHANN_NO_P"    value="${params.CHANN_NO_P}" label="渠道编号" />
						...
						<img align="absmiddle" name="selCHANN_NO_P" style="cursor: hand"src="${ctx}/styles/${theme}/images/plus/select.gif"
							onClick="selCommon('BS_19', false, 'CHANN_NO_P', 'CHANN_NO', 'forms[1]','CHANN_ID_P,CHANN_NO_P,CHANN_NAME_P', 'CHANN_ID,CHANN_NO,CHANN_NAME', 'selectParams')">
		      		</td>
		      		<td nowrap align="right" class="detail_label">渠道名称：</td>
		      		<td nowrap class="detail_content">
		                <input id="CHANN_NAME_P" name="CHANN_NAME_P" json="CHANN_NAME_P" label="渠道名称" value="${params.CHANN_NAME_P}"/>
		      		</td>
		      		...
		      		<td nowrap class="detail_content">
						...
						<img align="absmiddle" name="selAREA_NO" style="cursor: hand"src="${ctx}/styles/${theme}/images/plus/select.gif"
							onClick="selCommon('BS_18', false, 'AREA_NO', 'AREA_NO', 'forms[1]','AREA_ID,AREA_NO,AREA_NAME', 'AREA_ID,AREA_NO,AREA_NAME', 'selectParams')">
		      		</td>
				    </tr>
				    <tr>
				    <td nowrap align="right" class="detail_label">区域名称：</td>
		      	   ...
		      	   <tr>
		      		...
		      		<td nowrap class="detail_content">
	                 <select id="RNVTN_PROP" name="RNVTN_PROP" json="RNVTN_PROP"  style="width:155px;"
							 	label="装修性质" inputtype="string" autocheck="true" value="${params.RNVTN_PROP}">
					 </select>
		      		</td>
		      		
		      		<td nowrap align="right" class="detail_label">开店类型：</td>
		      		<td nowrap class="detail_content">
	                 <select id="BEG_BUSS_TYPE" name="BEG_BUSS_TYPE" json="BEG_BUSS_TYPE"  style="width:155px;"
							 	label="开店类型" inputtype="string" autocheck="true" value="${params.BEG_BUSS_TYPE}">
					 </select>
		      		</td>
		      		<td nowrap align="right" class="detail_label">装修完成日期从：</td>
		      		<td nowrap class="detail_content">
	                 <input id="LAST_DECOR_TIME_BEG" name="LAST_DECOR_TIME_BEG" json="LAST_DECOR_TIME_BEG" 
							 	label="装修完成时间从" inputtype="string" autocheck="true" value="${params.LAST_DECOR_TIME_BEG}" onclick="SelectDate()" READONLY/>
					 <img align="absmiddle" style="cursor:hand" src="${ctx}/styles/${theme}/images/plus/date_16x16.gif" 
							onclick="SelectDate(LAST_DECOR_TIME_BEG);"/>
		      		</td>
		      		<td nowrap align="right" class="detail_label">装修完成日期到：</td>
		      		<td nowrap class="detail_content">
	                 <input id="LAST_DECOR_TIME_END" name="LAST_DECOR_TIME_END" json="LAST_DECOR_TIME_END" 
							 	label="装修完成时间到" inputtype="string" autocheck="true" value="${params.LAST_DECOR_TIME_END}" onclick="SelectDate()" READONLY/>
					 <img align="absmiddle" style="cursor:hand" src="${ctx}/styles/${theme}/images/plus/date_16x16.gif" 
							onclick="SelectDate(LAST_DECOR_TIME_END);"/>
		      		</td>
...
<script language="JavaScript">
   SelDictShow("BEG_BUSS_TYPE","BS_136","${params.BEG_BUSS_TYPE}","");
