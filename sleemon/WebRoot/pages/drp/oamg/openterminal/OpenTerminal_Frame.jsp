...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/drp/oamg/openterminal/OpenTerminal_Frame.js"></script>
	<title>新开门店申请单维护</title>
</head>
<body>
<table width="99.9%" height="98%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td>
      <div id="topdiv" style="height:45%;width:100%">
	    <!-- 上帧 -->
	           ...
	           <table cellSpacing=0 cellPadding=0 border=0 width="100%">
				<tr>
					...
					<td id="label" nowrap="nowrap">
						...
						<span id="label_2" class="label_down" style="margin-top:2px;">&nbsp;评估表&nbsp;</span>
