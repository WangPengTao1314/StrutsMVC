...
<%@ page import="com.hoperun.commons.edit.EditWebhelper,com.hoperun.commons.edit.EditBean"%>
<%
		String 	sContentID,
	        	sStyleID,
	        	sFullScreen,
	...
	//初始化输出bean
	EditBean bean = web.InitPara(sStyleName);
	...
	String sUploadFilePath=sStyleUploadDir;//"/UploadFile/";
