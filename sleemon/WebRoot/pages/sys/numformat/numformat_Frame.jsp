...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/sys/numformat/numformat_Frame.js"></script>
</head>
<BODY>
	<table cellspacing="0" cellpadding="0" width="100%" height="100%">
		<tr>
	<!-- 		<td id="leftiframe" width="180px"><iframe id="leftcontent" name="leftcontent" style="margin-left: 0px"
