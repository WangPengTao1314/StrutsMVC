...
<head>
    ...
    <script type="text/javascript" src="${ctx}/pages/sys/gzzxx/gzzxx_Mx_List.js"></script>
</head>
<BODY>
				...
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));">
						<td nowrap align='center' >
							<input type="checkbox" style="height:12px;valign:middle" id="eid${rr}" value="${rst.GZZCYID}" onclick="setEidChecked(this);">
						</td>
						<td nowrap align="center">${rst.YHBH }&nbsp;</td>
<!--						<td nowrap align="left">${rst.YHM}&nbsp;</td>-->
						<td nowrap align="left">${rst.XM}&nbsp;</td>
						<td nowrap align="left">${rst.YHLB}&nbsp;</td>
...
<form id="form1" action="#" method="post" name="listForm">
	<input type="hidden" id=GZZCYID name="GZZCYID" value=""/>
</form>
</body>
