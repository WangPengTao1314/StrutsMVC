...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/sys/gzzxx/gzzxx_Frame.js"></script>
	<title>工作组信息</title>
</head>
<BODY>
...
<tr>
	<td >
		 <div id="topdiv" style="height:50%;width:100%"><!-- 上帧 -->
			...
			<table cellSpacing=0 cellPadding=0 border=0 width="100%">
				<tr>
					...
					<td id="label" nowrap="nowrap">
					    <span id="label_1" class="label_down" style="margin-top:2px;" title="Alt+1" accesskey="1">&nbsp;工作组信息&nbsp;</span>
						<span id="label_2" class="label_down1" style="margin-top:2px;" title="Alt+2" accesskey="2">&nbsp;详细信息&nbsp;</span>
						<input type="hidden" id="showLabel" value="label_1"/>
					</td>
					<!--标签页添加完毕-->
					<td class="label_line" align="right" nowrap="nowrap" width="55px" >
						<input type="button"  id="butHidTop"  class="button" title="Alt+↑">
						<input type="button"  id="butHidBottom" class="button" title="Alt+↓">
					</td>
