...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/sys/ztxxwh/ztxxwh_Frame.js"></script>
...
<tr>
			...
			<td width="7px">
			 <table id="colResize" width="7" height="100%" style="cursor: e-resize" border="0" cellpadding="0" cellspacing="0"  background="${ctx}/styles/${theme}/images/left/sep3pt.gif">
			  <tr>
			    <td>&nbsp;</td>
			  </tr>
			</table>	
			...
			<table cellSpacing=0 cellPadding=0 border=0 width="100%">
				<tr>
					...
					<td id="label" nowrap="nowrap">
						<span id="label_1" class="label_down" style="margin-top:2px;" title="Alt+1">&nbsp;详细信息<input type="button" class="hiddenelem" accesskey="1">&nbsp;</span>
						<input type="hidden" id="showLabel" value="label_1"/>
					</td>
					<!--标签页添加完毕-->
					<td class="label_line" align="right" width="150px">
						<input type="button" id="butHidTop" class="button" value="↑(T)" title="Alt+T" accesskey="T">
						<input type="button" id="butHidBottom" class="button" value="↓(B)" title="Alt+B" accesskey="B">
					</td>
				</tr>
			</table>
		</div>
