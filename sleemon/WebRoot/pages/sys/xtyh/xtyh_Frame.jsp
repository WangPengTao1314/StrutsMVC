...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/sys/xtyh/xtyh_Frame.js"></script>
			...
			<table cellSpacing=0 cellPadding=0 border=0 width="100%">
				<tr>
					...
					<td id="label" nowrap="nowrap">
						...
						<span id="label_2" class="label_down" style="margin-top:2px;" >&nbsp;机构分管&nbsp;</span>
						<span id="label_3" class="label_down1" style="margin-top:2px;" >&nbsp;部门分管&nbsp;</span>
						<span id="label_4" class="label_down" style="margin-top:2px;" >&nbsp;帐套分管&nbsp;</span>
						<span id="label_1" class="label_down" style="margin-top:2px;" >&nbsp;详细信息&nbsp;</span>
						<span id="label_5" class="label_down" style="margin-top:2px;" >&nbsp;货品分管&nbsp;</span>
						<!--<span id="label_2" class="label_down" style="margin-top:2px;" >&nbsp;授权信息&nbsp;</span>-->
