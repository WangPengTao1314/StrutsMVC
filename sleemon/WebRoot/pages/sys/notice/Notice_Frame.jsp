...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/sys/notice/Notice_Frame.js"></script>
</head>
<BODY>
				...
				<table cellSpacing=0 cellPadding=0 border=0 width="100%">
					<tr>
						...
						<td id="label" nowrap="nowrap">
							...
							<span id="label_2" class="label_down1" style="margin-top:2px;">&nbsp;公告生效区域&nbsp;</span>
							<span id="label_3" class="label_down1" style="margin-top:2px;">&nbsp;公告生效部门&nbsp;</span>
