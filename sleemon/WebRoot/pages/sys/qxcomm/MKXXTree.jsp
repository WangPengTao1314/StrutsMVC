...
%>
<div  title="<%=MKAry[tempMKAryI2]%>"><img  style="cursor:hand" id="img<%=MKAry[tempMKAryI]%>" src="${ctx}/styles/${theme}/images/plus/closediv.gif" onclick="changeImg('<%=MKAry[tempMKAryI]%>');switchMenu(sub<%=MKAry[tempMKAryI]%>); ">
<input name="checkSelA" <%if (strMK.indexOf(MKAry[tempMKAryI])!=-1) {%>checked<%}%> value="<%=MKAry[tempMKAryI]%>" type="checkBox" id="input<%=MKAry[tempMKAryI]%>" style="border:0px" onclick="changeImg('<%=MKAry[tempMKAryI]%>');switchMenu(sub<%=MKAry[tempMKAryI]%>); callSel('<%=MKAry[tempMKAryI]%>');"><%=MKAry[i]+"["+MKAry[tempMKAryI]+"]"%></div>
<%
...
%>
&nbsp;&nbsp;&nbsp;
<img style="cursor:hand" title="<%=SubMKAry[tempMKAryJ2]%>" id="img<%=SubMKAry[tempMKAryJ]%>" src="${ctx}/styles/${theme}/images/plus/closediv.gif" onclick="changeImg('<%=SubMKAry[tempMKAryJ]%>');switchSubmenu(sub<%=SubMKAry[tempMKAryJ]%>);">
<input  title="<%=SubMKAry[tempMKAryJ2]%>" id="input<%=SubMKAry[tempMKAryJ]%>"  <%if (strMK.indexOf(SubMKAry[tempMKAryJ])!=-1) {%>checked<%}%>  type="checkBox" name="checkSelB<%=MKAry[tempMKAryI]%>"  value="<%=SubMKAry[tempMKAryJ]%>" style="border:0px" onclick="changeImg('<%=SubMKAry[tempMKAryJ]%>');switchSubmenu(sub<%=SubMKAry[tempMKAryJ]%>); callSel('<%=SubMKAry[tempMKAryJ]%>');"><font title="<%=SubMKAry[tempMKAryJ2]%>"><%=SubMKAry[j]+"["+SubMKAry[tempMKAryJ]+"]"%></font>
...
%>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input title="<%=FinalMKAry[tempMKAryK2]%>" id="input<%=FinalMKAry[tempMKAryK]%>"   <%   if (strMK.indexOf(FinalMKAry[tempMKAryK])!=-1) { %>checked<%}%> type="checkBox" name="checkSel" value="<%=FinalMKAry[tempMKAryK]%>" onclick="callSel('<%=FinalMKAry[tempMKAryK]%>')" style="border:0px"><font  title="<%=FinalMKAry[tempMKAryK2]%>"><%=FinalMKAry[k]+"["+FinalMKAry[tempMKAryK]+"]"%></font>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    %>
    <input type="radio" name="radioSel<%=FinalMKAry[tempMKAryK]%>" style="border:0px" value="<%=FinalMKAry[tempMKAryK]+"_0"%>" <%if (strMK.indexOf(FinalMKAry[tempMKAryK]+"_0")!=-1) { flag=1;%>checked<%}%>>机构集中
    <input type="radio" name="radioSel<%=FinalMKAry[tempMKAryK]%>" style="border:0px" value="<%=FinalMKAry[tempMKAryK]+"_1"%>" <%if (strMK.indexOf(FinalMKAry[tempMKAryK]+"_1")!=-1) { flag=1;%>checked<%}%>>多机构
    <input type="radio" name="radioSel<%=FinalMKAry[tempMKAryK]%>" style="border:0px" value="<%=FinalMKAry[tempMKAryK]+"_2"%>" <%if (strMK.indexOf(FinalMKAry[tempMKAryK]+"_2")!=-1) { flag=1;%>checked<%}%>>本机构
    <input type="radio" name="radioSel<%=FinalMKAry[tempMKAryK]%>" style="border:0px" value="<%=FinalMKAry[tempMKAryK]+"_3"%>" <%if (strMK.indexOf(FinalMKAry[tempMKAryK]+"_3")!=-1) { flag=1;%>checked<%}%>>部门集中
    <input type="radio" name="radioSel<%=FinalMKAry[tempMKAryK]%>" style="border:0px" value="<%=FinalMKAry[tempMKAryK]+"_4"%>" <%if (strMK.indexOf(FinalMKAry[tempMKAryK]+"_4")!=-1) { flag=1;%>checked<%}%>>多部门
    <input type="radio" name="radioSel<%=FinalMKAry[tempMKAryK]%>" style="border:0px" value="<%=FinalMKAry[tempMKAryK]+"_5"%>" <%if (strMK.indexOf(FinalMKAry[tempMKAryK]+"_5")!=-1) { flag=1;%>checked<%}%>>本部门
    <input type="radio" name="radioSel<%=FinalMKAry[tempMKAryK]%>" style="border:0px" value="<%=FinalMKAry[tempMKAryK]+"_6"%>" <%if (strMK.indexOf(FinalMKAry[tempMKAryK]+"_6")!=-1||flag==0) { flag=1;%>checked<%}%>>本人员
    <%
      }
      else {
    %>
    <input type="radio" name="radioSel<%=FinalMKAry[tempMKAryK]%>" style="border:0px" value="<%=FinalMKAry[tempMKAryK]+"_0"%>" <%if (MKQXJB.equals("0")) { %>checked<%}%>>机构集中
    <input type="radio" name="radioSel<%=FinalMKAry[tempMKAryK]%>" style="border:0px" value="<%=FinalMKAry[tempMKAryK]+"_1"%>" <%if (MKQXJB.equals("1")) { %>checked<%}%>>多机构
    <input type="radio" name="radioSel<%=FinalMKAry[tempMKAryK]%>" style="border:0px" value="<%=FinalMKAry[tempMKAryK]+"_2"%>" <%if (MKQXJB.equals("2")) { %>checked<%}%>>本机构
    <input type="radio" name="radioSel<%=FinalMKAry[tempMKAryK]%>" style="border:0px" value="<%=FinalMKAry[tempMKAryK]+"_3"%>" <%if (MKQXJB.equals("3")) { %>checked<%}%>>部门集中
    <input type="radio" name="radioSel<%=FinalMKAry[tempMKAryK]%>" style="border:0px" value="<%=FinalMKAry[tempMKAryK]+"_4"%>" <%if (MKQXJB.equals("4")) { %>checked<%}%>>多部门
    <input type="radio" name="radioSel<%=FinalMKAry[tempMKAryK]%>" style="border:0px" value="<%=FinalMKAry[tempMKAryK]+"_5"%>" <%if (MKQXJB.equals("5")) { %>checked<%}%>>本部门
    <input type="radio" name="radioSel<%=FinalMKAry[tempMKAryK]%>" style="border:0px" value="<%=FinalMKAry[tempMKAryK]+"_6"%>" <%if (MKQXJB.equals("6")) { %>checked<%}%>>本人员 
    <%
       }
    %>
</div>
...
function callDefaultRadio(Type) {
    if (!confirm("是否需要重新设定默认的所有权限级别？如果确定，则当前所有模块的权限级别都会被置为默认的级别同时目前没有提交的新增权限将会丢失（但如果不提交,原有权限不会更新)！")) return false;
	 window.location="readxml.shtml?action=toMkxxTree&MKLB=<%=MKLB%>&KeyName=<%=KeyName%>&KeyID=<%=KeyID%>&MKQXJB="+Type;
 ...
 function callSel(MKBH) {
    try {
	 ...
	 a= eval("document.all(\"input"+MKBH+"\").checked");
   ...
   //  alert(MKBH.length);
     ...
     if (a == false) {     
        if (MKBH.length == 5) {
           var tmp;
           eval("tmp=document.all('sub"+MKBH+"').all('checkSelB"+MKBH+"').length");
              
           for (i=0; i<tmp; i++) {  
	         if (eval("document.all('sub"+MKBH+"').all('checkSelB"+MKBH+"')[i].value.indexOf(MKBH)") != -1) {
	           eval("document.all('sub"+MKBH+"').all('checkSelB"+MKBH+"')[i].checked = false");          
	         }
	       }          	       	     
        }
        ...
        if (MKBH.length == 7) {
           var tmp;
             ...
             eval("tmp=document.all('sub"+MKBH+"').all('checkSel').length");
         
           if (tmp == null)   {
             tmp = 0;
             eval("document.all('sub"+MKBH+"').all('checkSel').checked = false");  
           } 
           
           for (i=0; i<tmp; i++) {  
	        // if (eval("document.all('sub"+MKBH+"').all('checkSel')[i].value.indexOf(MKBH)") != -1) {
	           eval("document.all('sub"+MKBH+"').all('checkSel')[i].checked = false");     
	        // }
	       }    
        }               
            var tmpMKBH;
	   ...
	   //        eval("tmpMKBH=document.insertForm.checkSelB"+MKBH+"[i].value");
	          // alert(tmpMKBH);
	           ...
	           eval("tmp2=document.all('sub"+MKBH+"').all('checkSel').length");
               for (j=0; j<tmp2; j++) {  
                 eval("tmpvalue = document.all('sub"+MKBH+"').all('checkSel')[j].value");
	             if (eval("tmpvalue.indexOf(MKBH)") != -1) {
	                eval("document.all('sub"+MKBH+"').all('checkSel')[j].checked = false");     
	             }
	      ...
	      if (MKBH.length == 5) {
           ...
           for (i=0; i<tmp; i++) {  
	         if (eval("document.all('sub"+MKBH+"').all('checkSelB"+MKBH+"')[i].value.indexOf(MKBH)") != -1) {
	           eval("document.all('sub"+MKBH+"').all('checkSelB"+MKBH+"')[i].checked = true");     
        ...
        if (MKBH.length == 7) {
           ...
           if (tmp == null)   {
             ...
             tmp = 0;
             eval("document.all('sub"+MKBH+"').all('checkSel').checked = true");  
           }
           
           for (i=0; i<tmp; i++) {  
	         //if (eval("document.all('sub"+MKBH+"').all('checkSel')[i].value.indexOf(MKBH)") != -1) {
	           eval("document.all('sub"+MKBH+"').all('checkSel')[i].checked = true");     
	         //}
	       }    
        }
	   ...
	   //      alert(tmpMKBH);
               ...
               for (j=0; j<tmp2; j++) {  
	             ...
	             if (eval("tmpvalue.indexOf(MKBH)") != -1) {
	                eval("document.all('sub"+MKBH+"').all('checkSel')[j].checked = true");     
	             }
	            // if (tmpvalue.substring(2,5) > decide) {
	            //   break;
	            // }
