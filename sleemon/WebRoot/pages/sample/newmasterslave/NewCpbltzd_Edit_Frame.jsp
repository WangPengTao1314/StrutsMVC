...
<head>
	...
	<script type=text/javascript src="${ctx}/pages/sample/newmasterslave/NewCpbltzd_Edit_Frame.js"></script>
	<title>成品不良品通知单维护</title>
</head>
<body>
<table border="0" cellpadding="0" cellspacing="0" width="99.9%" height="98%">
	<tr>
		<td>
			...
			<table cellSpacing=0 cellPadding=0 border=0 width="100%">
				<tr>
					...
					<td id="label" nowrap="nowrap">
						<span id="label_1" class="label_down" style="margin-top:2px;">&nbsp;成品不良品通知单明细&nbsp;</span>
