...
<head>
	...
	<title>成品不良品通知单信息</title>
	<link rel="stylesheet" type="text/css" href="${ctx}/styles/${theme}/css/style.css"/>
	<script type=text/javascript src="${ctx}/pages/sample/newmasterslave/NewCpbltzd_Frame.js"></script>
</head>
<BODY>
				...
				<table cellSpacing=0 cellPadding=0 border=0 width="100%">
					<tr>
						...
						<td id="label" nowrap="nowrap">
							<span id="label_1" class="label_down" style="margin-top:2px;">&nbsp;成品不良品通知单详细信息&nbsp;</span>
							<span id="label_4" class="label_down1" style="margin-top:2px;">&nbsp;详细信息&nbsp;</span>
