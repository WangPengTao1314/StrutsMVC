...
<html>
	<head>
		...
		<script type="text/javascript"
			src="${ctx}/pages/sample/newsingletable/newsingletable_Edit.js"></script>
		<title>机构信息编辑</title>
	</head>
	<body class="bodycss1">
									...
									<td class="detail2">
										<table width="100%" border="0" cellpadding="1" cellspacing="1"
											...
											<tr>
												...
												<td width="35%" class="detail_content">
													<input id="JGBH" json="JGBH" name="JGBH" type="text" autocheck="true"
														label="机构编号" inputtype="string" mustinput="true"
											...
											<tr>
												...
												<td width="35%" class="detail_content">
													<input json="FRDB" name="FRDB" type="text" autocheck="true"
														label="法人代表" inputtype="string" maxlength="50"
														value="${rst.FRDB }">
												</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td width="35%" class="detail_content">
													<input json="CZ" name="CZ" type="text" autocheck="true"
														label="传真" inputtype="string" maxlength="50"
														value="${rst.CZ }">
												</td>
												<td width="15%" align="right" class="detail_label">
													电子邮件：
												...
												<td width="35%" class="detail_content">
													<input json="DZYJ" name="DZYJ" type="text" autocheck="true"
														label="电子邮件" inputtype="string" maxlength="50"
														value="${rst.DZYJ }">
												</td>
											</tr>
											<tr>
												...
												<td width="35%" class="detail_content">
													<input json="ZYDZ" name="ZYDZ" type="text" autocheck="true"
														label="主页地址" inputtype="string" maxlength="50"
														value="${rst.ZYDZ }">
												</td>
												<td width="15%" align="right" class="detail_label">
													联系电话：
												...
												<td width="35%" class="detail_content">
													<input json="DH" name="DH" type="text" autocheck="true"
														label="联系电话" inputtype="string" maxlength="32"
														value="${rst.DH }">
												</td>
											</tr>
											<tr>
												...
												<td width="35%" class="detail_content">
													...
													<img align="absmiddle" name="selDZXX" style="cursor: hand"
														...
														onClick="selCommon('19', false, 'DZXXID', 'DZXXID', 'forms[0]','GJ,SF,CS', 'GJ,SF,CS', '')">
												</td>
												<td width="15%" align="right" class="detail_label">
													省/直辖市：
												</td>
											...
											<tr>
												...
												<td width="35%" class="detail_content">
													<input json="YZBM" name="YZBM" type="text" autocheck="true"
														label="邮政编码" inputtype="string" maxlength="12"
														value="${rst.YZBM }">
												</td>
											</tr>
											<tr>
												...
												<td width="35%" class="detail_content">
													<input json="XH" name="XH" type="text" autocheck="true"
														label="排序号" inputtype="int" mustinput="true" maxlength="11"
														value="${rst.XH }">
												</td>
											</tr>
											<tr>
												...
												<td width="35%" class="detail_content">
													<input json="JGYWMC" name="JGYWMC" type="text"
														autocheck="true" label="英文名称" inputtype="string"
												...
												<td width="35%" class="detail_content">
													<input json="JGYWJC" name="JGYWJC" type="text"
														autocheck="true" label="英文简称" inputtype="string"
											...
											<tr>
												...
												<td width="35%" class="detail_content">
													...
													<img align="absmiddle" name="selRYXX" style="cursor: hand"
														src="${ctx}/styles/${theme}/images/plus/select.gif"
														onClick="selCommon('10', false, 'FGCWRYID', 'RYXXID', 'forms[0]','FGCWRYXM', 'XM', 'ryxxSelectContion')">
												</td>
											...
											<tr>
												...
												<td width="35%" class="detail_content" colspan="3">
													<textarea json="XXDZ" name="XXDZ" inputtype="string"
														maxlength="250" rows="3" cols="80%">${rst.XXDZ }</textarea>
												</td>
											</tr>
											<tr>
												<td width="15%" align="right" class="detail_label" >
												...
												<td width="35%" class="detail_content" colspan="3">
													<textarea json="JGYWXXDZ" name="JGYWXXDZ" inputtype="string"
														maxlength="250" rows="3" cols="80%">${rst.JGYWXXDZ }</textarea>
												</td>
											</tr>
											<!--<tr>
