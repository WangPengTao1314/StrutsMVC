							...
							<tr>
								...
								<td>
									<table width="100%" height="40" border="0" align="center"
										...
										<tr>
											<td width="8%">
												<img src="${ctx}/styles/${theme}/images/plus/icon-warning.gif" width="32"
													height="32" />
											</td>
											<td width="92%">
												${msg}
										...
										<tr>
											<td colspan="2" align="center">
												<input id="ok" type="button" class="btn1" style="background:url(${ctx}/styles/${theme}/images/index/tsbt.png)" onclick="closeWindow()" value="确 定" />
											</td>
										</tr> -->
									</table>
								</td>
