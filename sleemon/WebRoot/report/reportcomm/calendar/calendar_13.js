...
function writeTopBar1()
{
	...
	var topBar1 = document.createElement('DIV1');
	topBar1.className = 'topBar';
	topBar1.id = 'topBar';
	calendarDiv1.appendChild(topBar1);

	// Left arrow
	var leftDiv1 = document.createElement('DIV1');
	...
	// Right arrow
	var rightDiv1 = document.createElement('DIV1');
	...
	// Month selector
	var monthDiv = document.createElement('DIV1');
	monthDiv.id = 'monthSelect';
	monthDiv.onmouseover = highlightSelect;
	monthDiv.onmouseout = highlightSelect;
	//monthDiv.onclick = showMonthDropDown;
    ...
    /*
	var monthPicker = createMonthDiv();
	monthPicker.style.left = '60px';
	monthPicker.style.top = monthDiv.offsetTop + monthDiv.offsetHeight + 1 + 'px';
	monthPicker.style.width ='60px';
	monthPicker.id = 'monthDropDown';
	calendarDiv1.appendChild(monthPicker);
	*/

	// Year selector
	var yearDiv = document.createElement('DIV1');
	yearDiv.onmouseover = highlightSelect;
	yearDiv.onmouseout = highlightSelect;
	//yearDiv.onclick = showYearDropDown;
	var span = document.createElement('SPAN');
	...
	var yearPicker = createYearDiv();
	yearPicker.style.left = '160px';
	yearPicker.style.top = monthDiv.offsetTop + monthDiv.offsetHeight + 1 + 'px';
	yearPicker.style.width = '35px';
	yearPicker.id = 'yearDropDown';
	calendarDiv1.appendChild(yearPicker);
...
function writeCalendarContent1()
{
	var calendarContentDivExists = true;
	if(!calendarContentDiv){
		calendarContentDiv = document.createElement('DIV1');
...
{
	var d = new Date();
	var bottomBar1 = document.createElement('DIV1');
	...
	var subDiv1 = document.createElement('DIV1');
	subDiv1.onclick = pickTodaysDate;
	subDiv1.id = 'todaysDateString';
	subDiv1.style.width = (calendarDiv.offsetWidth - 95) + 'px';
	var day = d.getDay();
	if (! weekStartsOnSunday) {
      if(day==0)day = 7;
      day--;
...
function initCalendar1()
{
	...
	calendarDiv1 = document.createElement('DIV1');
	calendarDiv1.id = 'calendarDiv';
