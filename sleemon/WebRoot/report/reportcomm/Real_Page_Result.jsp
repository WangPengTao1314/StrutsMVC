...
<html>
	...
	<body>
	<div class="lst_area" style="width:100%;height:93%">
...
<div style="width:100%;height:7%;position:absolute;bottom:0px">
...
//      	window.showModalDialog(url,window,"dialogwidth=800px; dialogheight=600px; status=no");
      	window.open(url,'报表','height=600, width=1000, top=100, left=100, toolbar=no, menubar=no, scrollbars=yes, resizable=yes,location=no, status=no');
      }
</script>
<script type="text/javascript">	  
$(function(){	
