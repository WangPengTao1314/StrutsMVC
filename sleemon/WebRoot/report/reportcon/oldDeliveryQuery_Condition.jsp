...
<table width="100%" cellspacing="0" cellpadding="0" class="wz">
	<tr>
		...
		<td>当前位置：报表管理&gt;&gt;销售报表&gt;&gt;原发运单查询</td>
	</tr>
</table>
<form id="queryForm" method="post" action="raq.shtml?action=toQueryOldDelivery" target="bottomcontent${rptConFile}">
					...
					<table width="100%" border="0" cellpadding="1" cellspacing="1"	class="detail3" id="jsontb">
						<tr>
							...
							<td width="15%" class="detail_content">
				   				<input id="DELIVER_ORDER_NO" name="DELIVER_ORDER_NO" mustinput="true" inputtype="true" autocheck="true" label="发运单号" type="text"  value="${params.DELIVER_ORDER_NO}"/>
							</td>
