...
<table width="100%" cellspacing="0" cellpadding="0" class="wz">
	<tr>
		...
		<td>当前位置：报表管理&gt;&gt;销售报表&gt;&gt;订货订单报表</td>
	</tr>
</table>
<form id="queryForm" method="post" action="raq.shtml?action=toGoodOrderResult" target="bottomcontent${rptConFile}">
			...
			<td class="detail2" height="100">
					<table width="100%" border="0" cellpadding="1" cellspacing="1"
						...
						<tr>
							...
							<td width="15%" class="detail_content">
								<input json="KSRQ" name="KSRQ" id="KSRQ" type="text" mustinput="true" autocheck="true" inputtype="date" value="" label="业务日期从" onclick="SelectDate()">	
							...
							<td width="15%" class="detail_content">
								<input json="JZRQ" name="JZRQ" id="JZRQ" type="text" mustinput="true" autocheck="true" inputtype="date" value="" label="业务日期到"  onclick="SelectDate()">
						...
						<tr>
							...
							<td width="10%" nowrap align="right" class="detail_label">订货订单状态:
							</td>
