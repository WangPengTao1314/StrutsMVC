...
<body style="overflow:auto" onload="load()">
<table width="100%" cellspacing="0" cellpadding="0" class="wz">
	<tr>
		<td width="28" align="center"><label class="wz_img"></label></td>
		<td>当前位置：报表管理&gt;&gt;营销报表&gt;&gt;销售目标达成率</td>
	</tr>
</table>
<form id="queryForm" method="post" action="raq.shtml?action=toSalePlanReport" target="bottomcontent${rptConFile}">
			...
			<td class="detail2" height="100">
					<table width="100%" border="0" cellpadding="1" cellspacing="1"
						...
						<tr>
							...
							<td width="15%" class="detail_content">
								<input json="START_DATE" name="START_DATE" id="START_DATE" type="text"    autocheck="true" inputtype="date" value="" label="出库日期从" onclick="SelectDate()" value="SelectDate(1)">	
							...
							<td width="15%" class="detail_content">
								<input json="END_DATE" name="END_DATE" id="END_DATET" type="text"   autocheck="true" inputtype="date" label="出库日期到"  onclick="SelectDate()">
