...
<table width="100%" cellspacing="0" cellpadding="0" class="wz">
	<tr>
		...
		<td>当前位置：报表中心&gt;&gt;报表管理&gt;&gt;直营办报表&gt;&gt;销售情况统计表</td>
	</tr>
</table>
<form id="queryForm" method="post" action="raq.shtml?action=toSaleaOrderReport" target="bottomcontent${rptConFile}">
		...
		<tr>
			<td class="detail2" height="100">
					<table width="100%" border="0" cellpadding="1" cellspacing="1"
						...
						<tr>
							<td width="10%" align="right" class="detail_label">销售日期从：</td>
							<td width="15%" class="detail_content">
								<input json="ORDER_DATE_BENG" name="ORDER_DATE_BENG" id="ORDER_DATE_BENG" type="text" inputtype="date" value="" label="销售日期从" autocheck="true" onclick="SelectDate()" READONLY />
								<img align="absmiddle" style="cursor:hand" src="${ctx}/styles/${theme}/images/plus/date_16x16.gif" onclick="SelectDate(ORDER_DATE_BENG);">
							</td>
							<td width="10%" nowrap align="right" class="detail_label">销售日期到：</td>
							<td width="15%" class="detail_content">
								<input json="ORDER_DATE_END" name="ORDER_DATE_END" id="ORDER_DATE_END" type="text" inputtype="date" value="" label="销售日期到" autocheck="true" onclick="SelectDate()" READONLY />
							...
							<td width="15%" class="detail_content">
								<input id="ORDER_CHANN_ID" name="ORDER_CHANN_ID"  json="ORDER_CHANN_ID" type="hidden"  style="width:155"  />
								<input id="ORDER_CHANN_NO" name="ORDER_CHANN_NO"  json="ORDER_CHANN_NO"  type="text" style="width:155"  />
				   				<img align="absmiddle" name="" style="cursor: hand"
										src="${ctx}/styles/${theme}/images/plus/select.gif"
										onClick="selCommon('BS_185', true, 'ORDER_CHANN_ID', 'TERM_ID', 'forms[0]',
							...
							<td width="15%" class="detail_content">
			   					<input id="ORDER_CHANN_NAME" name="ORDER_CHANN_NAME"  json="ORDER_CHANN_NAME" type="text" style="width:155" />
							</td>
						</tr>
						<tr>							
						...
						<tr>
							...
							<td width="15%" class="detail_content">
								<input id="SALE_ORDER_NO" name="SALE_ORDER_NO" type="text"  value="${params.SALE_ORDER_NO}"/>
							</td>
