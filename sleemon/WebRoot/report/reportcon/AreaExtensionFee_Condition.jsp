...
<table width="100%" cellspacing="0" cellpadding="0" class="wz">
	<tr>
		...
		<td>当前位置：报表管理&gt;&gt;营销报表&gt;&gt;区域推广费</td>
	</tr>
</table>
<form id="queryForm" method="post" action="raq.shtml?action=toAreaExtensionFeeReport" target="bottomcontent${rptConFile}">
			...
			<td class="detail2" height="100">
					<table width="100%" border="0" cellpadding="1" cellspacing="1"
						...
						<tr>
							...
							<td width="10%" align="right" class="detail_label"> 区域编号： </td>
							<td width="15%" class="detail_content">
