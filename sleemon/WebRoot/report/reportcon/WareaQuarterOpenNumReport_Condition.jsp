...
<head>
	...
	<title>有效门店达成数报表</title>
</head>
<body style="overflow:auto">
<table width="100%" cellspacing="0" cellpadding="0" class="wz">
	<tr>
		<td width="28" align="center"><label class="wz_img"></label></td>
		<td>当前位置：报表管理&gt;&gt;营销报表&gt;&gt;各战区有效门店达成数</td>
	</tr>
</table>
<form id="queryForm" method="post" action="raq.shtml?action=toWareaQuarterOpenNumReport" target="bottomcontent${rptConFile}">
		...
		<tr>
			<td class="detail2" height="100">
					<table width="100%" border="0" cellpadding="1" cellspacing="1"
					   ...
					   <tr>
					   		<td width="10%" align="right" class="detail_label"nowrap="nowrap"> 月份： </td>
							<td width="15%" class="detail_content">
							  <select json="MONTH" name="MONTH" id="MONTH" style="width:155px;"  label="月份"  ></select>
							   <SPAN class="validate">&nbsp;*</SPAN> 
							</td>
