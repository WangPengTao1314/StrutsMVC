...
<table width="100%" cellspacing="0" cellpadding="0" class="wz">
	<tr>
		...
		<td>当前位置：报表管理&gt;&gt;财务报表&gt;&gt;返款情况查询</td>
	</tr>
</table>
<form id="queryForm" method="post" action="raq.shtml?action=toQueryRebates" target="bottomcontent${rptConFile}">
			...
			<td class="detail2" height="100">
					<table width="100%" border="0" cellpadding="1" cellspacing="1"	class="detail3" id="jsontb">
						...
						<tr>
							...
							<td width="15%" class="detail_content">
								<input json="SAEL_DATE_BENG" name="SAEL_DATE_BENG" id="SAEL_DATE_BENG" type="text" inputtype="date" value="" label="销售日期从"  autocheck="true" onclick="SelectDate()">	
							...
							<td width="15%" class="detail_content">
								<input json="SAEL_DATE_END" name="SAEL_DATE_END" id="SAEL_DATE_END" type="text"  inputtype="date" value="" label="销售日期到"  autocheck="true" onclick="SelectDate()">	
							...
							<td width="15%" class="detail_content">
								<input json="WRITE_OFF_PSON_TIME_BENG" name="WRITE_OFF_PSON_TIME_BENG" id="WRITE_OFF_PSON_TIME_BENG" type="text" inputtype="date" value="" label="核销日期从"  autocheck="true" onclick="SelectDate()">	
								<img align="absmiddle" style="cursor:hand" src="${ctx}/styles/${theme}/images/plus/date_16x16.gif" onclick="SelectDate(WRITE_OFF_PSON_TIME_BENG);">
							</td>
							<td width="10%" align="right" class="detail_label"nowrap="nowrap">
								核销日期到：
							</td>
							<td width="15%" class="detail_content">
								<input json="WRITE_OFF_PSON_TIME_END" name="WRITE_OFF_PSON_TIME_END" id="WRITE_OFF_PSON_TIME_END" type="text"  inputtype="date" value="" label="核销日期到"  autocheck="true" onclick="SelectDate()">	
								<img align="absmiddle" style="cursor:hand" src="${ctx}/styles/${theme}/images/plus/date_16x16.gif" onclick="SelectDate(WRITE_OFF_PSON_TIME_END);">
							</td>
						</tr>
						<tr>
