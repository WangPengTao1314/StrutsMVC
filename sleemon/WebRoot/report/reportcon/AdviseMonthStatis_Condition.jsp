...
<head>
	...
	<title>每月售后投诉报表</title>
</head>
<body style="overflow:auto">
<table width="100%" cellspacing="0" cellpadding="0" class="wz">
	<tr>
		<td width="28" align="center"><label class="wz_img"></label></td>
		<td>当前位置：报表管理&gt;&gt;营销报表&gt;&gt;每月售后投诉报表</td>
	</tr>
</table>
<form id="queryForm" method="post" action="raq.shtml?action=toAdviseMothStatis" target="bottomcontent${rptConFile}">
					...
					<table width="100%" border="0" cellpadding="1" cellspacing="1"	class="detail3" id="jsontb">
						...
						<tr>
							...
							<td width="15%" class="detail_content">
								<input id="YEAR_MONTH" name="YEAR_MONTH"   value="${params.YEAR_MONTH}" onclick="SelectDate1();" readonly="readonly"/>
								&nbsp;
								<img align="absmiddle" style="cursor: hand" src="${ctx}/styles/${theme}/images/plus/date_16x16.gif" onclick="SelectDate1(YEAR_MONTH);" />
							</td>
