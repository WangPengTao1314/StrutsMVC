...
<table width="100%" cellspacing="0" cellpadding="0" class="wz">
	<tr>
		...
		<td>当前位置：报表管理&gt;&gt;财务报表&gt;&gt;信用流水账对照</td>
	</tr>
</table>
<form id="queryForm" method="post" action="raq.shtml?action=toCreditAcctResult" target="bottomcontent${rptConFile}">
			...
			<td class="detail2" height="100">
					<table width="100%" border="0" cellpadding="1" cellspacing="1" class="detail3" id="jsontb">
						...
						<tr>
							...
							<td width="15%" class="detail_content">
								<input json="KSRQ" name="KSRQ" id="KSRQ" type="text"  mustinput="true" autocheck="true" 
							...
							<td width="15%" class="detail_content">
								<input json="JZRQ" name="JZRQ" id="JZRQ" type="text"  mustinput="true" autocheck="true" inputtype="date"  
