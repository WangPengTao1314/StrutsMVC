...
<table width="100%" cellspacing="0" cellpadding="0" class="wz">
	<tr>
		...
		<td>当前位置：报表管理&gt;&gt;销售报表&gt;&gt;冻结信用</td>
	</tr>
</table>
<form id="queryForm" method="post" action="raq.shtml?action=toCreditFreeze" target="bottomcontent${rptConFile}">
					...
					<table width="100%" border="0" cellpadding="1" cellspacing="1"
						...
						<tr>
							...
							<td width="15%" class="detail_content">
									...
									<input id="CHANN_NO" name="CHANN_NO"  json="CHANN_NO" label="渠道编号" inputtype="string"  mustinput="true" autocheck="true"   <c:if test="${IS_DRP_LEDGER eq 1}"> value="${CHANN_NO}" readonly</c:if> />
