...
<body style="overflow: auto">
	<table width="100%" cellspacing="0" cellpadding="0" class="wz">
		<tr>
			...
			<td>
				当前位置：报表管理&gt;&gt;直营办报表&gt;&gt;进销存报表
			</td>
		</tr>
	</table>
	<form id="queryForm" method="post" action="raq.shtml?action=toInvocAcctaReport"
			...
			<tr>
				<td class="detail2" height="100">
					<table width="100%" border="0" cellpadding="1" cellspacing="1"
						...
						<input type="hidden" name="selectParamsStore" id="selectParamsStore" value="STATE in( '启用','停用') and DEL_FLAG='0' and BEL_CHANN_ID='${ZTXXID}'">	
						...
						<tr>
							...
							<td width="15%" class="detail_content">
								<select id="YEAR" name="YEAR" json="YEAR" style="width: 155px;" inputtype="string" mustinput="true" label="年份" autocheck="true" ></select>
							</td>
							<td width="10%" nowrap align="right" class="detail_label">
								月份:
							</td>
							<td width="15%" class="detail_content">
								<select id="MONTH" name="MONTH" inputtype="string" style="width: 155px;" json="MONTH" mustinput="true" label="月份" autocheck="true"></select>
							</td>
						...
						<tr>
							<td width="10%" align="right" class="detail_label" nowrap="nowrap">库房编号：</td>
							<td width="15%" class="detail_content">
							 <input type="hidden" name="STORE_ID" id="STORE_ID" value="${params.STORE_ID}"/>
							 <input type="text" name="STORE_NO" id="STORE_NO" value="${params.STORE_NO}"/>
							 <img align="absmiddle" name="" style="cursor: hand"
										src="${ctx}/styles/${theme}/images/plus/select.gif"
										onClick="selCommon('BS_35', true, 'STORE_ID', 'STORE_ID', 'forms[0]','STORE_NO,STORE_NAME', 'STORE_NO,STORE_NAME', 'selectParamsStore');">
							</td>
							...
							<td width="10%" nowrap align="right" class="detail_label">纬度：</td>
							<td width="15%" class="detail_content">
