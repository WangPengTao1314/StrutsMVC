...
<head>
	...
	<title>库存预订单对照备货查询</title>
</head>
<body style="overflow:auto">
<table width="100%" cellspacing="0" cellpadding="0" class="wz">
	<tr>
		<td width="28" align="center"><label class="wz_img"></label></td>
		<td>当前位置：报表管理&gt;&gt;库存报表&gt;&gt;库存预订单对照备货查询</td>
	</tr>
</table>
<form id="queryForm" method="post" action="raq.shtml?action=toAdvcStoreAcct" target="bottomcontent${rptConFile}">
