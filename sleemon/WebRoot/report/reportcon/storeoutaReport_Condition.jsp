...
<table width="100%" cellspacing="0" cellpadding="0" class="wz">
	<tr>
		...
		<td>当前位置：报表中心&gt;&gt;报表管理&gt;&gt;直营办报表&gt;&gt;发货情况统计表</td>
	</tr>
</table>
<form id="queryForm" method="post" action="raq.shtml?action=toStoreoutaReport" target="bottomcontent${rptConFile}">
		...
		<tr>
			<td class="detail2" height="100">
					<table width="100%" border="0" cellpadding="1" cellspacing="1"
						...
						<tr>
							<td width="10%" align="right" class="detail_label">出货日期从：</td>
							<td width="15%" class="detail_content">
								<input json="DEAL_TIME_BENG" name="DEAL_TIME_BENG" id="DEAL_TIME_BENG" type="text" inputtype="date" value="" label="出货日期从" autocheck="true" onclick="SelectDate()" READONLY />
								<img align="absmiddle" style="cursor:hand" src="${ctx}/styles/${theme}/images/plus/date_16x16.gif" onclick="SelectDate(DEAL_TIME_BENG);">
							</td>
							<td width="10%" nowrap align="right" class="detail_label">出货日期到：</td>
							<td width="15%" class="detail_content">
								<input json="DEAL_TIME_END" name="DEAL_TIME_END" id="DEAL_TIME_END" type="text" inputtype="date" value="" label="出货日期到" autocheck="true" onclick="SelectDate()" READONLY />
							...
							<td width="15%" class="detail_content">
								<input id="RECV_CHANN_ID" name="RECV_CHANN_ID"  json="RECV_CHANN_ID" type="hidden"  style="width:155"  />
								<input id="RECV_CHANN_NO" name="RECV_CHANN_NO"  json="RECV_CHANN_NO"  type="text" style="width:155"  />
				   				<img align="absmiddle" name="" style="cursor: hand"
										src="${ctx}/styles/${theme}/images/plus/select.gif"
										onClick="selCommon('BS_185', true, 'RECV_CHANN_ID', 'TERM_ID', 'forms[0]',
										'RECV_CHANN_ID,RECV_CHANN_NO,RECV_CHANN_NAME', 
						...
						<tr>
							...
							<td width="15%" class="detail_content">
								<input id="STOREOUT_NO" name="STOREOUT_NO" type="text"  value="${params.STOREOUT_NO}"/>
							</td>
