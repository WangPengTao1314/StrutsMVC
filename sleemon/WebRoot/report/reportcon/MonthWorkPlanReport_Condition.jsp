...
<head>
	...
	<title>月工作计划提交情况</title>
</head>
<body style="overflow:auto">
<table width="100%" cellspacing="0" cellpadding="0" class="wz">
	<tr>
		<td width="28" align="center"><label class="wz_img"></label></td>
		<td>当前位置：报表中心&gt;&gt;报表管理&gt;&gt;销售报表&gt;&gt;月工作计划提交情况</td>
	</tr>
</table>
<form id="queryForm" method="post" action="raq.shtml?action=toMonthWorkPalnReport" target="bottomcontent${rptConFile}">
					...
					<table width="100%" border="0" cellpadding="1" cellspacing="1"
						...
						<tr>
							...
							<td width="15%" class="detail_content">
								<select id="PLAN_YEAR" json="PLAN_YEAR" name="PLAN_YEAR" style="width: 155px;" ></select>
							</td>
							<td width="10%" nowrap align="right" class="detail_label" >
									月份：
							</td>
							<td width="20%" class="detail_content">
							    <select id="PLAN_MONTH" name="PLAN_MONTH" json="PLAN_MONTH" style="width: 155px" ></select>
							</td>
						</tr>
						<tr>
...
<script language="JavaScript">
	SelDictShow("PLAN_YEAR","89","${params.CUR_YEAR}","");
    SelDictShow("PLAN_MONTH","168","${params.CUR_MONTH}","");
$(function(){	
//form校验设置
	InitFormValidator(0);
 	//查询！！！！！！
