...
<table width="100%" cellspacing="0" cellpadding="0" class="wz">
	<tr>
		...
		<td>当前位置：报表管理&gt;&gt;销售报表&gt;&gt;门店销售统计(成本)</td>
	</tr>
</table>
					...
					<table width="100%" border="0" cellpadding="1" cellspacing="1"
						...
						<tr>
							...
							<td width="15%" class="detail_content">
								<input name="FDflag" value="1" type="hidden">
							...
							<td width="15%" class="detail_content">
								<input id="TERM_NAME" name="TERM_NAME"  json="TERM_NAME" style="width:155" value="${params.TERM_NAME}"/>	   					
			   					<img align="absmiddle" name="" style="cursor: hand"
									src="${ctx}/styles/${theme}/images/plus/select.gif"
									onClick="selCommon('BS_27', true, 'TERM_NAME', 'TERM_NAME', 'forms[0]',
						...
						<tr>
							<td width="10%" nowrap align="right" class="detail_label">发货/退货日期从：</td>
							<td width="20%" class="detail_content">
								<input json="ORDER_RECV_DATE_BEGIN" name="ORDER_RECV_DATE_BEGIN" id="ORDER_RECV_DATE_BEGIN" type="text"  autocheck="true" inputtype="date"   value="" label="发货/退货日期从" onclick="SelectDate()">	
							...
							<td width="10%" align="right" class="detail_label"nowrap="nowrap">发货/退货日期到：</td>
							<td width="15%" class="detail_content">
								<input json="ORDER_RECV_DATE_END" name="ORDER_RECV_DATE_END" id="ORDER_RECV_DATE_END" type="text"  autocheck="true"  inputtype="date" value=""  label="发货/退货日期到" onclick="SelectDate()">
						...
						<tr>
							<td width="10%" nowrap align="right" class="detail_label">成本类型：</td>
							<td width="20%" class="detail_content">
								<input name="COST_FLAG" id="COST_FLAG" type="hidden">
								<input type="radio" name="flag" onclick="upFlag('0')" checked="checked" >月成本&nbsp;&nbsp;&nbsp;
								<input type="radio" name="flag" onclick="upFlag('1')"  >供货价
							</td>
							<td width="10%" align="right" class="detail_label">
								门店编号：
							</td>
							<td width="15%" class="detail_content">
								<input id="TERM_NO" name="TERM_NO"  json="TERM_NO" style="width:155" value="${params.TERM_NO}"/>	   					
			   					<img align="absmiddle" name="" style="cursor: hand"
									src="${ctx}/styles/${theme}/images/plus/select.gif"
									onClick="selCommon('BS_27', true, 'TERM_NO', 'TERM_NO', 'forms[0]',
