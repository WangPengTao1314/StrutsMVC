...
*/
package com.hoperun.erp.sale.prdreturn.model;
 ...
 */
public class PrdreturnModelChld extends BaseModel{
   /** 退货单明细ID **/
   ...
   /**货品序列号**/
   private String  SN;
   private String ADVC_RETURN_PRICE;
   

	/**
 * @return the aDVC_RETURN_PRICE
 */
public String getADVC_RETURN_PRICE() {
	return ADVC_RETURN_PRICE;
}

/**
 * @param aDVCRETURNPRICE the aDVC_RETURN_PRICE to set
 */
public void setADVC_RETURN_PRICE(String aDVCRETURNPRICE) {
	ADVC_RETURN_PRICE = aDVCRETURNPRICE;
}
