 ...
 */
public class GoodsorderModelChld extends BaseModel{
   /** 订货订单明细ID **/
   ...
   /**自动抵库标记  **/
   private String AUTO_BACKUP_FLG;
	...
	public String getOLD_DECT_PRICE() {
		return OLD_DECT_PRICE;
	}
	public void setOLD_DECT_PRICE(String oLDDECTPRICE) {
		OLD_DECT_PRICE = oLDDECTPRICE;
	}
	...
	public String getAUTO_BACKUP_FLG() {
		return AUTO_BACKUP_FLG;
	}
	public void setAUTO_BACKUP_FLG(String aUTOBACKUPFLG) {
		AUTO_BACKUP_FLG = aUTOBACKUPFLG;
	}
