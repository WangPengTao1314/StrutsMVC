 ...
 */
package com.hoperun.erp.sale.saleordersp.model;

import com.hoperun.commons.model.BaseModel;

/**
 * *@module *@func *@version 1.1 *@author zzb *@createdate 2013-10-12 13:52:19
 */
public class SaleorderspModelChld extends BaseModel {
	/** 销售订单明细ID **/
	...
	//抛转标记
	private String IS_TOSS_FLAG;
	
	private String PRDC_POINT_ID;
	
	private String PRDC_POINT_NAME;
	...
	public void setOLD_ORDER_NUM(String oLDORDERNUM) {
		OLD_ORDER_NUM = oLDORDERNUM;
	}
	...
	public void setREBATE_PRICE(String rEBATEPRICE) {
	...
	public String getIS_TOSS_FLAG() {
		return IS_TOSS_FLAG;
	}

	public void setIS_TOSS_FLAG(String iSTOSSFLAG) {
		IS_TOSS_FLAG = iSTOSSFLAG;
	}

	public String getPRDC_POINT_ID() {
		return PRDC_POINT_ID;
	}

	public void setPRDC_POINT_ID(String pRDCPOINTID) {
		PRDC_POINT_ID = pRDCPOINTID;
	}

	public String getPRDC_POINT_NAME() {
		return PRDC_POINT_NAME;
	}

	public void setPRDC_POINT_NAME(String pRDCPOINTNAME) {
		PRDC_POINT_NAME = pRDCPOINTNAME;
	}
	...
	public void setPRODUCT_REMARK(String pRODUCTREMARK) {
