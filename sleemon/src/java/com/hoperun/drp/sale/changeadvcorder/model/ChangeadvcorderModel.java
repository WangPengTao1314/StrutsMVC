 ...
 *
 */
public class ChangeadvcorderModel extends BaseModel {

	private static final long serialVersionUID = -596126436761244904L;
	
	//预订单变更ID
	private String ADVC_ORDER_CHANGE_ID;	
	//预订单变更编号
	private String ADVC_ORDER_CHANGE_NO;
	...
	/** 预订单ID **/
	   ...
	   /**原收货地址**/
	   private String OLD_RECV_ADDR;
	   
	     /**
	 * @return the oLD_CUST_NAME
	 */
	public String getOLD_CUST_NAME() {
		return OLD_CUST_NAME;
	}
	/**
	 * @param oLDCUSTNAME the oLD_CUST_NAME to set
	 */
	public void setOLD_CUST_NAME(String oLDCUSTNAME) {
	...
	/**
	 * @param oLDTEL the oLD_TEL to set
	 */
	public void setOLD_TEL(String oLDTEL) {
		OLD_TEL = oLDTEL;
	}
	/**
	 * @return the oLD_RECV_ADDR
	 */
	public String getOLD_RECV_ADDR() {
		return OLD_RECV_ADDR;
	}
	/**
	 * @param oLDRECVADDR the oLD_RECV_ADDR to set
	 */
	public void setOLD_RECV_ADDR(String oLDRECVADDR) {
		OLD_RECV_ADDR = oLDRECVADDR;
	}
		/**
	...
	public void setBILL_TYPE(String bILLTYPE) {
		...
		public void setADVC_ORDER_CHANGE_ID(String aDVCORDERCHANGEID) {
			ADVC_ORDER_CHANGE_ID = aDVCORDERCHANGEID;
		}
		public String getADVC_ORDER_CHANGE_NO() {
			return ADVC_ORDER_CHANGE_NO;
		}
		public void setADVC_ORDER_CHANGE_NO(String aDVCORDERCHANGENO) {
			ADVC_ORDER_CHANGE_NO = aDVCORDERCHANGENO;
		}
		/**
		...
		/**
		 * @param tOTALAMOUNT the tOTAL_AMOUNT to set
		 */
		...
		/**
		 * @param dISCOUNTAMOUNT the dISCOUNT_AMOUNT to set
		 */
		...
		/**
		 * @param dIFFAMOUNT the dIFF_AMOUNT to set
		 */
		public void setDIFF_AMOUNT(String dIFFAMOUNT) {
