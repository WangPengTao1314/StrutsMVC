...
/**
 * *@module *@func *@version 1.1 *@author lyg *@createdate 2013-08-11 17:17:29
 */
public class AdvcorderModel extends BaseModel {
	/**
	 * 
	 */
	...
	public void setCUSTOMER_AGE(String cUSTOMERAGE) {
	...
	public void setCUSTOMER_SOURCE(String cUSTOMERSOURCE) {
	...
	public void setCUSTOMER_DEMAND(String cUSTOMERDEMAND) {
	...
	public void setPROMOTE_NO(String promote_no) {
		PROMOTE_NO = promote_no;
	}
