 ...
 */
public class AdvctoorderModelChld extends BaseModel{
   /**
	 * 
	 */
...
/** 预订单明细ID **/
   ...
   private String TO_BASE_ORDER_NUM;
   private String OFFSET_STORE_NUM;
...
public void setSPCL_TECH_FLAG(String sPCLTECHFLAG) {
	...
	public String getTO_BASE_ORDER_NUM() {
		return TO_BASE_ORDER_NUM;
	}
	public void setTO_BASE_ORDER_NUM(String tOBASEORDERNUM) {
		TO_BASE_ORDER_NUM = tOBASEORDERNUM;
	}
	public String getOFFSET_STORE_NUM() {
		return OFFSET_STORE_NUM;
	}
	public void setOFFSET_STORE_NUM(String oFFSETSTORENUM) {
		OFFSET_STORE_NUM = oFFSETSTORENUM;
	}
