...
*/
package com.hoperun.drp.store.storediff.service;
 ...
 */
public interface StorediffService extends IBaseService {
    /**
	 * @查询
	 * @param params map
	 * @param pageNo 
     ...
     * @return true, if tx child edit
     */
    public boolean txdealEdit(String STOREIN_DIFF_ID,String STOREIN_DIFF_DTL_ID, List <StorediffdealModelChld> modelList,UserBean userBean);
    /**
     * 根据入库差异单查询是否有差异处理明细
     * @param STOREIN_DIFF_ID
     * @return
