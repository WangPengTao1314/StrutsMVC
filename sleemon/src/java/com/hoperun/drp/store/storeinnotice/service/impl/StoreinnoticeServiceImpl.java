 ...
 * prjName:喜临门营销平台
 * ucName:入库通知单维护
 * fileName:StoreinnoticeServiceImpl
 */
...
/**
 * *@serviceImpl *@func *@version 1.1 *@author glw *@createdate 2013-08-17
 * 17:07:03
 */
public class StoreinnoticeServiceImpl extends BaseService implements StoreinnoticeService {
	/**
	 * @查询
	 * @param params
	 *            map
