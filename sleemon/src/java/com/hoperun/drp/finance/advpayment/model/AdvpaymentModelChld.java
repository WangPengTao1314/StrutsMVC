...
*/
package com.hoperun.drp.finance.advpayment.model;
 ...
 */
public class AdvpaymentModelChld extends BaseModel{
   /** 结算单付款明细ID **/
   ...
   private String PAY_TYPE_OLD;
	...
	public String getPAY_TYPE_OLD() {
		return PAY_TYPE_OLD;
	}
	public void setPAY_TYPE_OLD(String pAYTYPEOLD) {
		PAY_TYPE_OLD = pAYTYPEOLD;
	}
