 ...
 * prjName:喜临门营销平台
 * ucName:客户退货结算
 * fileName:RestatementsModel
*/
package com.hoperun.drp.finance.restatements.model;
 ...
 */
public class RestatementsModel extends BaseModel{
	/** 结算单ID **/
	   ...
	   /** 已收剩余金额 **/
	   private String RECV_LAST_AMOUNT;
	   /** 单据类型 **/
	   private String BILL_TYPE;
		...
		public String getRECV_LAST_AMOUNT() {
			return RECV_LAST_AMOUNT;
		}
		public void setRECV_LAST_AMOUNT(String recv_last_amount) {
			RECV_LAST_AMOUNT = recv_last_amount;
		}
