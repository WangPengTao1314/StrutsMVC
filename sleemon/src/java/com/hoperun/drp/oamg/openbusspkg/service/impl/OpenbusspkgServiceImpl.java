...
package com.hoperun.drp.oamg.openbusspkg.service.impl;
 ...
 *
 */
public class OpenbusspkgServiceImpl extends BaseService implements OpenbusspkgService {
	...
	public IListPage pageQuery(Map<String, String> params, int pageNo) {
		return this.pageQuery("Openbusspkg.pageQuery", "Openbusspkg.pageCount",
				params, pageNo);
	}
	...
	public Map<String, String> load(String param) {		
        ...
        params.put("OPEN_BUSS_PKG_ID", param);
        return (Map<String, String>) load("Openbusspkg.loadById", params);
	}
	...
	public String txEdit(String OPEN_BUSS_PKG_ID, OpenbusspkgModel model, UserBean userBean) {
		...
		params.put("OPEN_BUSS_PKG_ID",model.getOPEN_BUSS_PKG_ID());  // 门店开业大礼包ID  
		
		 //门店开业大礼包编号
		if(model.getOPEN_BUSS_PKG_NO().equals(BusinessConsts.ZDSC)){
			params.put("OPEN_BUSS_PKG_NO",LogicUtil.getBmgz("DRP_OPEN_BUSS_PKG_NO"));
		}else{
			params.put("OPEN_BUSS_PKG_NO",model.getOPEN_BUSS_PKG_NO());
		}
		...
		params.put("REQ_NAME",model.getREQ_NAME());  //申请人姓名		
		...
		params.put("REQ_DATE",model.getREQ_DATE());  //申请日期				
		params.put("ADDRESS",model.getADDRESS());  //详细地址		
		params.put("STATE",model.getSTATE());  //状态		
		params.put("REMARK",model.getREMARK());  //备注 
		params.put("REQ_ID",model.getREQ_ID());  //申请人ID 
		params.put("RNVTN_REIT_REQ_ID",model.getRNVTN_REIT_REQ_ID()); //装修报销申请单ID
		params.put("RNVTN_REIT_REQ_NO",model.getRNVTN_REIT_REQ_NO()); //装修报销申请单编号
		params.put("TOTAL_REIT_AMOUNT",model.getTOTAL_REIT_AMOUNT()); //报销总金额
		params.put("REQ_RSON",model.getREQ_RSON()); //详细内容
		
								
		if (StringUtils.isEmpty(OPEN_BUSS_PKG_ID)) {
			OPEN_BUSS_PKG_ID= StringUtil.uuid32len();
    ...
    public boolean txInsert(Map <String, String> params) {
        insert("Openbusspkg.insert", params);
        return true;
    }
    /**
     * 更新记录 Description :.
    ...
    public boolean txUpdateById(Map <String, String> params) {
        ...
        return update("Openbusspkg.updateById", params);
    }
	...
	public boolean txInsertAtt(Map<String,String> params){
		String fromBillId = params.get("OPEN_BUSS_PKG_ID");
