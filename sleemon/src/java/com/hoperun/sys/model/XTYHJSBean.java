...
public class XTYHJSBean 
{
	...
	/**
     * Instantiates a new xTYHJS bean.
     */
    public XTYHJSBean()
    {
    }
	 ...
	 * Sets the xTYHJSID.
	 * 
	 * @param xtyhjsid the new xTYHJSID
	 */
