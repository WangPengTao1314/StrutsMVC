...
package com.hoperun.base.product.model;
...
public class ProductModel extends BaseModel {
	 ...
	 * 终结点标记
	 */
	private String FINAL_NODE_FLAG;
	...
	private String IS_DISTRIBUT_FLAG;
	private String IS_CAN_FREE_FLAG;
	private String IS_REBATE_FLAG;
	/**
	 ...
	 */
	public String getRET_PRICE_MIN() {
	 ...
	 */
	public void setRET_PRICE_MIN(String rETPRICEMIN) {
	 ...
	 */
	public String getPRD_SUIT_FLAG() {
	 ...
	 */
	public void setPRD_SUIT_FLAG(String pRDSUITFLAG) {
	 ...
	 */
	public String getFINAL_NODE_FLAG() {
	 ...
	 */
	public void setFINAL_NODE_FLAG(String fINALNODEFLAG) {
		FINAL_NODE_FLAG = fINALNODEFLAG;
	}

	/**
	 * @return the iS_CAN_FREE_FLAG
	 */
	public String getIS_CAN_FREE_FLAG() {
		return IS_CAN_FREE_FLAG;
	}

	/**
	 * @param iSCANFREEFLAG the iS_CAN_FREE_FLAG to set
	 */
	public void setIS_CAN_FREE_FLAG(String iSCANFREEFLAG) {
		IS_CAN_FREE_FLAG = iSCANFREEFLAG;
	}

	public String getIS_DISTRIBUT_FLAG() {
		return IS_DISTRIBUT_FLAG;
	}

	public void setIS_DISTRIBUT_FLAG(String iSDISTRIBUTFLAG) {
		IS_DISTRIBUT_FLAG = iSDISTRIBUTFLAG;
	}

	public String getIS_REBATE_FLAG() {
		return IS_REBATE_FLAG;
	}

	public void setIS_REBATE_FLAG(String iSREBATEFLAG) {
		IS_REBATE_FLAG = iSREBATEFLAG;
	}
